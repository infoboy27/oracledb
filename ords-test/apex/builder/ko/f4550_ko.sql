...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A136000137358738387')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121680243234671278)
,p_name=>'USERNAME'
,p_message_language=>'ko'
,p_message_text=>unistr('\C0AC\C6A9\C790 \C774\B984')
,p_version_scn=>2566745
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121680339809671278)
,p_name=>'USERNAME_DB'
,p_message_language=>'ko'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121680472880671278)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121680101507671278)
