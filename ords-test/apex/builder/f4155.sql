...
prompt APPLICATION 4155 - Scheme Authentication Login
--
-- Application Export:
--   Application:     4155
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'AUTHENTICATION-SCHEME-LOGIN')
...
,p_documentation_banner=>'Oracle APEX end user change password application.  Also used by the login API to present dynamically built login pages and to support related functionality.'
,p_authentication_id=>wwv_flow_imp.id(655487206132077960)
,p_populate_roles=>'A'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(214728703440958)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(729705784761864)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>16254507
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(729973388438584)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(738148027200247)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>243431110
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2658383525125448)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(14858802044941038)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(99844666838888905)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(118480913244833028)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(123213782349478467)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(124389475140989299)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37165931336889
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(176128720275506818)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1765072259284712054)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1831780000720994153)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1917632860486939887)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(2001350114556715)
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(26310914319937994)
...
wwv_flow_imp_shared.create_tab(
 p_id=>wwv_flow_imp.id(519013824056522)
,p_tab_set=>'One'
,p_tab_sequence=>1
,p_tab_name=>'T_PAGE_1'
,p_tab_text=>'Page&nbsp;1'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(519104518056523)
,p_tab_set=>'main'
,p_tab_sequence=>1
,p_tab_name=>'One'
,p_tab_text=>'One'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(519229449056523)
,p_tab_set=>'main'
,p_tab_sequence=>2
,p_tab_name=>'Two'
,p_tab_text=>'Two'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(519313755056523)
,p_tab_set=>'main'
,p_tab_sequence=>3
,p_tab_name=>'Three'
,p_tab_text=>'Three'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(519415313056523)
,p_tab_set=>'main'
,p_tab_sequence=>4
,p_tab_name=>'Four'
,p_tab_text=>'Four'
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(24029824597247454)
,p_theme_id=>101
,p_name=>'[x] Popup'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72728360925039215)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72728876711039216)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72729330291039216)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72729853624039217)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72730323826039217)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72730870062039218)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72731313676039218)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1146777630795684705)
,p_theme_id=>101
,p_name=>'Init 101 - Wizard Page'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140000736737349573)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140000865476349569)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140000946667349569)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140001066237349569)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140001170251349569)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705)
,p_name=>'Page Position 4'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140001263551349569)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140001364638349569)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(3791751542872)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(297140727685898042)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(1146918375616882531)
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(517201101056507)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2215041129476413)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2215527167476413)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2216042234476413)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2216504575476413)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2217084962476413)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2217506554476414)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2218055132476414)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2218552890476414)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2219033408476414)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507)
,p_name=>'Sub Regions'
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(498992332002296754)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1740330628446135)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1740827628446136)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1741391521446136)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1741895363446136)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1742395931446136)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1742896231446136)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1743362700446136)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1743898517446136)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1744376232446136)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146723779286487855)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2536211860486609)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2536743325486610)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2537292037486610)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2537709426486610)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2538299282486610)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2538786661486610)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146753630500658875)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2217162739232335)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2217682972232335)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2218186498232335)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2218624330232335)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2219115152232335)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2219697118232335)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2220127729232336)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2220668832232336)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2221156155232336)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146757828351658890)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2980501821500941)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2981059332500941)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2981517806500941)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2982076945500941)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2982580614500941)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2983067930500942)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2983505583500942)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2984018080500942)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2984545795500942)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2985064312500942)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2985552919500942)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2986080343500942)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2986567494500943)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146833868130703375)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88181214486816922)
,p_plug_template_id=>wwv_flow_imp.id(1146833868130703375)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88181795297816922)
,p_plug_template_id=>wwv_flow_imp.id(1146833868130703375)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146834495802703415)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3348953398508588)
,p_plug_template_id=>wwv_flow_imp.id(1146834495802703415)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3349463369508589)
,p_plug_template_id=>wwv_flow_imp.id(1146834495802703415)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146873381156733851)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3375472609510517)
,p_plug_template_id=>wwv_flow_imp.id(1146873381156733851)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3375920234510517)
,p_plug_template_id=>wwv_flow_imp.id(1146873381156733851)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1147008167971256777)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3218497363505982)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3218920376505982)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3219452134505982)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3219932417505982)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3220401325505982)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3220999613505982)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3221415442505982)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3221997967505983)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3222426479505983)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3222900779505983)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3223423656505983)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3223959907505983)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(517018400056507)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(107535106471295136)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(1146837484282708152)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(1146837615734708160)
...
wwv_flow_imp_shared.create_popup_lov_template(
 p_id=>wwv_flow_imp.id(518927322056521)
,p_page_name=>'winlov'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(353934608623697503)
,p_theme_id=>101
,p_theme_name=>'Init'
,p_theme_internal_name=>'INIT'
,p_navigation_type=>'T'
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_current_theme_style_id=>wwv_flow_imp.id(204026132314798041)
,p_default_page_template=>wwv_flow_imp.id(1146777630795684705)
,p_error_template=>wwv_flow_imp.id(1146777630795684705)
,p_printer_friendly_template=>wwv_flow_imp.id(1146777630795684705)
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(204026132314798041)
,p_theme_id=>101
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146724143104487863)
,p_theme_id=>101
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146724462659487863)
,p_theme_id=>101
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146754092014658878)
,p_theme_id=>101
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146754358989658879)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146754729789658879)
,p_theme_id=>101
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146758446175658891)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146759398601658893)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146725670811487866)
,p_theme_id=>101
,p_name=>'USE_COLORED_BACKGROUND'
,p_display_name=>'Use Colored Background'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(1146723779286487855)
,p_css_classes=>'a-Alert--colorBG'
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146725750422487866)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146725914274487866)
,p_theme_id=>101
,p_name=>'WARNING'
...
,p_group_id=>wwv_flow_imp.id(1146724143104487863)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726163815487867)
,p_theme_id=>101
,p_name=>'ERROR'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726316311487867)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726506076487867)
,p_theme_id=>101
,p_name=>'HORIZONTAL'
...
,p_group_id=>wwv_flow_imp.id(1146724462659487863)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726718245487867)
,p_theme_id=>101
,p_name=>'WIZARD'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726819613487867)
,p_theme_id=>101
,p_name=>'REMOVE_ICON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146727036922487867)
,p_theme_id=>101
,p_name=>'SUCCESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146755698969658883)
,p_theme_id=>101
,p_name=>'REGIONCONTAINSITEMSTEXT'
,p_display_name=>'Region Contains Items / Text'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(1146753630500658875)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146755801158658885)
,p_theme_id=>101
...
,p_group_id=>wwv_flow_imp.id(1146754729789658879)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756082978658885)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756265184658888)
,p_theme_id=>101
,p_name=>'SLIMPADDING'
...
,p_group_id=>wwv_flow_imp.id(1146754358989658879)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756454000658889)
,p_theme_id=>101
,p_name=>'NOPADDING'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756528427658889)
,p_theme_id=>101
,p_name=>'WIZARDDIALOG'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756794417658889)
,p_theme_id=>101
,p_name=>'VISIBLE'
...
,p_group_id=>wwv_flow_imp.id(1146754092014658878)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756999993658889)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554803565325408341)
,p_theme_id=>101
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(1146757828351658890)
,p_css_classes=>'a-Region--hideHeader'
,p_group_id=>wwv_flow_imp.id(1146754092014658878)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554803717040408342)
,p_theme_id=>101
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554803989855408342)
,p_theme_id=>101
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804189766408342)
,p_theme_id=>101
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804330090408342)
,p_theme_id=>101
,p_name=>'SIDEBAR'
...
,p_group_id=>wwv_flow_imp.id(1146759398601658893)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804537318408342)
,p_theme_id=>101
,p_name=>'BORDERLESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804780569408343)
,p_theme_id=>101
...
,p_group_id=>wwv_flow_imp.id(1146758446175658891)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804971600408343)
,p_theme_id=>101
,p_name=>'AUTOSCROLL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554805190489408343)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554805239267408343)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554805471106408343)
,p_theme_id=>101
,p_name=>'SIMPLE'
...
wwv_flow_imp_shared.create_language_map(
 p_id=>wwv_flow_imp.id(72242926705976153)
,p_translation_flow_id=>4156
,p_translation_flow_language_cd=>'es'
,p_translation_comments=>'Scheme Authentication Login - Spanish'
,p_direction_right_to_left=>'N'
);
wwv_flow_imp_shared.create_language_map(
 p_id=>wwv_flow_imp.id(72243010314976153)
,p_translation_flow_id=>4157
,p_translation_flow_language_cd=>'fr'
,p_translation_comments=>'Scheme Authentication Login - French'
,p_direction_right_to_left=>'N'
);
wwv_flow_imp_shared.create_language_map(
 p_id=>wwv_flow_imp.id(72243106215976153)
,p_translation_flow_id=>4158
,p_translation_flow_language_cd=>'de'
,p_translation_comments=>'Scheme Authentication Login - German'
,p_direction_right_to_left=>'N'
);
wwv_flow_imp_shared.create_language_map(
 p_id=>wwv_flow_imp.id(72243211553976153)
,p_translation_flow_id=>4159
,p_translation_flow_language_cd=>'it'
,p_translation_comments=>'Scheme Authentication Login - Italian'
,p_direction_right_to_left=>'N'
);
wwv_flow_imp_shared.create_language_map(
 p_id=>wwv_flow_imp.id(72243311438976153)
,p_translation_flow_id=>4160
,p_translation_flow_language_cd=>'pt-br'
,p_translation_comments=>'Scheme Authentication Login - Brazilian Portuguese'
,p_direction_right_to_left=>'N'
);
wwv_flow_imp_shared.create_language_map(
 p_id=>wwv_flow_imp.id(72243426112976153)
,p_translation_flow_id=>4161
,p_translation_flow_language_cd=>'zh-cn'
,p_translation_comments=>'Scheme Authentication Login - Simplified Chinese'
,p_direction_right_to_left=>'N'
);
wwv_flow_imp_shared.create_language_map(
 p_id=>wwv_flow_imp.id(72243502370976153)
,p_translation_flow_id=>4162
,p_translation_flow_language_cd=>'zh-tw'
,p_translation_comments=>'Scheme Authentication Login - Traditional Chinese'
,p_direction_right_to_left=>'N'
);
wwv_flow_imp_shared.create_language_map(
 p_id=>wwv_flow_imp.id(72243630888976153)
,p_translation_flow_id=>4163
,p_translation_flow_language_cd=>'ko'
,p_translation_comments=>'Scheme Authentication Login - Korean'
,p_direction_right_to_left=>'N'
);
wwv_flow_imp_shared.create_language_map(
 p_id=>wwv_flow_imp.id(72243731058976153)
,p_translation_flow_id=>4164
,p_translation_flow_language_cd=>'ja'
,p_translation_comments=>'Scheme Authentication Login - Japanese'
,p_direction_right_to_left=>'N'
);
end;
/
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(655487206132077960)
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1025089530051554947)
,p_plugin_type=>'AUTHENTICATION TYPE'
,p_name=>'COM.ORACLE.AUTHENTICATION.4155'
,p_display_name=>'Internal Login Authentication'
...
wwv_flow_imp_page.create_page(
 p_id=>1
,p_name=>'Public Page for Logout'
,p_alias=>'PUBLIC_PAGE'
,p_step_title=>'Public Page for Logout'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_html_page_header=>'<meta name="viewport" content="width=device-width, initial-scale=1.0" />'
,p_step_template=>wwv_flow_imp.id(1146777630795684705)
,p_page_template_options=>'#DEFAULT#'
,p_page_component_map=>'13'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7642519848874484)
,p_plug_name=>'You have successfully logged out.'
,p_region_template_options=>'a-Alert--defaultIcons:a-Alert--success:a-Alert--wizard'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146723779286487855)
,p_plug_display_sequence=>10
,p_plug_new_grid_row=>false
,p_plug_display_column=>1
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'You have been redirected here after using a logout link provided by an authentication scheme. To redirect to a page in your application instead, do something like this:',
'<ul>',
'<li>Create a page in your application and give it an alias PUBLIC_PAGE.',
'<li>On the Builder page attributes page, select the "Yes - This page is public" Public Page attribute.',
'<li>Change the logout URL in your authentication scheme to redirect to this new page after the logout procedure executes. For example use the following logout URL:<p>',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8191525547492034)
,p_plug_name=>'reset'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8191706236492034)
,p_plug_name=>'Change Password - Body'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146834495802703415)
,p_plug_display_sequence=>20
,p_plug_new_grid_row=>false
,p_plug_display_column=>1
,p_plug_query_row_template=>wwv_flow_imp.id(1939532588110833)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(923579772962744043)
,p_plug_name=>'Change Password'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146873381156733851)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(923580432969744050)
,p_plug_name=>'Change Password - Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146753630500658875)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1146875645787737806)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(923580432969744050)
,p_button_name=>'Save'
,p_button_static_id=>'Save'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(1146918375616882531)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Apply Changes'
,p_button_position=>'NEXT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8192329780492035)
,p_name=>'P50_USER_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8191706236492034)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_imp.id(1146837615734708160)
,p_item_template_options=>'#DEFAULT#'
,p_protection_level=>'I'
,p_help_text=>'Name of the user to have password changed'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8192820569492035)
,p_name=>'P50_PASSWORD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8191706236492034)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8193305833492036)
...
,p_item_template_options=>'#DEFAULT#'
,p_is_persistent=>'N'
,p_help_text=>'Reenter the new password'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'submit_when_enter_pressed', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8193806723492036)
...
,p_item_template_options=>'#DEFAULT#'
,p_is_persistent=>'N'
,p_help_text=>'Enter your current password.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'submit_when_enter_pressed', 'N')).to_clob
);
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(12378622409765411)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8194403614492037)
,p_validation_name=>'P50_ENTER_CURRENT_PASSWORD'
,p_validation_sequence=>.5
,p_validation=>'P50_ENTER_CURRENT_PASSWORD'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Password must be specified.'
,p_associated_item=>wwv_flow_imp.id(8193806723492036)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8194629425492037)
,p_validation_name=>'P50_PASSWORD Not Null'
,p_validation_sequence=>1
,p_validation=>'P50_PASSWORD'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Password must be specified.'
,p_associated_item=>wwv_flow_imp.id(8192820569492035)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 07-AUG-2002 16:59'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8194822652492037)
,p_validation_name=>'P50_CONFIRM_PASSWORD Not Null'
,p_validation_sequence=>2
,p_validation=>'P50_CONFIRM_PASSWORD'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Confirm Password must be specified.'
,p_associated_item=>wwv_flow_imp.id(8193305833492036)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 07-AUG-2002 16:59'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8195026061492037)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8195417294492037)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(25690303485866343)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8195726390492038)
...
,p_process_error_message=>'Error changing password.'
,p_process_when=>':P50_PASSWORD = :P50_CONFIRM_PASSWORD'
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_process_success_message=>'Password changed.'
,p_internal_uid=>8195726390492038
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(12382112282781418)
...
'end if;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>12382112282781418
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>99
,p_name=>'&PRODUCT_NAME. Inactive Workspace'
,p_alias=>'INACTIVE-WORKSPACE'
,p_step_title=>'&PRODUCT_NAME. Inactive Workspace'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498926816038101235)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498929027949101251)
,p_plug_name=>'Do Not Purge Workspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146834495802703415)
,p_plug_display_sequence=>30
,p_plug_source=>'<p>By clicking <strong>Do Not Purge Workspace</strong>, you are requesting that workspace &P99_WORKSPACE_NAME. should not be deleted. <strong>You must perform this action to avoid having workspace &P99_WORKSPACE_NAME. deleted.</strong></p>'
,p_translate_title=>'N'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498929409062101254)
...
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>&P99_LAST_UPDATED_BY., a workspace administrator of the &P99_WORKSPACE_NAME. workspace, has already designated this workspace to not be purged. This was updated by &P99_LAST_UPDATED_BY. on &P99_LAST_UPDATED..</p>',
'',
'<p>If you do not need this workspace any longer, click <strong>I changed my mind - Please Purge Workspace</strong> and the workspace will be automatically purged on or after <span class="u-danger-text"><strong>&P99_DATE_TO_BE_PURGED.</strong></span>.'
||'</p>'))
,p_translate_title=>'N'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498929808292101255)
,p_plug_name=>'Invalid Request'
,p_region_template_options=>'#DEFAULT#:a-Alert--warning:a-Alert--wizard'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146723779286487855)
,p_plug_display_sequence=>70
,p_plug_source=>'This application is used to confirm the usage of a workspace on &P99_APEX_URL..  You have accessed this page using an invalid URL.  If you have questions about this application or the purge process, please feel free to ask via email at <a href="mailt'
||'o:&P99_PURGE_ADMIN_EMAIL.">&P99_PURGE_ADMIN_EMAIL.</a>.'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498930028451101256)
,p_plug_name=>'&PRODUCT_NAME. Workspace Purge'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146873381156733851)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498930208776101256)
,p_plug_name=>'Thank you for using &PRODUCT_NAME. - Workspace Purged'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146873381156733851)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878093898737830)
...
,p_plug_display_sequence=>20
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p>The inactive workspace &P99_WORKSPACE_NAME. is scheduled to be deleted on &P99_DATE_TO_BE_PURGED..</p>'
,p_translate_title=>'N'
,p_plug_display_condition_type=>'EXPRESSION'
,p_plug_display_when_condition=>':P99_SGID is not null and :P99_RID is not null and :P99_EID is not null and :P99_DATE_PURGED is null'
,p_plug_display_when_cond2=>'PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878195005737831)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Workspace <strong>&P99_WORKSPACE_NAME.</strong> was purged at <strong>&P99_DATE_PURGED.</strong>.</p>',
'<p>Thank you for using &PRODUCT_NAME. at &P99_APEX_URL..</p>'))
,p_translate_title=>'N'
,p_plug_display_condition_type=>'EXPRESSION'
,p_plug_display_when_condition=>':P99_SGID is not null and :P99_RID is not null and :P99_EID is not null and :P99_DATE_PURGED is not null'
,p_plug_display_when_cond2=>'PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878222526737832)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(498929226472101252)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1146878222526737832)
,p_button_name=>'DONTPURGE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(1146918375616882531)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Do Not Purge Workspace'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(498929614547101255)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(1146918375616882531)
,p_button_image_alt=>'I changed my mind - Please Purge Workspace'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(498931017585101269)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927015083101242)
,p_name=>'P99_EID'
,p_item_sequence=>25
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927201924101248)
,p_name=>'P99_DATE_TO_BE_PURGED'
,p_item_sequence=>95
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235)
,p_prompt=>'Target Purge Date'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_imp.id(1146837484282708152)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927400231101248)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927620508101249)
,p_name=>'P99_SGID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927813465101249)
,p_name=>'P99_RID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928004161101250)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928221678101250)
,p_name=>'P99_ADMIN_EMAIL'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235)
,p_prompt=>'Workspace Originally Requested By'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_imp.id(1146837484282708152)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928405763101250)
,p_name=>'P99_OK_TO_DELETE'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235)
,p_prompt=>'Workspace to be Purged?'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928608702101251)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928817636101251)
,p_name=>'P99_DATE_PURGED'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235)
,p_prompt=>'Date Purged'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(502441507830936748)
,p_name=>'P99_APEX_URL'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(504639132530012441)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(504753932501485476)
,p_name=>'P99_WORKSPACE_ADMINS'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235)
,p_prompt=>'Workspace Administrators'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(498930401204101258)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'commit;'))
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(498929226472101252)
,p_process_success_message=>'Workspace &P99_WORKSPACE_NAME. will not be purged.  Thank you.'
,p_internal_uid=>498930401204101258
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(498930608172101261)
...
'commit;'))
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(498929614547101255)
,p_process_success_message=>'Workspace &P99_WORKSPACE_NAME. will be purged on or after &P99_DATE_TO_BE_PURGED..  Thank you.'
,p_internal_uid=>498930608172101261
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(498930813327101266)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>'Invalid workspace and request identifier.'
,p_internal_uid=>498930813327101266
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>200
,p_name=>'Unsubscribe Interactive Report Subscription'
,p_alias=>'UNSUBSCRIBE-INTERACTIVE-REPORT-SUBSCRIPTION'
,p_step_title=>'Unsubscribe Interactive Report Subscription'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(1146777630795684705)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23238304177115429)
...
,p_plug_display_column=>1
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'You are currently subscribed to the report below as <strong>&P200_EMAIL.</strong>.  If you no longer wish to receive emails at the email address, click <strong>Unsubscribe</strong> below:'
,p_translate_title=>'N'
,p_plug_display_condition_type=>'EXPRESSION'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24076722086058097)
,p_plug_name=>'Thank you. - Unsubscribed'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Thank you.  You have now been unsubscribed from the report subscription emails.  '
,p_plug_display_condition_type=>'EXPRESSION'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24076913092131160)
,p_plug_name=>'Invalid Request'
,p_region_template_options=>'#DEFAULT#:a-Alert--warning:a-Alert--wizard'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146723779286487855)
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_plug_source=>'This application is used to unsubscribe report subscriptions.  You have accessed this page using an invalid URL.'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24078523883238409)
,p_plug_name=>'Report'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>20
,p_plug_new_grid_row=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878390734737833)
,p_plug_name=>'Unsubscribe'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146873381156733851)
,p_plug_display_sequence=>30
,p_plug_new_grid_row=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878524267737835)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146753630500658875)
,p_plug_display_sequence=>50
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(23241020416235620)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1146878524267737835)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(24075027356965025)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23239325947161488)
,p_name=>'P200_EMAIL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23240324656217886)
...
,p_field_template=>wwv_flow_imp.id(1146837484282708152)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Name of the application.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23240509896223103)
,p_name=>'P200_PAGE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409)
,p_prompt=>'Page:'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23240719592225871)
,p_name=>'P200_REPORT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409)
,p_prompt=>'Report:'
...
,p_field_template=>wwv_flow_imp.id(1146837484282708152)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Name of the report you are subscribed to.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23240927557228254)
,p_name=>'P200_ID'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23241516784272398)
,p_name=>'P200_SGID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24080425624314564)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24084004265516600)
,p_name=>'P200_RID'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(24070713831809643)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(23241020416235620)
,p_process_success_message=>'Unsubscribed.  Thank you.'
,p_internal_uid=>24070713831809643
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(24059901749058684)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>'Invalid subscription and request identifier.'
,p_internal_uid=>24059901749058684
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1402815470381580)
,p_plug_name=>'Tips'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146834495802703415)
,p_plug_display_sequence=>10
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Enter your credentials in this form to start a new session in this &PRODUCT_NAME. application.'
,p_translate_title=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(57075215208721471)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(643964332163437775)
,p_plug_name=>'Help'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146834495802703415)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146876836521737818)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146877779285737827)
,p_plug_name=>'Log In to Application &F4155_P1000_APP_ID.'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146873381156733851)
,p_plug_display_sequence=>40
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(57079816296853917)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1146876836521737818)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(34456324362177919)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(476622691412236)
,p_name=>'F4155_P1000_USERNAME'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(57075215208721471)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(477505160416649)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(485932199001641)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1441703804737288)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(643811309110241934)
,p_name=>'F4155_PLUGIN_HELP_TEXT'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(1402815470381580)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(643833917075244221)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(643856524001246239)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(644127827193502573)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1146877882588737828)
,p_name=>'F4155_P1000_APP_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1146877779285737827)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>475708492408121
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643777621100235936)
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>643777621100235936
);
end;
/
...
wwv_flow_imp_shared.create_install(
 p_id=>wwv_flow_imp.id(765410550257850358)
);
end;
/
