...
prompt APPLICATION 4652 - Oracle APEX Feedback
--
-- Application Export:
--   Application:     4652
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A125000156877697397')
...
,p_publish_yn=>'Y'
,p_authentication_id=>wwv_flow_imp.id(546448889396214216.4652)
,p_populate_roles=>'A'
...
,p_substitution_value_08=>'Haut'
,p_substitution_string_09=>'CLOSE'
,p_substitution_value_09=>'Fermer'
,p_substitution_string_10=>'MSG_COPYRIGHT'
,p_substitution_value_10=>unistr('Copyright &copy; 1999, 2024, Oracle et/ou ses affili\00E9s.')
...
,p_substitution_value_13=>'Espace de travail'
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(5403068356838105.4652)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(6552444832780127.4652)
,p_name=>'APEX Shared Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>117449631
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2199352638227484.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2199791824227484.4652)
...
,p_parent_list_item_id=>wwv_flow_imp.id(2199352638227484.4652)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2200177236227484.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2200555951227485.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2200959806227485.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2201316706227485.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2201774096227485.4652)
,p_list_item_display_sequence=>100
,p_list_item_link_text=>'Tous les utilitaires d''espace de travail'
,p_list_item_link_target=>'f?p=4000:182:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_imp.id(2201316706227485.4652)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2202171394227485.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2202546941227485.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2202938027227485.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2203384748227485.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2203778274227485.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2204135762227486.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2204519334227486.4652)
,p_list_item_display_sequence=>160
,p_list_item_link_text=>'Navigateur d''objet'
,p_list_item_link_target=>'f?p=4500:2000:&SESSION.'
,p_parent_list_item_id=>wwv_flow_imp.id(2204135762227486.4652)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2204946403227486.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2205300885227486.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2205795790227486.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2206189803227486.4652)
,p_list_item_display_sequence=>220
,p_list_item_link_text=>'Tous les utilitaires'
,p_list_item_link_target=>'f?p=4500:1005:&SESSION.'
,p_parent_list_item_id=>wwv_flow_imp.id(2205795790227486.4652)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2206586688227486.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2206942931227486.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2207394407227487.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2207734153227487.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2208180895227487.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2208563801227487.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2208987751227487.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2209364795227487.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2209764397227487.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2210134224227487.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2210577163227487.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2210913779227488.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2211349982227488.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2211729627227488.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2212105846227488.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2212500260227488.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2212944086227488.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2213314207227488.4652)
...
,p_parent_list_item_id=>wwv_flow_imp.id(2212944086227488.4652)
,p_security_scheme=>wwv_flow_imp.id(19014885373808980)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2213703399227488.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2214173333227488.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2214504490227489.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2214978799227489.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2215373922227489.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2215752826227489.4652)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(183873395194737719.4652)
,p_name=>'navigation icons'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557926
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(183875295836737736.4652)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Informations en retour'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(183892999331937539.4652)
,p_name=>'navigation icons / dashboard'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557926
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(183894899015937544.4652)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Informations en retour'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(186750499630485354.4652)
,p_name=>'tasks tabs'
,p_list_status=>'PUBLIC'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(186961506868578060.4652)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(187305388135212889.4652)
,p_name=>'Team'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557934
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(187439920161634625.4652)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Informations en retour'
,p_list_item_link_target=>'f?p=&APP_ID.:8012:&SESSION.::&DEBUG.::::'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(187448905681160262.4652)
,p_name=>'events tabs'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557934
);
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(187720495709879883.4652)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(187761296054930199.4652)
,p_name=>'Feature Tabs'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557934
);
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(187892701127714718.4652)
,p_name=>'Bug Tabs'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557934
);
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(188228600364085362.4652)
,p_name=>'Feedback Tabs'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557934
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(189507995768831929.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(188228799304085371.4652)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Etat'
,p_list_item_link_target=>'f?p=&APP_ID.:8000:&SESSION.::&DEBUG.::::'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'8000'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(189008403625092036.4652)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Calendrier'
,p_list_item_link_target=>'f?p=&APP_ID.:8011:&SESSION.::&DEBUG.::::'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'8011'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(188229407853085384.4652)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>unistr('Par cr\00E9ateur')
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(330195004095908635.4652)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(331674799388342537.4652)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(704128726002003936.4652)
,p_name=>'APEX 5 - Administration (Header)'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557934
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704128889353003939.4652)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704129182327003940.4652)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'------'
,p_list_item_link_target=>'separator'
,p_list_item_current_type=>'TARGET_PAGE'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704129518290003940.4652)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704129829532003940.4652)
,p_list_item_display_sequence=>80
,p_list_item_link_text=>unistr('G\00E9rer un service')
,p_list_item_link_target=>'f?p=4350:21:&SESSION.'
,p_parent_list_item_id=>wwv_flow_imp.id(704129518290003940.4652)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704130085696003940.4652)
,p_list_item_display_sequence=>90
,p_list_item_link_text=>'------'
,p_list_item_link_target=>'separator'
,p_parent_list_item_id=>wwv_flow_imp.id(704129518290003940.4652)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704130442814003941.4652)
,p_list_item_display_sequence=>100
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(322767452165376935.4652)
,p_list_item_display_sequence=>110
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704131030506003941.4652)
,p_list_item_display_sequence=>120
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(180644398312532379.4652)
,p_list_item_display_sequence=>130
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704131357914003941.4652)
,p_list_item_display_sequence=>140
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(5203987522513487.4652)
,p_list_item_display_sequence=>150
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704131635045003941.4652)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704131885647003941.4652)
,p_list_item_display_sequence=>50
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704132222469003942.4652)
,p_list_item_display_sequence=>60
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(327721311766132607.4652)
,p_list_item_display_sequence=>70
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(704133729983005466.4652)
,p_name=>'APEX 5 - Help'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557934
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704133911516005467.4652)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2112462657213593705.4652)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2192007899943120724.4652)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(704134809327005468.4652)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'---'
,p_list_item_link_target=>'separator'
,p_list_item_current_type=>'TARGET_PAGE'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(28404746512118655.4652)
,p_list_item_display_sequence=>50
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1273635293832132327.4652)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1273640947705143091.4652)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(916969500465878.4652)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1291229113451106.4652)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1297177647778062.4652)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>16259565
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1321326969185827.4652)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>243439542
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3210486817136990.4652)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(21354998114480992.4652)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(99845036844888905.4652)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(118481410739833028.4652)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(123214289579478467.4652)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(124389916416989299.4652)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37165931336889
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(176129237057506820.4652)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1771579147742252115.4652)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1838228900013533939.4652)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1924144112996479973.4652)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2017489143332659140.4652)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(1756114682006489.4652)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(2237574036421385.4652)
,p_name=>'Flow: RESTFUL'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(4600217015020208.4652)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(11404848212691946.4652)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(17100680668766728.4652)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(19014885373808980.4652)
,p_name=>'Flow: EDIT'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'EDIT'
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(19027996399058141.4652)
,p_name=>'Flow: ADMIN'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'ADMIN'
,p_error_message=>unistr('Vous n''\00EAtes pas autoris\00E9 \00E0 administrer des applications')
,p_version_scn=>2599287
,p_caching=>'BY_USER_BY_SESSION'
);
end;
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(185441288973292654.4652)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(185441697843292655.4652)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(185442186271292656.4652)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(330155780902809283.4652)
...
'   return false;',
'end if;'))
,p_error_message=>unistr('Pour acc\00E9der \00E0 cette page, les fichiers de d\00E9veloppement d''\00E9quipe doivent \00EAtre activ\00E9s.')
,p_version_scn=>2599287
,p_caching=>'NOCACHE'
);
end;
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(340808806444504291.4652)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(924142799474578284.4652)
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(240228498534092429.4652)
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(39659194176253998.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(39687302085502294.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(39686519615497868.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(39685106455494105.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(40589212087879993.4652)
,p_name=>'AJAX_WS_NUM'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(808157289945989781.4652)
,p_name=>'COMPANY'
,p_scope=>'GLOBAL'
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(176320593212726240.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(187164401829658401.4652)
,p_name=>'FOLDER_ID'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(169965497689755953.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(23116113790163063.4652)
,p_name=>'ITEM_ID'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(212601704559973757.4652)
,p_name=>'MSG_COMPANY'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(191826710535164637.4652)
,p_name=>'OWNER_ID'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(194987598169980229.4652)
,p_name=>'RPT_ID'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(187311995341113436.4652)
,p_name=>'SHOWNAV'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(23147208603287312.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(38269819333150352.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(23146805140286315.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(23120618657315808.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(19223200152826192.4652)
,p_name=>'WORKGROUP'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(19230816718477186.4652)
,p_name=>'WORKGROUP_ID'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(38983191458297230.4652)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(94100308836307541.4652)
...
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(808157680380996522.4652)
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(187312600881115097.4652)
,p_computation_sequence=>10
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(188485712678162256.4652)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(188542606751974885.4652)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(681074921907529445.4652)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(6597377151972039.4652)
,p_name=>'Feedback Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(6597846814990224.4652)
,p_short_name=>unistr('<span class="u-VisuallyHidden">Probl\00E8mes</span><span class="a-Icon icon-breadcrumb-previous" title="Issues"></span>')
,p_link=>'f?p=4600:999:&APP_SESSION.'
,p_page_id=>0
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(6598070160992348.4652)
,p_parent_id=>wwv_flow_imp.id(6597846814990224.4652)
,p_short_name=>'Informations en retour'
,p_link=>'f?p=&APP_ID.:8012:&SESSION.::&DEBUG.:::'
,p_page_id=>8012
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(6598248790001070.4652)
,p_parent_id=>wwv_flow_imp.id(6598070160992348.4652)
,p_short_name=>'Calendrier'
,p_link=>'f?p=&APP_ID.:8011:&SESSION.::&DEBUG.:::'
,p_page_id=>8011
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(6598414745005626.4652)
,p_parent_id=>wwv_flow_imp.id(6598070160992348.4652)
,p_short_name=>'Etat'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(6598672174009747.4652)
,p_parent_id=>wwv_flow_imp.id(6598070160992348.4652)
,p_short_name=>'Visualiser/modifier les informations en retour'
,p_link=>'f?p=&APP_ID.:8001:&SESSION.::&DEBUG.:::'
,p_page_id=>8001
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(6598816026012533.4652)
,p_parent_id=>wwv_flow_imp.id(6598672174009747.4652)
,p_short_name=>'Modifier le suivi des informations en retour'
,p_link=>'f?p=&APP_ID.:8014:&SESSION.::&DEBUG.:::'
,p_page_id=>8014
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(6599042686018183.4652)
,p_parent_id=>wwv_flow_imp.id(6598070160992348.4652)
,p_short_name=>unistr('par cr\00E9ateur')
...
begin
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(94078305196268627.4652)
,p_name=>'worksheet standard'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(118729785765681082.4652)
,p_short_name=>unistr('<span class="u-VisuallyHidden">Probl\00E8mes</span><span class="a-Icon icon-breadcrumb-previous" title="Issues"></span>')
,p_link=>'f?p=4600:999:&SESSION.'
,p_page_id=>999
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(120629898535546685.4652)
,p_parent_id=>wwv_flow_imp.id(188166605479270547.4652)
,p_short_name=>'Modifier le suivi des informations en retour'
,p_link=>'f?p=&FLOW_ID.:8014:&SESSION.'
,p_page_id=>8014
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(188141192895137966.4652)
,p_parent_id=>wwv_flow_imp.id(189506688383825864.4652)
,p_short_name=>'Etat'
,p_link=>'f?p=&APP_ID.:8000:&SESSION.::&DEBUG.:::'
,p_page_id=>8000
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(188166605479270547.4652)
,p_parent_id=>wwv_flow_imp.id(189506688383825864.4652)
,p_short_name=>'Visualiser/modifier les informations en retour'
,p_link=>'f?p=&APP_ID.:8001:&SESSION.::&DEBUG.:::'
,p_page_id=>8001
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(188237788028166599.4652)
,p_parent_id=>wwv_flow_imp.id(189506688383825864.4652)
,p_short_name=>unistr('par cr\00E9ateur')
,p_link=>'f?p=&APP_ID.:8005:&SESSION.::&DEBUG.:::'
,p_page_id=>8005
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(189008194222089847.4652)
,p_parent_id=>wwv_flow_imp.id(189506688383825864.4652)
,p_short_name=>'Calendrier'
,p_link=>'f?p=&APP_ID.:8011:&SESSION.::&DEBUG.:::'
,p_page_id=>8011
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(189506688383825864.4652)
,p_parent_id=>wwv_flow_imp.id(186485216863096905.4652)
,p_short_name=>'Informations en retour'
,p_link=>'f?p=&APP_ID.:8012:&SESSION.::&DEBUG.:::'
,p_page_id=>8012
);
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(189910623938725087.4652)
,p_theme_id=>3
,p_name=>'[x] APEX 4.2 - Popup.fr'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72517631307978241.4652)
,p_page_template_id=>wwv_flow_imp.id(189910623938725087.4652)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72518181386978241.4652)
,p_page_template_id=>wwv_flow_imp.id(189910623938725087.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72518652486978242.4652)
,p_page_template_id=>wwv_flow_imp.id(189910623938725087.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72519163723978243.4652)
,p_page_template_id=>wwv_flow_imp.id(189910623938725087.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72519631470978244.4652)
,p_page_template_id=>wwv_flow_imp.id(189910623938725087.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72520137001978244.4652)
,p_page_template_id=>wwv_flow_imp.id(189910623938725087.4652)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(395644842192767482.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1566807974131873.4652)
,p_page_template_id=>wwv_flow_imp.id(395644842192767482.4652)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1567378972131873.4652)
,p_page_template_id=>wwv_flow_imp.id(395644842192767482.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1567866614131873.4652)
,p_page_template_id=>wwv_flow_imp.id(395644842192767482.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1568359450131873.4652)
,p_page_template_id=>wwv_flow_imp.id(395644842192767482.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1568818181131873.4652)
,p_page_template_id=>wwv_flow_imp.id(395644842192767482.4652)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1569337310131874.4652)
,p_page_template_id=>wwv_flow_imp.id(395644842192767482.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1569891446131874.4652)
,p_page_template_id=>wwv_flow_imp.id(395644842192767482.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1570371516131874.4652)
,p_page_template_id=>wwv_flow_imp.id(395644842192767482.4652)
,p_name=>'Control Bar'
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(643947460795988298.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2446635889706108.4652)
,p_page_template_id=>wwv_flow_imp.id(643947460795988298.4652)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2447162563706108.4652)
,p_page_template_id=>wwv_flow_imp.id(643947460795988298.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2447612159706108.4652)
,p_page_template_id=>wwv_flow_imp.id(643947460795988298.4652)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2448199485706108.4652)
,p_page_template_id=>wwv_flow_imp.id(643947460795988298.4652)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2448693782706108.4652)
,p_page_template_id=>wwv_flow_imp.id(643947460795988298.4652)
,p_name=>'Page Position 4'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2449182353706109.4652)
,p_page_template_id=>wwv_flow_imp.id(643947460795988298.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2449684682706109.4652)
,p_page_template_id=>wwv_flow_imp.id(643947460795988298.4652)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2450183562706109.4652)
,p_page_template_id=>wwv_flow_imp.id(643947460795988298.4652)
,p_name=>'Control Bar'
,p_placeholder=>'REGION_POSITION_09'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(676701755252252907.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293490713756977320.4652)
,p_page_template_id=>wwv_flow_imp.id(676701755252252907.4652)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293491217749977321.4652)
,p_page_template_id=>wwv_flow_imp.id(676701755252252907.4652)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293491725290977321.4652)
,p_page_template_id=>wwv_flow_imp.id(676701755252252907.4652)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(700757386426987576.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2537087170702147.4652)
,p_page_template_id=>wwv_flow_imp.id(700757386426987576.4652)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2537546680702147.4652)
,p_page_template_id=>wwv_flow_imp.id(700757386426987576.4652)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2538075365702147.4652)
,p_page_template_id=>wwv_flow_imp.id(700757386426987576.4652)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2538561778702148.4652)
,p_page_template_id=>wwv_flow_imp.id(700757386426987576.4652)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2539045343702148.4652)
,p_page_template_id=>wwv_flow_imp.id(700757386426987576.4652)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2539539736702148.4652)
,p_page_template_id=>wwv_flow_imp.id(700757386426987576.4652)
,p_name=>'Page Position 5'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2540074511702148.4652)
,p_page_template_id=>wwv_flow_imp.id(700757386426987576.4652)
,p_name=>'Page Position 7'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2540503559702148.4652)
,p_page_template_id=>wwv_flow_imp.id(700757386426987576.4652)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2541094313702149.4652)
,p_page_template_id=>wwv_flow_imp.id(700757386426987576.4652)
,p_name=>'Control Bar'
,p_placeholder=>'REGION_POSITION_09'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(700758032440987611.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293537782107992205.4652)
,p_page_template_id=>wwv_flow_imp.id(700758032440987611.4652)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293538205229992206.4652)
,p_page_template_id=>wwv_flow_imp.id(700758032440987611.4652)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293538718174992206.4652)
,p_page_template_id=>wwv_flow_imp.id(700758032440987611.4652)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(783936135557333953.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1529556713875378.4652)
,p_page_template_id=>wwv_flow_imp.id(783936135557333953.4652)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1530096172875378.4652)
,p_page_template_id=>wwv_flow_imp.id(783936135557333953.4652)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1530508278875379.4652)
,p_page_template_id=>wwv_flow_imp.id(783936135557333953.4652)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1531063319875379.4652)
,p_page_template_id=>wwv_flow_imp.id(783936135557333953.4652)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1531546223875379.4652)
,p_page_template_id=>wwv_flow_imp.id(783936135557333953.4652)
,p_name=>'Page Position 4'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1532070261875379.4652)
,p_page_template_id=>wwv_flow_imp.id(783936135557333953.4652)
,p_name=>'Page Position 7'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1532554640875379.4652)
,p_page_template_id=>wwv_flow_imp.id(783936135557333953.4652)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1533088337875380.4652)
,p_page_template_id=>wwv_flow_imp.id(783936135557333953.4652)
,p_name=>'Control Bar'
,p_placeholder=>'REGION_POSITION_09'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(52847904441713695.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(188465439437178873.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(207940091359480439.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(207940289776480439.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(308205889752201939.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(395010736604687693.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(395010959526687694.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(411369261610169638.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(411369470801169643.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(411369734082169643.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(411397931291349067.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(499402697948958678.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(499402896063958684.4652)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(635747177427497172.4652)
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25235801195590655.4652)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1855870050455619.4652)
,p_plug_template_id=>wwv_flow_imp.id(25235801195590655.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1856356257455619.4652)
,p_plug_template_id=>wwv_flow_imp.id(25235801195590655.4652)
,p_name=>'Sub Regions'
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44609818978948791.4652)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(229914798954787151.4652)
,p_plug_template_id=>wwv_flow_imp.id(44609818978948791.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(229915278294787151.4652)
,p_plug_template_id=>wwv_flow_imp.id(44609818978948791.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2051069825463786.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2051502174463786.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2052010658463786.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2052510990463786.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2053067997463786.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2053544781463787.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2054058007463787.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2054513884463787.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2055037832463787.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2055560542463787.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2056050737463787.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2056521330463787.4652)
,p_plug_template_id=>wwv_flow_imp.id(44920011425855551.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62138891989715890.4652)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60405852726110463.4652)
,p_plug_template_id=>wwv_flow_imp.id(62138891989715890.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60406329446110463.4652)
,p_plug_template_id=>wwv_flow_imp.id(62138891989715890.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62139511251715892.4652)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(135727700843120563.4652)
,p_plug_template_id=>wwv_flow_imp.id(62139511251715892.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(135728284443120563.4652)
,p_plug_template_id=>wwv_flow_imp.id(62139511251715892.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1895478058457189.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1895905288457190.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1896426741457190.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1896916470457190.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1897435247457190.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1897970566457190.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1898464020457190.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1898905451457190.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1899499340457191.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1899957177457191.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1900464384457191.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1900917930457191.4652)
,p_plug_template_id=>wwv_flow_imp.id(62140203187715892.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2281736895476435.4652)
,p_plug_template_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2282284019476435.4652)
,p_plug_template_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2282738151476435.4652)
,p_plug_template_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2283234026476436.4652)
,p_plug_template_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2283730801476436.4652)
,p_plug_template_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2284297487476436.4652)
,p_plug_template_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2284704891476436.4652)
,p_plug_template_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2285255830476436.4652)
,p_plug_template_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2285769022476436.4652)
,p_plug_template_id=>wwv_flow_imp.id(62141710374715893.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2374026453478199.4652)
,p_plug_template_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2374576655478200.4652)
,p_plug_template_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2375013261478200.4652)
,p_plug_template_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2375598930478200.4652)
,p_plug_template_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2376073123478200.4652)
,p_plug_template_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2376551051478200.4652)
,p_plug_template_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2377084056478200.4652)
,p_plug_template_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2377565507478200.4652)
,p_plug_template_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2378083663478201.4652)
,p_plug_template_id=>wwv_flow_imp.id(62142309916715893.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140556264995344453.4652)
,p_plug_template_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140556361311344453.4652)
,p_plug_template_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140556418569344453.4652)
,p_plug_template_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140556531846344453.4652)
,p_plug_template_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140556641646344453.4652)
,p_plug_template_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140556708670344453.4652)
,p_plug_template_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140556829679344453.4652)
,p_plug_template_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140556953392344453.4652)
,p_plug_template_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140557095307344452.4652)
,p_plug_template_id=>wwv_flow_imp.id(169967419851504809.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(169972595154818636.4652)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140557117408344452.4652)
,p_plug_template_id=>wwv_flow_imp.id(169972595154818636.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140557228869344452.4652)
,p_plug_template_id=>wwv_flow_imp.id(169972595154818636.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92512462215295501.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92512951132295501.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92513457347295501.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92513971713295502.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92514421923295502.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92514982449295502.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92515486227295502.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92515981512295503.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92516404658295503.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92516918811295503.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92517428128295503.4652)
,p_plug_template_id=>wwv_flow_imp.id(186745810195475637.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92563236860298319.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92563732591298319.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92564201971298320.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92564740750298320.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92565292549298320.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92565799117298322.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92566256245298322.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92566789433298323.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92567213062298323.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92567709040298323.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(92568201331298324.4652)
,p_plug_template_id=>wwv_flow_imp.id(186746202608475682.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1837322939453654.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1837801272453654.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1838302623453654.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1838881354453654.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1839384532453654.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1839810272453655.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1840355273453655.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1840877776453655.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1841369282453655.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1841812951453655.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1842396413453655.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1842868975453655.4652)
,p_plug_template_id=>wwv_flow_imp.id(186833193687011642.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1962458063460917.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1962956254460918.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1963418549460918.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1963940535460918.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1964439667460918.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1964931917460918.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1965426806460918.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1965992326460918.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1966403943460919.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1966958227460919.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1967405190460919.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1967955072460919.4652)
,p_plug_template_id=>wwv_flow_imp.id(186905897464204984.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aRegion buttonRegion" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="aRegionHeading">',
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60548112918153023.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60548627047153023.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60549174790153023.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60549662959153023.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60550187732153024.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60550660645153024.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60551140973153024.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60551662292153025.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60552195689153025.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60552646842153025.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60553109648153025.4652)
,p_plug_template_id=>wwv_flow_imp.id(197560605041176246.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(197577184540233756.4652)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140573627310344435.4652)
,p_plug_template_id=>wwv_flow_imp.id(197577184540233756.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140573716892344435.4652)
,p_plug_template_id=>wwv_flow_imp.id(197577184540233756.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(215153199785752378.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93618574080534552.4652)
,p_plug_template_id=>wwv_flow_imp.id(215153199785752378.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93619044939534553.4652)
,p_plug_template_id=>wwv_flow_imp.id(215153199785752378.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aRegion sideRegion #REGION_CSS_CLASSES#" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="aRegionHeading">',
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2062116582463789.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2062699233463789.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2063133724463790.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2063610830463790.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2064192898463790.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2064694286463790.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2065134297463790.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2065643742463790.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2066195184463791.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2066650189463791.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2067182813463791.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2067692398463791.4652)
,p_plug_template_id=>wwv_flow_imp.id(249022840020543624.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3089608966500983.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3090154095500983.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3090674670500983.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3091163857500983.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3091694180500984.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3092154029500984.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3092615915500984.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3093166251500984.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3093688180500984.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3094178079500984.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3094691800500984.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3095187443500985.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3095631496500985.4652)
,p_plug_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(394873728911883775.4652)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32612039403747565.4652)
,p_plug_template_id=>wwv_flow_imp.id(394873728911883775.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32612547755747565.4652)
,p_plug_template_id=>wwv_flow_imp.id(394873728911883775.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32613038158747565.4652)
,p_plug_template_id=>wwv_flow_imp.id(394873728911883775.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32613565333747566.4652)
,p_plug_template_id=>wwv_flow_imp.id(394873728911883775.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(415202027252589471.4652)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140579024518344430.4652)
,p_plug_template_id=>wwv_flow_imp.id(415202027252589471.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140579188724344430.4652)
,p_plug_template_id=>wwv_flow_imp.id(415202027252589471.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2150889013465574.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2151333565465574.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2151880708465575.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2152397269465575.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2152828129465575.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2153349177465575.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2153887060465575.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2154311321465575.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2154853779465575.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2155375768465576.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2155804825465576.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2156378371465576.4652)
,p_plug_template_id=>wwv_flow_imp.id(473213802990752028.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(508696982154118073.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1773206614450027.4652)
,p_plug_template_id=>wwv_flow_imp.id(508696982154118073.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1773791670450027.4652)
,p_plug_template_id=>wwv_flow_imp.id(508696982154118073.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(684869836739871122.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2931798496493390.4652)
,p_plug_template_id=>wwv_flow_imp.id(684869836739871122.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2932241291493390.4652)
,p_plug_template_id=>wwv_flow_imp.id(684869836739871122.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2932796703493391.4652)
,p_plug_template_id=>wwv_flow_imp.id(684869836739871122.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2933283491493391.4652)
,p_plug_template_id=>wwv_flow_imp.id(684869836739871122.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1651951662423898.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1652448017423899.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1652961434423899.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1653493265423899.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1653939067423899.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1654476754423899.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1654970588423899.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1655473438423899.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1655951213423900.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1656467159423900.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1656920225423900.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1657495194423900.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1657997119423900.4652)
,p_plug_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2304660514232376.4652)
,p_plug_template_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2305194732232376.4652)
,p_plug_template_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2305652622232376.4652)
,p_plug_template_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2306146537232376.4652)
,p_plug_template_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2306692582232376.4652)
,p_plug_template_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2307174189232376.4652)
,p_plug_template_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2307637463232376.4652)
,p_plug_template_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2308168994232377.4652)
,p_plug_template_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2308655843232377.4652)
,p_plug_template_id=>wwv_flow_imp.id(697044757239351357.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2799268656491366.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2799751669491366.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2800210159491366.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2800730025491366.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2801222156491367.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2801756382491367.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2802203327491367.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2802727463491367.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2803213082491367.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2803769099491367.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2804273859491367.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2804777320491367.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2805239439491368.4652)
,p_plug_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(700764213343999023.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3755108212621368.4652)
,p_plug_template_id=>wwv_flow_imp.id(700764213343999023.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3755614125621368.4652)
,p_plug_template_id=>wwv_flow_imp.id(700764213343999023.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(700764942929999024.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140584912494344424.4652)
,p_plug_template_id=>wwv_flow_imp.id(700764942929999024.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140585035088344423.4652)
,p_plug_template_id=>wwv_flow_imp.id(700764942929999024.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(700766407172999024.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(68602841254251726.4652)
,p_plug_template_id=>wwv_flow_imp.id(700766407172999024.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(68603386006251726.4652)
,p_plug_template_id=>wwv_flow_imp.id(700766407172999024.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(68603879580251727.4652)
,p_plug_template_id=>wwv_flow_imp.id(700766407172999024.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(68604369945251727.4652)
,p_plug_template_id=>wwv_flow_imp.id(700766407172999024.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140585789913344423.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140585869981344423.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140585904660344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586082977344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586164494344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586258249344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586338696344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586449938344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586569685344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586698710344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586768542344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586887620344422.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140586925989344421.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767147709999025.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587037197344421.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587116731344421.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587281750344421.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587306316344421.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587464344344421.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587520237344421.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587674412344421.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587754581344421.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587848953344420.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140587919910344420.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140588024681344420.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140588186614344420.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140588222925344420.4652)
,p_plug_template_id=>wwv_flow_imp.id(700767825232999025.4652)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3284466807506003.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3284954734506003.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3285454716506003.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3285937991506004.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3286486853506004.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3286981390506004.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3287421425506004.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3287904340506004.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3288492560506004.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3288962957506004.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3289462358506005.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3289925170506005.4652)
,p_plug_template_id=>wwv_flow_imp.id(700768560594999026.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(813554394221812426.4652)
,p_layout=>'TABLE'
,p_template=>'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>#BODY#</div>'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60418627624125960.4652)
,p_plug_template_id=>wwv_flow_imp.id(813554394221812426.4652)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(60419186414125960.4652)
,p_plug_template_id=>wwv_flow_imp.id(813554394221812426.4652)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(23735196180806583.4652)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(26666984607144851.4652)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(188948529125031038.4652)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(193632009704546435.4652)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(205034121246397307.4652)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(215159999381754637.4652)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(216948000482610776.4652)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(244726335168133894.4652)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(394878284873890296.4652)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(394878606759890298.4652)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li data-id="#A01#" data-disabled="#A02#" data-hide="#A03#" data-shortcut="#A05#" data-icon="#IMAGE#"><a href="#LINK#" title="#A04#" target="#A06#">#TEXT_ESC_SC#</a></li>',
''))
,p_list_template_noncurrent=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(395640290513433908.4652)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(694410403055228602.4652)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(705132100057297693.4652)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(12080207088206014.4652)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(26536607305126866.4652)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(176568047789263777.4652)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(181635329842110151.4652)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(186827396907902067.4652)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(186827809170902096.4652)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(395652746647870440.4652)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(395653048191870446.4652)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(703372107153632568.4652)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(703376939640632578.4652)
...
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(11436607399317360.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(227699045965618787.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(263340242321347374.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(263341940374356326.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(408093938801503146.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(474833281367609401.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(493950867964259075.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(493950978277259098.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(694415461746261220.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(694415638329261221.4652)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(694416725694263392.4652)
...
wwv_flow_imp_shared.create_menu_template(
 p_id=>wwv_flow_imp.id(183701840519666652.4652)
...
begin
wwv_flow_imp_shared.create_menu_template(
 p_id=>wwv_flow_imp.id(394880309395892667.4652)
...
wwv_flow_imp_shared.create_popup_lov_template(
 p_id=>wwv_flow_imp.id(180184739606372703.4652)
,p_page_name=>'winlov'
...
wwv_flow_imp_shared.create_calendar_template(
 p_id=>wwv_flow_imp.id(218713441324738082.4652)
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(78840186844083825.4652)
,p_theme_id=>3
,p_name=>'DARK'
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(210531387365324264.4652)
,p_theme_id=>3
,p_name=>'STANDARD'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#IMAGE_PREFIX#apex_ui/css/Core#MIN#.css',
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(556401691879116466.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(556401916469117281.4652)
,p_theme_id=>3
,p_name=>'DARK_AUTO'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#IMAGE_PREFIX#apex_ui/css/Core#MIN#.css',
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2325953820907717.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(236104293091260262.4652)
,p_theme_id=>3
,p_name=>'LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(693437730767568160.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(693438672424568161.4652)
,p_theme_id=>101
,p_name=>'BODY_PADDING'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(693440202068568161.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697045387842351371.4652)
,p_theme_id=>101
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697046454352351372.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697054449869351406.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697055438734351407.4652)
,p_theme_id=>101
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697236983795192856.4652)
,p_theme_id=>101
,p_name=>'BUTTON_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697237088104192858.4652)
,p_theme_id=>101
,p_name=>'BUTTON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697237205186192858.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697237358462192858.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697237404763192858.4652)
,p_theme_id=>101
,p_name=>'BADGE_LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697237568618192858.4652)
,p_theme_id=>101
,p_name=>'BADGE_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697237650199192858.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697237747369192858.4652)
,p_theme_id=>101
,p_name=>'REPORT_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697237840919192858.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697237936650192859.4652)
,p_theme_id=>101
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697238001197192859.4652)
,p_theme_id=>101
,p_name=>'HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697238137627192859.4652)
,p_theme_id=>101
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697238213668192859.4652)
,p_theme_id=>101
,p_name=>'MAX_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697238313939192859.4652)
,p_theme_id=>101
,p_name=>'MIN_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697238388379192859.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(703120149933578335.4652)
,p_theme_id=>101
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(703754804407248924.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(705132502554297699.4652)
,p_theme_id=>101
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752965663325972701.4652)
,p_theme_id=>3
,p_name=>'HEIGHT'
,p_display_name=>'Height'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752966961011972701.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752967240437972701.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752967503447972701.4652)
,p_theme_id=>3
,p_name=>'BUTTON_SET'
,p_display_name=>'Button Set'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752968625073972702.4652)
,p_theme_id=>3
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752968916066972702.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752969246994972702.4652)
,p_theme_id=>3
,p_name=>'BUTTON_SIZE'
,p_display_name=>'Button Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752969523829972702.4652)
,p_theme_id=>3
,p_name=>'SPACING_LEFT'
,p_display_name=>'Spacing left'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752969816508972703.4652)
,p_theme_id=>3
,p_name=>'SPACING_RIGHT'
,p_display_name=>'Spacing Right'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752970373928972703.4652)
,p_theme_id=>3
,p_name=>'ICON_POSITION'
,p_display_name=>'Icon Position'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(752970610131972703.4652)
,p_theme_id=>3
,p_name=>'BUTTON_TYPE'
,p_display_name=>'Button Type'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(757216252300959709.4652)
,p_theme_id=>3
,p_name=>'REGION_TITLE'
,p_display_name=>'Region Title'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(757217027408959709.4652)
,p_theme_id=>3
,p_name=>'REGION_PADDING'
,p_display_name=>'Region Padding'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(757217561984959709.4652)
,p_theme_id=>3
,p_name=>'REGION_POSITION'
,p_display_name=>'Region Position'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(757217841787959709.4652)
,p_theme_id=>3
,p_name=>'REGION_STYLE'
,p_display_name=>'Region Style'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(757218501215959709.4652)
,p_theme_id=>3
,p_name=>'REGION_OVERFLOW'
,p_display_name=>'Region Overflow'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(757230369532962928.4652)
,p_theme_id=>3
,p_name=>'DISPLAY'
,p_display_name=>'Display'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(793628286525489784.4652)
,p_theme_id=>3
,p_name=>'ALTERNATING_TABLE_ROWS'
,p_display_name=>'Alternating Table Rows'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(793628595521489784.4652)
,p_theme_id=>3
,p_name=>'ROW_HIGHLIGHTING'
,p_display_name=>'Row Highlighting'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(793628907307489784.4652)
,p_theme_id=>3
,p_name=>'REPORT_BORDER'
,p_display_name=>'Report Border'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(793629694305489785.4652)
,p_theme_id=>3
,p_name=>'REPORT_WIDTH'
,p_display_name=>'Report Width'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1027581746419114496.4652)
,p_theme_id=>3
,p_name=>'DISPLAY_ICONS'
,p_display_name=>'Display Icons'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1529500089426799.4652)
,p_theme_id=>3
,p_name=>'HIDDEN'
,p_display_name=>'Hidden to Assistive Tech'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(684869836739871122.4652)
,p_css_classes=>'a-Region--hideHeader'
,p_group_id=>wwv_flow_imp.id(757216252300959709.4652)
,p_template_types=>'REGION'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2326240864918046.4652)
,p_theme_id=>3
,p_name=>'HEADING_LEVEL_H1'
,p_display_name=>'H1'
,p_display_sequence=>10
,p_css_classes=>'js-headingLevel-1'
,p_group_id=>wwv_flow_imp.id(2325953820907717.4652)
,p_template_types=>'REGION'
,p_help_text=>'H1'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2326577471918046.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2326994749918046.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2327361980918046.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2327723374918047.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2328196091918047.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705136091795297720.4652)
,p_theme_id=>101
,p_name=>'2COLUMNGRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(705132100057297693.4652)
,p_css_classes=>'a-MediaList--cols a-MediaList--2cols'
,p_group_id=>wwv_flow_imp.id(705132502554297699.4652)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705136475424297721.4652)
,p_theme_id=>101
,p_name=>'3COLUMNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705136713435297721.4652)
,p_theme_id=>101
,p_name=>'4COLUMNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705137018578297721.4652)
,p_theme_id=>101
,p_name=>'5COLUMNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705137359585297721.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705137580273297721.4652)
,p_theme_id=>101
,p_name=>'HIDEBADGE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705137932439297722.4652)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705138188065297722.4652)
,p_theme_id=>101
,p_name=>'HIDETITLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705138486446297722.4652)
,p_theme_id=>101
,p_name=>'HIDEICONS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705138789420297724.4652)
,p_theme_id=>101
,p_name=>'SLIMLIST'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752965768025972701.4652)
,p_theme_id=>3
,p_name=>'180PX'
,p_display_name=>'180px'
,p_display_sequence=>10
,p_css_classes=>'h180'
,p_group_id=>wwv_flow_imp.id(752965663325972701.4652)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752965949536972701.4652)
,p_theme_id=>3
,p_name=>'240PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752966124463972701.4652)
,p_theme_id=>3
,p_name=>'320PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752966311131972701.4652)
,p_theme_id=>3
,p_name=>'480PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752966557880972701.4652)
,p_theme_id=>3
,p_name=>'540PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752966759495972701.4652)
,p_theme_id=>3
,p_name=>'640PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752966993524972701.4652)
,p_theme_id=>3
,p_name=>'ALIGNLABELSLEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_css_classes=>'a-Form--leftLabels'
,p_group_id=>wwv_flow_imp.id(752966961011972701.4652)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752967357282972701.4652)
,p_theme_id=>3
,p_name=>'AUTOWIDTH'
,p_display_name=>'Auto Width'
,p_display_sequence=>1
,p_css_classes=>'a-Form--autoWidthLabels'
,p_group_id=>wwv_flow_imp.id(752967240437972701.4652)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752967632517972701.4652)
,p_theme_id=>3
,p_name=>'FIRSTBUTTON'
,p_display_name=>'First Button'
,p_display_sequence=>1
,p_css_classes=>'a-Button--pillStart'
,p_group_id=>wwv_flow_imp.id(752967503447972701.4652)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752967847470972702.4652)
,p_theme_id=>3
,p_name=>'FIXEDLARGE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752968045227972702.4652)
,p_theme_id=>3
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752968270759972702.4652)
,p_theme_id=>3
,p_name=>'FIXEDWIDTH'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752968384078972702.4652)
,p_theme_id=>3
,p_name=>'INNERBUTTON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752968730135972702.4652)
,p_theme_id=>3
,p_name=>'LABELAUTOWIDTH'
,p_display_name=>'Auto Width'
,p_display_sequence=>1
,p_css_classes=>'a-Form-fieldContainer--autoLabelWidth'
,p_group_id=>wwv_flow_imp.id(752968625073972702.4652)
,p_template_types=>'FIELD'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752969015558972702.4652)
,p_theme_id=>3
,p_name=>'LABELSABOVE'
,p_display_name=>'Labels Above'
,p_display_sequence=>1
,p_css_classes=>'a-Form--labelsAbove'
,p_group_id=>wwv_flow_imp.id(752968916066972702.4652)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752969365387972702.4652)
,p_theme_id=>3
,p_name=>'LARGE'
,p_display_name=>'Large'
,p_display_sequence=>3
,p_css_classes=>'a-Button--large'
,p_group_id=>wwv_flow_imp.id(752969246994972702.4652)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752969647302972702.4652)
,p_theme_id=>3
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
,p_css_classes=>'a-Button--gapLeft'
,p_group_id=>wwv_flow_imp.id(752969523829972702.4652)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752969888473972703.4652)
,p_theme_id=>3
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
,p_css_classes=>'a-Button--gapRight'
,p_group_id=>wwv_flow_imp.id(752969816508972703.4652)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752970126233972703.4652)
,p_theme_id=>3
,p_name=>'LASTBUTTON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752970404302972703.4652)
,p_theme_id=>3
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_imp.id(752970373928972703.4652)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752970729154972703.4652)
,p_theme_id=>3
,p_name=>'PRIMARY'
,p_display_name=>'Primary'
,p_display_sequence=>1
,p_css_classes=>'a-Button--primary'
,p_group_id=>wwv_flow_imp.id(752970610131972703.4652)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752970828723972703.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752971067643972703.4652)
,p_theme_id=>3
,p_name=>'SMALL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752971248289972703.4652)
,p_theme_id=>3
,p_name=>'SMALLLEFT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752971412563972703.4652)
,p_theme_id=>3
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752971486301972703.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(752971590342972703.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793628379686489784.4652)
,p_theme_id=>3
,p_name=>'DISABLE'
,p_display_name=>'Disable'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(12080207088206014.4652)
,p_css_classes=>'a-Report--staticRowColors'
,p_group_id=>wwv_flow_imp.id(793628286525489784.4652)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793628760749489784.4652)
,p_theme_id=>3
,p_name=>'ENABLE'
...
,p_group_id=>wwv_flow_imp.id(793628595521489784.4652)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793629007882489784.4652)
,p_theme_id=>3
,p_name=>'NOBORDERS'
...
,p_group_id=>wwv_flow_imp.id(793628907307489784.4652)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793629245040489785.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793629473847489785.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793629555202489785.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793629791467489785.4652)
,p_theme_id=>3
,p_name=>'STRETCH'
...
,p_group_id=>wwv_flow_imp.id(793629694305489785.4652)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793637915221489802.4652)
,p_theme_id=>3
,p_name=>'DISABLE'
,p_display_name=>'Disable'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(703372107153632568.4652)
,p_css_classes=>'a-Report--staticRowColors'
,p_group_id=>wwv_flow_imp.id(793628286525489784.4652)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793638135830489802.4652)
,p_theme_id=>3
,p_name=>'ENABLE'
,p_display_name=>'Enable'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793638353930489802.4652)
,p_theme_id=>3
,p_name=>'NOBORDERS'
,p_display_name=>'No Borders'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793638482055489803.4652)
,p_theme_id=>3
,p_name=>'HORIZONTALBORDERS'
,p_display_name=>'Horizontal Borders'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793638736443489806.4652)
,p_theme_id=>3
,p_name=>'VERTICALBORDERS'
,p_display_name=>'Vertical Borders'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793638825903489806.4652)
,p_theme_id=>3
,p_name=>'INLINEBORDERS'
,p_display_name=>'Inline Borders'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(793639056671489806.4652)
,p_theme_id=>3
,p_name=>'STRETCH'
,p_display_name=>'Stretch'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(804039850748664666.4652)
,p_theme_id=>3
,p_name=>'REGIONCONTAINSITEMSTEXT'
,p_display_name=>'Region Contains Items / Text'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(697044757239351357.4652)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(804040047598664667.4652)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(757217841787959709.4652)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(804040227714664667.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(804040425333664668.4652)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
...
,p_group_id=>wwv_flow_imp.id(757217027408959709.4652)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(804040608630664668.4652)
,p_theme_id=>3
,p_name=>'NOPADDING'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(804040773255664668.4652)
,p_theme_id=>3
,p_name=>'WIZARDDIALOG'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(804040903463664668.4652)
,p_theme_id=>3
,p_name=>'VISIBLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(804041170030664668.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(932903997746247585.4652)
,p_theme_id=>3
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(394878606759890298.4652)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(932904093639247586.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(947203208588881643.4652)
,p_theme_id=>3
,p_name=>'SLIMPROGRESSLIST'
,p_display_name=>'Slim Progress List'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(694410403055228602.4652)
,p_css_classes=>'a-WizardSteps--slim'
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1206067706551572487.4652)
,p_theme_id=>3
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_imp.id(411397931291349067.4652)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_imp.id(752970373928972703.4652)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1532164284640722153.4652)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(205034121246397307.4652)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1532164381268722153.4652)
,p_theme_id=>3
,p_name=>'SHOWBADGES'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1532164504697722153.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1532164672594722153.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1532164873933722153.4652)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(1027581746419114496.4652)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1532165023409722154.4652)
,p_theme_id=>3
,p_name=>'FORALLITEMS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1551323683134018073.4652)
,p_theme_id=>3
,p_name=>'SHOWRIGHTARROW'
,p_display_name=>'Show Right Arrow'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(703376939640632578.4652)
,p_css_classes=>'a-LinksList--showArrow'
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1551323839353018073.4652)
,p_theme_id=>3
,p_name=>'USEBRIGHTHOVERS'
,p_display_name=>'Use Bright Hovers'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1551323909014018073.4652)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561321039672948443.4652)
,p_theme_id=>3
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(394867304186881833.4652)
,p_css_classes=>'a-Region--hideHeader'
,p_group_id=>wwv_flow_imp.id(757216252300959709.4652)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561321253855948443.4652)
,p_theme_id=>3
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561321417403948443.4652)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561321628882948443.4652)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561321862621948443.4652)
,p_theme_id=>3
,p_name=>'SIDEBAR'
...
,p_group_id=>wwv_flow_imp.id(757217561984959709.4652)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561322014141948443.4652)
,p_theme_id=>3
,p_name=>'BORDERLESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561322240097948443.4652)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(757218501215959709.4652)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561322457641948444.4652)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561322646198948444.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561322694314948444.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561322975290948444.4652)
,p_theme_id=>3
,p_name=>'SIMPLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561341112407066888.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561341186254066888.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561341370269066888.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561346951801082320.4652)
,p_theme_id=>3
,p_name=>'FLUSHREGION'
,p_display_name=>'Flush Region'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(697050653416351401.4652)
,p_css_classes=>'a-Region--flush'
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561347020555082320.4652)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561347264747082320.4652)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561347465808082320.4652)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561347673790082320.4652)
,p_theme_id=>3
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561347832081082320.4652)
,p_theme_id=>3
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561347989907082320.4652)
,p_theme_id=>3
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561348236951082320.4652)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561348469902082320.4652)
,p_theme_id=>3
,p_name=>'EXPANDED'
...
,p_group_id=>wwv_flow_imp.id(757230369532962928.4652)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561348606942082320.4652)
,p_theme_id=>3
,p_name=>'COLLAPSED'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561372507314090874.4652)
,p_theme_id=>3
,p_name=>'REMOVE_TOP_BORDER'
,p_display_name=>'Remove Top Border'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(695168763283587043.4652)
,p_css_classes=>'a-Region--noTopBorder'
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561372751152090874.4652)
,p_theme_id=>3
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561372965620090874.4652)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561373159771090874.4652)
,p_theme_id=>3
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561373280775090874.4652)
,p_theme_id=>3
,p_name=>'DEFAULTPADDING'
,p_display_name=>'Default Padding'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561373505424090874.4652)
,p_theme_id=>3
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561373700954090874.4652)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561373974864090874.4652)
,p_theme_id=>3
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561374166389090874.4652)
,p_theme_id=>3
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1561374334798090874.4652)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(39617993240769231.4652)
,p_build_option_name=>'Enable Approval Status'
,p_build_option_status=>'INCLUDE'
,p_version_scn=>37165770887393
);
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(320919295971935424.4652)
,p_build_option_name=>'file attachments'
,p_build_option_status=>'INCLUDE'
,p_version_scn=>37165770887393
);
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(699952074310045895.4652)
...
wwv_flow_imp_shared.create_shortcut(
 p_id=>wwv_flow_imp.id(22358093777479555.4652)
...
begin
wwv_flow_imp_shared.create_shortcut(
 p_id=>wwv_flow_imp.id(170338901610649539.4652)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(546448889396214216.4652)
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(19015092593808981.4652)
...
,p_version_scn=>2599267
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1745598043758006.4652)
,p_plugin_id=>wwv_flow_imp.id(19015092593808981.4652)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1746495926758007.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
,p_display_sequence=>10
,p_display_value=>'ADMIN: Ability to manage flow developer privileges'
,p_return_value=>'ADMIN'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1746992639758007.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1747431739758007.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1747926979758008.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1748468690758009.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1748984896758009.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1749461406758009.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1749905207758009.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1750455971758010.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1750990793758010.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1751450007758010.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1751935480758011.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1745960579758006.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1745598043758006.4652)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(44506806247251871.4652)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(80399334057909071.4652)
,p_plugin_type=>'ITEM TYPE'
,p_name=>'COM.ORACLE.APEX.SEARCHBOX'
,p_display_name=>'Zone de recherche'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1519674605118770086.4652)
,p_plugin_id=>wwv_flow_imp.id(80399334057909071.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1519675068153770086.4652)
,p_plugin_id=>wwv_flow_imp.id(80399334057909071.4652)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(120253183546205493.4652)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416911617167942565.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416912017057942565.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(416911617167942565.4652)
,p_display_sequence=>10
,p_display_value=>'OpenID Connect Provider'
,p_return_value=>'OPENID_CONNECT'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416912596341942566.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(416911617167942565.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416913034376942566.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(416911617167942565.4652)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416913598786942566.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(416911617167942565.4652)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416914029942942567.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(416911617167942565.4652)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416914477605942567.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416914855256942567.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416915273398942567.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416915662828942568.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416916011369942568.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416916482994942568.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416916803566942569.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416917259107942569.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416917637772942569.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416918033002942569.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(416917637772942569.4652)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416918555844942570.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(416917637772942569.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416919081314942570.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(416917637772942569.4652)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416919592630942570.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(416917637772942569.4652)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416920009535942571.4652)
,p_plugin_id=>wwv_flow_imp.id(125112662381475171.4652)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363179900279987746.4652)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363182688189987750.4652)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363214584124987785.4652)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308184995538529857.4652)
,p_plugin_id=>wwv_flow_imp.id(363214584124987785.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308185357475529858.4652)
,p_plugin_id=>wwv_flow_imp.id(363214584124987785.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308185725816529858.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(308185357475529858.4652)
,p_display_sequence=>10
,p_display_value=>'Redirect to Built-In URL'
,p_return_value=>'BUILTIN_URL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308186299931529858.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(308185357475529858.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308186733256529859.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(308185357475529858.4652)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308187294165529859.4652)
,p_plugin_id=>wwv_flow_imp.id(363214584124987785.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
,p_display_length=>60
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(308185357475529858.4652)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308187679773529859.4652)
,p_plugin_id=>wwv_flow_imp.id(363214584124987785.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308188099391529859.4652)
,p_plugin_id=>wwv_flow_imp.id(363214584124987785.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308188422654529860.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(308188099391529859.4652)
,p_display_sequence=>10
,p_display_value=>'Each Request'
,p_return_value=>'ALWAYS'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308188966170529860.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(308188099391529859.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308189499935529860.4652)
,p_plugin_id=>wwv_flow_imp.id(363214584124987785.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363284985190987839.4652)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(363285304610987839.4652)
,p_plugin_id=>wwv_flow_imp.id(363284985190987839.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(363285690700987839.4652)
,p_plugin_id=>wwv_flow_imp.id(363284985190987839.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(363286102167987839.4652)
,p_plugin_id=>wwv_flow_imp.id(363284985190987839.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(363286482756987839.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(363286102167987839.4652)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(363286994210987839.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(363286102167987839.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(363287495524987840.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(363286102167987839.4652)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(363287988453987840.4652)
,p_plugin_id=>wwv_flow_imp.id(363284985190987839.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(363288403380987841.4652)
,p_plugin_id=>wwv_flow_imp.id(363284985190987839.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(363288779793987841.4652)
,p_plugin_id=>wwv_flow_imp.id(363284985190987839.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(363288403380987841.4652)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(363289193175987841.4652)
,p_plugin_id=>wwv_flow_imp.id(363284985190987839.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(363289601107987841.4652)
,p_plugin_id=>wwv_flow_imp.id(363284985190987839.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(363290010979987841.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(363289601107987841.4652)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(363290491461987842.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(363289601107987841.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(363290998391987842.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(363289601107987841.4652)
,p_display_sequence=>30
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363326507272987869.4652)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_plugin_type=>'REGION TYPE'
,p_name=>'COM.ORACLE.APEX.HTML5_BAR_CHART'
,p_display_name=>unistr('Graphique \00E0 barres HTML 5 ***')
...
,p_version_scn=>2599268
,p_subscribe_plugin_settings=>true
,p_help_text=>unistr('<p>Ce module d''extension dessine des graphiques \00E0 barres horizontales contenant des libell\00E9s, des valeurs et m\00EAme des ic\00F4nes</p>')
,p_version_identifier=>'1.0'
,p_files_version=>16
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708882027568788162.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1708890161503788168.4652)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708882456315788163.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708882027568788162.4652)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708882908025788163.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708882027568788162.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708883385946788163.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708882027568788162.4652)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708883913265788164.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708884308602788164.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708884738587788164.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708885102368788165.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708885558870788165.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708885924214788165.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1708882027568788162.4652)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708886364744788166.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708886708045788166.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708887118777788166.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1708892893261788171.4652)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708887552870788166.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708887969287788167.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708887552870788166.4652)
,p_display_sequence=>10
,p_display_value=>'Value'
,p_return_value=>'VALUE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708888449760788167.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708887552870788166.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708888931742788167.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
...
,p_is_required=>false
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(1708887552870788166.4652)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708889353381788168.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708889718148788168.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708890161503788168.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708890493945788168.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708890161503788168.4652)
,p_display_sequence=>10
,p_display_value=>'Icon Chart'
,p_return_value=>'ICON'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708890990973788169.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708890161503788168.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708891577616788169.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708891951707788169.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708891577616788169.4652)
,p_display_sequence=>10
,p_display_value=>'Absolute'
,p_return_value=>'ABSOLUTE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708892408961788170.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708891577616788169.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708892893261788171.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708893367551788172.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708892893261788171.4652)
,p_display_sequence=>5
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708893822893788172.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708892893261788171.4652)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708894354160788173.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708892893261788171.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708894875437788173.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708892893261788171.4652)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708895324925788173.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708892893261788171.4652)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708895816036788174.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708892893261788171.4652)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708896332346788174.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708892893261788171.4652)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708896850110788174.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708897216124788175.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708896850110788174.4652)
,p_display_sequence=>10
,p_display_value=>'Above the bar'
,p_return_value=>'ABOVE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708897756955788175.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(1708896850110788174.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708898247285788176.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1708898490590788176.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(1708906125156788184.4652)
,p_plugin_id=>wwv_flow_imp.id(637620824431401115.4652)
,p_name=>'SOURCE_SQL'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_plugin_type=>'REGION TYPE'
,p_name=>'COM.ORACLE.APEX.LISTCALENDAR'
,p_display_name=>unistr('Calendrier de liste (g\00E9n\00E9rateur)')
...
,p_substitute_attributes=>true
,p_version_scn=>2599272
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
,p_files_version=>3
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397820664413465022.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397821055837465022.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397821379146465022.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397821789566465022.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397822203255465022.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397822650396465024.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397822982443465025.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397823379472465025.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397823877364465025.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397824199294465026.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397824621786465026.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397825010572465026.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397825337465465026.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397825775644465026.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2397826103144465026.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(851664399498374640.4652)
,p_plugin_id=>wwv_flow_imp.id(1524140959408925227.4652)
,p_name=>'SOURCE_SQL'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1823567055267032277.4652)
,p_plugin_type=>'REGION TYPE'
,p_name=>'COM.ORACLE.APEX.TAG_CLOUD'
,p_display_name=>unistr('Nuage de mots-cl\00E9s 2')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1823599236052064538.4652)
,p_plugin_id=>wwv_flow_imp.id(1823567055267032277.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1823600635837073993.4652)
,p_plugin_id=>wwv_flow_imp.id(1823567055267032277.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1823601446572077108.4652)
,p_plugin_id=>wwv_flow_imp.id(1823567055267032277.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(851664682476374645.4652)
,p_plugin_id=>wwv_flow_imp.id(1823567055267032277.4652)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(2081986255421507394.4652)
,p_plugin_type=>'DYNAMIC ACTION'
...
,p_substitute_attributes=>true
,p_version_scn=>2599281
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>L''action dynamique Ajouter la case Cocher tout convertit un en-t\00EAte de colonne contenant la cha\00EEne #CHECK_ALL_CHECKBOX# en case accessible permettant de s\00E9lectionner tous les styles, c''est-\00E0-dire d''activer ou de d\00E9sactiver toutes les cases dans la')
...
'<ol>',
unistr('<li>Dans la colonne d''\00E9tat, la valeur ''#CHECK_ALL_CHECKBOX#'' doit \00EAtre d\00E9finie comme valeur d''en-t\00EAte.</li>'),
unistr('<li>Pour l''attribut WHEN de l''action dynamique, s\00E9lectionnez la r\00E9gion d''\00E9tat contenant la colonne.</li>'),
unistr('<li>D\00E9finissez l''action dynamique en vue d''un d\00E9clenchement Apr\00E8s r\00E9g\00E9n\00E9ration et l''action sur D\00E9clencher lors du chargement de la page. Ces deux actions seront d\00E9finies sur les valeurs par d\00E9faut de fa\00E7on appropri\00E9e si l''action dynamique est cr\00E9\00E9e e')
||unistr('n s\00E9lectionnant la r\00E9gion dans la section Affichage du concepteur de page et en configurant l''action dynamique \00E0 partir de l\00E0.</li>'),
unistr('<li>Cela ne permet pas de g\00E9rer l''accessibilit\00E9 des cases \00E0 cocher affich\00E9es sur chaque ligne, ce qui doit \00EAtre effectu\00E9 s\00E9par\00E9ment dans la source de r\00E9gion. (Pour obtenir un exemple, reportez-vous \00E0 la r\00E9gion R\00E9gions 4000:656.)</li>'),
'</ol>',
'</p>'))
,p_version_identifier=>'1.0'
);
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_plugin_type=>'ITEM TYPE'
,p_name=>'COM_ORACLE_APEX_ADVANCED_AUTO_COMPLETE'
,p_display_name=>unistr('Ecriture automatique avanc\00E9e')
,p_supported_component_types=>'APEX_APPLICATION_PAGE_ITEMS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2691534418734540516.4652)
,p_plugin_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2342584773353561555.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(2691534418734540516.4652)
,p_display_sequence=>10
,p_display_value=>'Contains & Case Sensitive'
,p_return_value=>'CONTAINS_CASE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2342584865963561555.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(2691534418734540516.4652)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2342584959400561555.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(2691534418734540516.4652)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2342585064891561556.4652)
,p_plugin_attribute_id=>wwv_flow_imp.id(2691534418734540516.4652)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2691535316095549256.4652)
,p_plugin_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2691536100988554389.4652)
,p_plugin_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2691538313586567411.4652)
,p_plugin_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2691539328131571627.4652)
,p_plugin_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2691536714148558120.4652)
,p_plugin_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2691537603544564576.4652)
,p_plugin_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2691539909215575615.4652)
,p_plugin_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(851664953702374648.4652)
,p_plugin_id=>wwv_flow_imp.id(2691525227710316053.4652)
,p_name=>'LOV'
,p_sql_min_column_count=>1
,p_sql_max_column_count=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(394908475076949551.4652)
,p_plug_name=>'APEX 5 - Header'
,p_region_css_classes=>'a-Header apex-team-dev'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394873728911883775.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(394908594122949551.4652)
,p_plug_name=>'APEX 5 - Header Left'
,p_parent_plug_id=>wwv_flow_imp.id(394908475076949551.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79231985409259809.4652)
,p_plug_name=>'Navigation Tabs Landmark'
,p_parent_plug_id=>wwv_flow_imp.id(394908594122949551.4652)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394873728911883775.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(44351113134799252.4652)
,p_plug_name=>'APEX 5 - Tabs'
,p_region_name=>'a_Header_menu'
,p_parent_plug_id=>wwv_flow_imp.id(79231985409259809.4652)
...
,p_list_id=>wwv_flow_imp.id(6552444832780127.4652)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(394878284873890296.4652)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(394909071035949551.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(394908817654949551.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(394909456432949552.4652)
,p_plug_name=>'APEX 5 - Header Navigation Links'
,p_parent_plug_id=>wwv_flow_imp.id(394908817654949551.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2401445824991811.4652)
,p_plug_name=>'APEX 5 - Extensions Menu'
,p_region_name=>'extensionsMenu'
,p_parent_plug_id=>wwv_flow_imp.id(394909456432949552.4652)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394873728911883775.4652)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(5403068356838105.4652)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(394878606759890298.4652)
,p_translate_title=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(395026786198758463.4652)
...
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(704128726002003936.4652)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(394878606759890298.4652)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(493278321674841793.4652)
...
,p_plug_display_sequence=>40
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(704133729983005466.4652)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(394878606759890298.4652)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(394909624886949552.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(395027587170767222.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(395028410318768653.4652)
,p_plug_name=>'APEX 5 - Control Bar Left'
,p_parent_plug_id=>wwv_flow_imp.id(395027587170767222.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(395030356752782532.4652)
,p_plug_name=>'APEX 5 - Breadcrumb'
,p_parent_plug_id=>wwv_flow_imp.id(395028410318768653.4652)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394873728911883775.4652)
,p_plug_display_sequence=>1
,p_plug_display_point=>'SUB_REGIONS'
,p_menu_id=>wwv_flow_imp.id(6597377151972039.4652)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_imp.id(394880309395892667.4652)
,p_translate_title=>'N'
,p_landmark_type=>'navigation'
,p_landmark_label=>'Chemin de navigation'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(395028617538768653.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(735035084290168745.4652)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(394909456432949552.4652)
,p_button_name=>'UPGRADE_AVAILABLE'
,p_button_static_id=>'header-upgradeAvailable'
,p_button_action=>'REDIRECT_APP'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(395010959526687694.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(735034990074168744.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(240106685644619666.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2401531179991812.4652)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(394909456432949552.4652)
,p_button_name=>'EXTENSIONS'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(395010736604687693.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(391195356511472868.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(391195420544472869.4652)
...
,p_required_patch=>wwv_flow_imp.id(699952074310045895.4652)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(391195572456472870.4652)
...
,p_step_template=>wwv_flow_imp.id(643947460795988298.4652)
,p_help_text=>'td_fb.htm'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(183879507146779002.4652)
,p_plug_name=>unistr('ic\00F4nes de navigation')
,p_region_name=>'apex-control-icons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(415202027252589471.4652)
,p_plug_display_sequence=>40
...
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_imp.id(183873395194737719.4652)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(216948000482610776.4652)
,p_plug_display_condition_type=>'NEVER'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(188229705449085384.4652)
,p_plug_name=>'Onglets d''informations en retour'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(813554394221812426.4652)
,p_plug_display_sequence=>10
,p_plug_new_grid=>true
,p_list_id=>wwv_flow_imp.id(188228600364085362.4652)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(188948529125031038.4652)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(786390949359884461.4652)
,p_plug_name=>'Informations en retour'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(684869836739871122.4652)
,p_plug_display_sequence=>40
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(648830527108355777.4652)
...
,p_heading=>unistr('Score d''\00E9valuation')
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(648830847622355780.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786391081625884463.4652)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786391239547884464.4652)
,p_name=>'EMAIL'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786391303803884465.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786391462196884466.4652)
...
,p_is_query_only=>true
,p_item_type=>'NATIVE_DISPLAY_ONLY'
,p_heading=>'Informations en retour'
,p_heading_alignment=>'CENTER'
,p_display_sequence=>60
,p_value_alignment=>'LEFT'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786391529279884467.4652)
...
,p_lov_null_text=>unistr('- s\00E9lectionner un type - ')
,p_enable_filter=>true
,p_filter_operators=>'C:S:CASE_INSENSITIVE:REGEXP'
,p_filter_is_required=>false
,p_filter_text_case=>'MIXED'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786391714557884469.4652)
...
,p_lov_display_extra=>true
,p_lov_display_null=>true
,p_lov_null_text=>unistr('- s\00E9lectionner un statut - ')
,p_enable_filter=>true
,p_filter_operators=>'C:S:CASE_INSENSITIVE:REGEXP'
,p_filter_is_required=>false
,p_filter_text_case=>'MIXED'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786392005177884472.4652)
,p_name=>'TAGS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786392267442884474.4652)
...
,p_heading=>unistr('Commentaire de d\00E9veloppeur')
,p_heading_alignment=>'CENTER'
,p_display_sequence=>120
,p_value_alignment=>'LEFT'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786392575396884477.4652)
...
,p_is_query_only=>false
,p_item_type=>'NATIVE_TEXTAREA'
,p_heading=>unistr('R\00E9ponse publique')
,p_heading_alignment=>'CENTER'
,p_display_sequence=>130
,p_value_alignment=>'LEFT'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786392634730884478.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786392736377884479.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786392840095884480.4652)
,p_name=>'PAGE_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786392948020884481.4652)
,p_name=>'PAGE_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393046058884482.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393080350884483.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393234214884484.4652)
,p_name=>'SESSION_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393374178884485.4652)
,p_name=>'APEX_USER'
,p_source_type=>'DB_COLUMN'
...
,p_is_query_only=>true
,p_item_type=>'NATIVE_DISPLAY_ONLY'
,p_heading=>unistr('Enregistr\00E9 par')
,p_heading_alignment=>'CENTER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393475816884486.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393518532884487.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393622015884488.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393700675884489.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393790483884490.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393887236884491.4652)
,p_name=>'REMOTE_ADDR'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786393982023884492.4652)
,p_name=>'REMOTE_USER'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394161216884493.4652)
,p_name=>'HTTP_HOST'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394228378884494.4652)
,p_name=>'SERVER_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394295712884495.4652)
,p_name=>'SERVER_PORT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394445914884496.4652)
,p_name=>'CREATED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394539782884497.4652)
,p_name=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394674246884498.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394738235884499.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394805236884500.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394951870884501.4652)
,p_name=>'UPDATED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786394987929884502.4652)
,p_name=>'UPDATED_ON'
,p_source_type=>'DB_COLUMN'
...
,p_is_query_only=>true
,p_item_type=>'NATIVE_DISPLAY_ONLY'
,p_heading=>unistr('Mis \00E0 jour')
,p_heading_alignment=>'CENTER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786395158032884503.4652)
,p_name=>'OS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786395202835884504.4652)
,p_name=>'BROWSER'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786395348622884505.4652)
,p_name=>'FOLLOWUPS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786395444873884506.4652)
,p_name=>'ATTRIBUTE_01'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786395525667884507.4652)
,p_name=>'ATTRIBUTE_02'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786395584388884508.4652)
,p_name=>'ATTRIBUTE_03'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786395697333884509.4652)
,p_name=>'ATTRIBUTE_04'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786395823540884510.4652)
,p_name=>'ATTRIBUTE_05'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786396378173888161.4652)
,p_name=>'ATTRIBUTE_06'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786396410566888162.4652)
,p_name=>'ATTRIBUTE_07'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786396572247888163.4652)
,p_name=>'ATTRIBUTE_08'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786396646624888164.4652)
,p_name=>'LABEL_01'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786396721524888165.4652)
,p_name=>'LABEL_02'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786396815378888166.4652)
,p_name=>'LABEL_03'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786396913466888167.4652)
,p_name=>'LABEL_04'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786396981156888168.4652)
,p_name=>'LABEL_05'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786397155151888169.4652)
,p_name=>'LABEL_06'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786397240598888170.4652)
,p_name=>'LABEL_07'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786397335789888171.4652)
,p_name=>'LABEL_08'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786397469953888172.4652)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(786397563724888173.4652)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(786390987270884462.4652)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(786401902417889038.4652)
,p_interactive_grid_id=>wwv_flow_imp.id(786390987270884462.4652)
,p_name=>'Ouvrir les informations en retour'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(786402073300889038.4652)
,p_report_id=>wwv_flow_imp.id(786401902417889038.4652)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1609043013046105381.4652)
,p_interactive_grid_id=>wwv_flow_imp.id(786390987270884462.4652)
,p_name=>'Toutes les informations en retour'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1609043183929105381.4652)
,p_report_id=>wwv_flow_imp.id(1609043013046105381.4652)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(188148712767209171.4652)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(188148919347211016.4652)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796740903850267464.4652)
,p_name=>'Refresh'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(786390949359884461.4652)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796741074661267465.4652)
,p_event_id=>wwv_flow_imp.id(796740903850267464.4652)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(786390949359884461.4652)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(786397662560888174.4652)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(786390949359884461.4652)
...
,p_internal_uid=>786397662560888174.4652
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>8001.4652
,p_name=>'Visualiser/modifier les informations en retour'
,p_alias=>'VIEW-EDIT-FEEDBACK'
,p_page_mode=>'MODAL'
,p_step_title=>'Visualiser/modifier les informations en retour'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_javascript_code=>'htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_step_template=>wwv_flow_imp.id(700758032440987611.4652)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_height=>'600'
,p_dialog_width=>'980'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52802303312219147.4652)
,p_plug_name=>unistr('S\00E9lecteur d''affichage de r\00E9gion')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(62139511251715892.4652)
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(188159097794270530.4652)
,p_plug_name=>'Informations en retour'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'Y'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(188167088881277892.4652)
,p_plug_name=>unistr('D\00E9tails des informations en retour')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(697044757239351357.4652)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(188167711045284350.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(188167920049286931.4652)
,p_plug_name=>'Contexte d''application'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(188168202518291361.4652)
,p_plug_name=>'Horodatage'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(188172406636339828.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(189568612980104568.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(208469999102865510.4652)
,p_plug_name=>unistr('Attributs suppl\00E9mentaires')
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(441741688554040550.4652)
,p_name=>'Suivi'
,p_region_name=>'abc'
,p_template=>wwv_flow_imp.id(394867304186881833.4652)
,p_display_sequence=>50
,p_include_in_reg_disp_sel_yn=>'Y'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
...
,p_fixed_header=>'NONE'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_imp.id(703372107153632568.4652)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(441742000838040564.4652)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(441742110535040566.4652)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(441742209509040566.4652)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(441742286382040566.4652)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(188159592358270532.4652)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(188167088881277892.4652)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(411369261610169638.4652)
,p_button_image_alt=>'Annuler'
,p_button_position=>'CLOSE'
,p_button_execute_validations=>'N'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(188159408440270532.4652)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(188167088881277892.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(188159316393270532.4652)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(188167088881277892.4652)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6446290793807319.4652)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_imp.id(189568612980104568.4652)
,p_button_name=>'APPLY_CHANGES_LOG_AS_ISSUE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:a-Button--primary'
,p_button_template_id=>wwv_flow_imp.id(411369261610169638.4652)
,p_button_image_alt=>unistr('Consigner en tant que probl\00E8me')
,p_button_position=>'NEXT'
,p_button_condition=>'P8001_ISSUE_ID'
,p_button_condition_type=>'ITEM_IS_NULL'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(156403182605150734.4652)
...
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(6446290793807319.4652)
,p_branch_sequence=>40
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(156403524363150738.4652)
,p_name=>'P8001_ISSUE_ID'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(189568612980104568.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Consign\00E9 en tant que probl\00E8me')
,p_source=>'ISSUE_ID'
,p_source_type=>'DB_COLUMN'
...
,p_field_template=>wwv_flow_imp.id(493950867964259075.4652)
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Fonctionnalit\00E9 cr\00E9\00E9e en fonction de cette entr\00E9e d''informations en retour, le cas \00E9ch\00E9ant.')
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188160313626270538.4652)
,p_name=>'P8001_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(188159097794270530.4652)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188160518810270538.4652)
,p_name=>'P8001_FEEDBACK_COMMENT'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(188159097794270530.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Commentaire fourni par l''utilisateur :'
...
,p_field_template=>wwv_flow_imp.id(694415461746261220.4652)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>'Informations en retour fournies par l''utilisateur'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'auto_height', 'N',
  'character_counter', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188160891682270539.4652)
...
,p_field_template=>wwv_flow_imp.id(493950978277259098.4652)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188161107343270540.4652)
...
,p_display_as=>'NATIVE_HIDDEN'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Application sur laquelle les informations en retour ont \00E9t\00E9 fournies.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188161303385270540.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188161501862270540.4652)
...
,p_display_as=>'NATIVE_HIDDEN'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Page de l''application sur laquelle les informations en retour ont \00E9t\00E9 fournies.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188161699990270540.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188161910335270541.4652)
,p_name=>'P8001_PAGE_LAST_UPDATED_BY'
,p_item_sequence=>400
,p_item_plug_id=>wwv_flow_imp.id(188167920049286931.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Mise \00E0 jour de la page effectu\00E9e par :')
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('D\00E9veloppeur \00E0 l''origine de la derni\00E8re mise \00E0 jour de la page r\00E9f\00E9renc\00E9e.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188162088570270541.4652)
,p_name=>'P8001_PAGE_LAST_UPDATED_ON'
,p_item_sequence=>410
,p_item_plug_id=>wwv_flow_imp.id(188167920049286931.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Page mise \00E0 jour :')
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Date de la derni\00E8re mise \00E0 jour de la page r\00E9f\00E9renc\00E9e.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188162312580270541.4652)
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('ID de session en cours lors de la cr\00E9ation des informations en retour.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188162519115270542.4652)
,p_name=>'P8001_APEX_USER'
,p_item_sequence=>430
,p_item_plug_id=>wwv_flow_imp.id(188167920049286931.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Utilisateur d''application :'
,p_source=>'APEX_USER'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_imp.id(493950867964259075.4652)
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Nom de l''utilisateur ayant fourni les informations en retour.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188162716849270542.4652)
,p_name=>'P8001_APPLICATION_VERSION'
,p_item_sequence=>440
,p_item_plug_id=>wwv_flow_imp.id(188167920049286931.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Version de l''application :'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Version de l''application associ\00E9e.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188162917810270542.4652)
,p_name=>'P8001_SESSION_STATE'
,p_item_sequence=>530
,p_item_plug_id=>wwv_flow_imp.id(188172406636339828.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Statut de session :'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('Statut de session en cours lors de la cr\00E9ation des informations en retour.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188163119374270542.4652)
...
,p_field_template=>wwv_flow_imp.id(493950867964259075.4652)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('Sch\00E9ma d''analyse de l''application en cours lors de la cr\00E9ation des informations en retour.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188163317405270543.4652)
,p_name=>'P8001_HTTP_USER_AGENT'
,p_item_sequence=>460
,p_item_plug_id=>wwv_flow_imp.id(188167711045284350.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Agent utilisateur HTTP :'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Agent utilisateur HTTP sur lequel les informations en retour ont \00E9t\00E9 fournies (peut \00EAtre diff\00E9rent de l''endroit o\00F9 les informations en retour sont v\00E9rifi\00E9es).')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188163508924270543.4652)
,p_name=>'P8001_REMOTE_ADDR'
,p_item_sequence=>470
,p_item_plug_id=>wwv_flow_imp.id(188167711045284350.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Adresse distante :'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Adresse distante sur laquelle les informations en retour ont \00E9t\00E9 fournies (peut \00EAtre diff\00E9rente de l''endroit o\00F9 les informations en retour sont v\00E9rifi\00E9es).')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188163714101270543.4652)
,p_name=>'P8001_REMOTE_USER'
,p_item_sequence=>480
,p_item_plug_id=>wwv_flow_imp.id(188167711045284350.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Utilisateur distant :'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Utilisateur distant sur lequel les informations en retour ont \00E9t\00E9 fournies.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188163909298270543.4652)
,p_name=>'P8001_HTTP_HOST'
,p_item_sequence=>490
,p_item_plug_id=>wwv_flow_imp.id(188167711045284350.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('H\00F4te HTTP :')
,p_source=>'HTTP_HOST'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_imp.id(493950867964259075.4652)
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('H\00F4te HTTP sur lequel les informations en retour ont \00E9t\00E9 fournies (peut \00EAtre diff\00E9rent de l''endroit o\00F9 les informations en retour sont v\00E9rifi\00E9es).')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188164113713270544.4652)
,p_name=>'P8001_SERVER_NAME'
,p_item_sequence=>500
,p_item_plug_id=>wwv_flow_imp.id(188167711045284350.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Nom du serveur :'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Nom du serveur sur lequel les informations en retour ont \00E9t\00E9 fournies (peut \00EAtre diff\00E9rent de l''endroit o\00F9 les informations en retour sont v\00E9rifi\00E9es).')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188164306557270544.4652)
,p_name=>'P8001_SERVER_PORT'
,p_item_sequence=>510
,p_item_plug_id=>wwv_flow_imp.id(188167711045284350.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Port du serveur :'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Port du serveur sur lequel les informations en retour ont \00E9t\00E9 fournies (peut \00EAtre diff\00E9rent de l''endroit o\00F9 les informations en retour sont v\00E9rifi\00E9es).')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188164499938270544.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188165503258270545.4652)
,p_name=>'P8001_UPDATED_ON'
,p_item_sequence=>540
,p_item_plug_id=>wwv_flow_imp.id(188168202518291361.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Mis \00E0 jour le :')
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Date de la derni\00E8re mise \00E0 jour des informations en retour.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188182117727418652.4652)
...
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Statut des informations en retour tel que d\00E9fini par les d\00E9veloppeurs qui les v\00E9rifient.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188189308995510758.4652)
,p_name=>'P8001_UPDATED_BY'
,p_item_sequence=>550
,p_item_plug_id=>wwv_flow_imp.id(188168202518291361.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Mis \00E0 jour par :')
,p_source=>'UPDATED_BY'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_imp.id(493950867964259075.4652)
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('D\00E9veloppeur \00E0 l''origine de la derni\00E8re mise \00E0 jour des informations en retour.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188189520076513942.4652)
,p_name=>'P8001_CREATED_ON'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(188159097794270530.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Cr\00E9\00E9 :')
,p_format_mask=>'SINCE'
,p_source=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188192389264580763.4652)
,p_name=>'P8001_SESSION_INFO'
,p_item_sequence=>520
,p_item_plug_id=>wwv_flow_imp.id(188172406636339828.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Informations d''en-t\00EAte de session :')
,p_source=>'SESSION_INFO'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_imp.id(694415461746261220.4652)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('Informations de session recueillies lorsque les informations en retour ont \00E9t\00E9 fournies.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188498293509572948.4652)
,p_name=>'P8001_DEVELOPER_COMMENT'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(189568612980104568.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Commentaire de d\00E9veloppeur')
...
,p_field_template=>wwv_flow_imp.id(694415461746261220.4652)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>unistr('Les commentaires de d\00E9veloppeur augmentent les informations en retour fournies par l''utilisateur. Ils ne sont pas rendus publics.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'auto_height', 'N',
  'character_counter', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208474578586878506.4652)
,p_name=>'P8001_ATTRIBUTE_01'
,p_item_sequence=>250
,p_item_plug_id=>wwv_flow_imp.id(208469999102865510.4652)
,p_use_cache_before_default=>'NO'
,p_source=>'ATTRIBUTE_01'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_imp.id(694416725694263392.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208475305036895604.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208475478848897532.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208475688891900409.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208475897549902937.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208476101358904028.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208476405167905160.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208476610016906588.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(210204482275456228.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299750702299378231.4652)
,p_name=>'P8001_PUBLIC_RESPONSE'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(189568612980104568.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('R\00E9ponse publique')
...
,p_field_template=>wwv_flow_imp.id(694415461746261220.4652)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>unistr('R\00E9ponse rendue publique.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'auto_height', 'N',
  'character_counter', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299754794297423312.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299755491096441310.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299755902178444505.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299756288803450056.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299756599884453304.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299756909927456148.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299757186856458951.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299757505556464405.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299758186210487165.4652)
,p_name=>'P8001_TAGS'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(189568612980104568.4652)
,p_use_cache_before_default=>'NO'
...
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Les balises sont des mots-cl\00E9s d\00E9crivant plus en d\00E9tail ces informations en retour. S\00E9parez les balises par des virgules. Les balises sont affich\00E9es dans une colonne diff\00E9rente de la vue de l''\00E9tat.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'case_sensitive', 'N',
  'display_as', 'POPUP',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(436386503779193988.4652)
,p_name=>'P8001_FEEDBACK_NUMBER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(188159097794270530.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Num\00E9ro :')
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(441743007170064809.4652)
,p_name=>'P8001_FOLLOW_UP'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_imp.id(441741688554040550.4652)
,p_prompt=>'Entrez le nouveau suivi :'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>80
,p_cMaxlength=>4000
,p_cHeight=>5
,p_field_template=>wwv_flow_imp.id(694415461746261220.4652)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>'Nouveaux commentaires de suivi.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'auto_height', 'Y',
  'character_counter', 'Y',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(479251886768025308.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(479252702352029777.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(648831064414355782.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796741107538267466.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796741180037267467.4652)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796740607232267461.4652)
,p_name=>'Cancel Dialog'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(188159592358270532.4652)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796740702919267462.4652)
,p_event_id=>wwv_flow_imp.id(796740607232267461.4652)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(188165817323270546.4652)
,p_process_sequence=>10
...
,p_internal_uid=>188165817323270546.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(11896626345815992.4652)
...
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>'Impossible de supprimer la ligne de la table WWV_FLOW_FEEDBACK.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(188159408440270532.4652)
,p_process_success_message=>unistr('Informations en retour supprim\00E9es.')
,p_internal_uid=>11896626345815992.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(188166019668270546.4652)
...
,p_attribute_11=>'U'
,p_attribute_12=>'Y'
,p_process_error_message=>'Impossible de traiter la ligne de la table WWV_FLOW_FEEDBACK.'
,p_process_when=>'DELETE'
,p_process_when_type=>'REQUEST_NOT_EQUAL_CONDITION'
,p_process_success_message=>unistr('Action trait\00E9e.')
,p_internal_uid=>188166019668270546.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(441743186307077669.4652)
...
'end if;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>441743186307077669.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(188166199532270546.4652)
...
,p_attribute_04=>'8001'
,p_process_when_button_id=>wwv_flow_imp.id(188159408440270532.4652)
,p_internal_uid=>188166199532270546.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(796740853284267463.4652)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(188159316393270532.4652)
,p_internal_uid=>796740853284267463.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(833256295190925568.4652)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(188159408440270532.4652)
,p_internal_uid=>833256295190925568.4652
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>8004.4652
,p_name=>unistr('Convertir les informations en retour en probl\00E8me')
,p_alias=>'CONVERT-FEEDBACK-TO-ISSUE'
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Convertir les informations en retour en probl\00E8me')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(700758032440987611.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(669041394654726555.4652)
,p_plug_name=>unistr('D\00E9tails du probl\00E8me')
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(669378289164830208.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1314088873816737824.4652)
,p_plug_name=>'Informations en retour'
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>unistr('La conversion en probl\00E8me des informations en retour permettra de d\00E9finir le statut des informations en retour comme ferm\00E9. Saisissez une r\00E9ponse publique pour les informations en retour.')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(480840454893812322.4652)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(669378289164830208.4652)
,p_button_name=>'Cancel'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(411369261610169638.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(480840896504812326.4652)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(669378289164830208.4652)
...
,p_button_template_id=>wwv_flow_imp.id(411369261610169638.4652)
,p_button_is_hot=>'Y'
,p_button_image_alt=>unistr('Cr\00E9er un probl\00E8me')
,p_button_position=>'CREATE'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(156403361748150736.4652)
,p_name=>'P8004_ISSUE_TEXT'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(669041394654726555.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Texte du probl\00E8me')
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_issue_text     clob;',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480833378598812303.4652)
,p_name=>'P8004_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(669041394654726555.4652)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480833737137812307.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480834157941812308.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480834501275812310.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480834930520812310.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480835399469812311.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480835723561812312.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480836106130812312.4652)
,p_name=>'P8004_ISSUE_TITLE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(669041394654726555.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Titre du probl\00E8me')
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480838300786812315.4652)
,p_name=>'P8004_ASSIGNED_TO'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(669041394654726555.4652)
,p_prompt=>unistr('Affecter \00E0')
,p_display_as=>'NATIVE_SELECT_LIST'
...
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Personnes devant \00EAtre affect\00E9es au probl\00E8me. ')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
,p_multi_value_type=>'SEPARATED'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(480841511020812328.4652)
,p_name=>'P8004_PUBLIC_RESPONSE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1314088873816737824.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('R\00E9ponse publique')
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(480843630638812345.4652)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(480840454893812322.4652)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(480844126329812346.4652)
,p_event_id=>wwv_flow_imp.id(480843630638812345.4652)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(156403485807150737.4652)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(480840896504812326.4652)
,p_internal_uid=>156403485807150737.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(480843285261812342.4652)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>480843285261812342.4652
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>8005.4652
,p_name=>'Informations en retour par utilisateur'
,p_alias=>'FEEDBACK-BY-USER'
,p_step_title=>'Informations en retour par utilisateur'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(643947460795988298.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(188237012174163760.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(638522961229835782.4652)
,p_plug_name=>unistr('Informations en retour par cr\00E9ateur')
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(638523033329835783.4652)
,p_max_row_count=>'10000'
,p_max_row_count_message=>unistr('Cette requ\00EAte renvoie plus de 10 000 lignes. Filtrez vos donn\00E9es pour \00EAtre s\00FBr d''obtenir des r\00E9sultats complets.')
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(638523104947835784.4652)
,p_db_column_name=>'FILING_USER'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>unistr('Cr\00E9ateur')
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(638523224211835785.4652)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(638523299506835786.4652)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(638523399552835787.4652)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(638523555620835788.4652)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(645439567443372925.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(189940683950984914.4652)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(638522961229835782.4652)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(188494915083361628.4652)
...
wwv_flow_imp_page.create_page(
 p_id=>8011.4652
,p_name=>'Calendrier des informations en retour'
,p_alias=>'FEEDBACK-CALENDAR'
,p_step_title=>'Calendrier des informations en retour'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(643947460795988298.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(189006196529072390.4652)
,p_plug_name=>'Feedback Tabs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394873728911883775.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(652741910848752619.4652)
,p_plug_name=>'Informations en retour par jour'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(189009913949097289.4652)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_internal_uid=>189009913949097289.4652
,p_process_comment=>'Generated 31-AUG-09'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(189010317350097292.4652)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>'Erreur lors du changement de la date de calendrier.'
,p_internal_uid=>189010317350097292.4652
,p_process_comment=>'Generated 31-AUG-09'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(189011903736097293.4652)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>'Erreur lors du changement de la date de calendrier.'
,p_internal_uid=>189011903736097293.4652
,p_process_comment=>'Generated 31-AUG-09'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(189011502040097293.4652)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>'Erreur lors du changement de la date de calendrier.'
,p_internal_uid=>189011502040097293.4652
,p_process_comment=>'Generated 31-AUG-09'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(189011107025097292.4652)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>'Erreur lors du changement de la date de calendrier.'
,p_internal_uid=>189011107025097292.4652
,p_process_comment=>'Generated 31-AUG-09'
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>8012.4652
,p_name=>'Tableau de bord des informations en retour'
,p_alias=>'FEEDBACK-DASHBOARD'
,p_step_title=>'Tableau de bord des informations en retour'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(395644842192767482.4652)
,p_page_template_options=>'#DEFAULT#'
,p_help_text=>'td_fb.htm'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15581443644474518.4652)
,p_plug_name=>'Ouvrir les informations en retour'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(183898105527986684.4652)
,p_plug_name=>unistr('ic\00F4nes de navigation')
,p_region_name=>'apex-control-icons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
,p_plug_display_point=>'REGION_POSITION_06'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_imp.id(183892999331937539.4652)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(216948000482610776.4652)
,p_plug_display_condition_type=>'NEVER'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(189502805888823452.4652)
,p_plug_name=>'Feedback Tabs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394873728911883775.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(189503001435823453.4652)
,p_plug_name=>'Top Bar'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(198426105113535390.4652)
,p_plug_name=>'A propos de'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>Vous pouvez imbriquer des liens d''informations en retour dans les applications de fa\00E7on d\00E9clarative \00E0 l''aide des entr\00E9es de barre de navigation ou en codant un lien en dur. Les utilisateurs ex\00E9cutant une application peuvent ainsi fournir des infor')
||unistr('mations en retour et ceux ayant acc\00E8s au d\00E9veloppement d''\00E9quipe dans &PRODUCT_NAME. peuvent g\00E9rer ces informations et les convertir en probl\00E8me.</p>'),
'',
'<p><a target="_blank" href="&SYSTEM_HELP_URL.">En savoir plus...</a></p>'))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(243191786516347065.4652)
,p_plug_name=>'Par statut'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
,p_plug_display_sequence=>70
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(437288102003925282.4652)
...
,p_fixed_header=>'NONE'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_imp.id(395652746647870440.4652)
,p_query_num_rows=>10
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>unistr('L''\00E9tat ne contient aucune donn\00E9e')
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(437290285857930008.4652)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(437294004951963907.4652)
,p_query_column_id=>2
,p_column_alias=>'DEVELOPER_COMMENTS'
,p_column_display_sequence=>2
,p_column_heading=>unistr('Entr\00E9es avec des commentaires de d\00E9veloppeur')
,p_column_format=>'999G999G999G999G999G990'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(437294104902963907.4652)
,p_query_column_id=>3
,p_column_alias=>'PUBLIC_RESPONSES'
,p_column_display_sequence=>3
,p_column_heading=>unistr('Entr\00E9es avec des r\00E9ponses publiques')
,p_column_format=>'999G999G999G999G999G990'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(437294390799988260.4652)
,p_query_column_id=>4
,p_column_alias=>'NO_PUBLIC_RESPONSE'
,p_column_display_sequence=>4
,p_column_heading=>unistr('Entr\00E9es sans r\00E9ponse publique')
,p_column_format=>'999G999G999G999G999G990'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(437310684844557022.4652)
,p_query_column_id=>5
,p_column_alias=>'DISTINCT_FILERS'
,p_column_display_sequence=>5
,p_column_heading=>'Serveurs de fichiers distincts'
,p_column_format=>'999G999G999G999G999G990'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(441218196716021605.4652)
,p_query_column_id=>6
,p_column_alias=>'FEEDBACK_LAST_24_HOURS'
,p_column_display_sequence=>6
,p_column_heading=>unistr('Informations en retour pour les derni\00E8res 24 heures')
,p_column_format=>'999G999G999G999G999G990'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(441218298037021606.4652)
,p_query_column_id=>7
,p_column_alias=>'FEEDBACK_LAST_WEEK'
,p_column_display_sequence=>7
,p_column_heading=>unistr('Informations en retour pour la semaine derni\00E8re')
,p_column_format=>'999G999G999G999G999G990'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(637727722500778262.4652)
,p_plug_name=>'Utilisateurs d''informations en retour'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
,p_plug_display_sequence=>50
,p_plug_new_grid_row=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(637728780217823379.4652)
,p_plug_name=>unistr('Entr\00E9es d''informations en retour')
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
,p_plug_display_sequence=>60
,p_plug_new_grid_row=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(643943110948981847.4652)
,p_plug_name=>'Par application'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
,p_plug_display_sequence=>80
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(643949967181020618.4652)
,p_plug_name=>'Par serveur de fichiers'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
,p_plug_display_sequence=>90
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(186679682569512687.4652)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(189503001435823453.4652)
,p_button_name=>'RESET'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(308205889752201939.4652)
,p_button_image_alt=>unistr('R\00E9g\00E9n\00E9rer')
,p_button_position=>'CREATE'
,p_button_redirect_url=>'f?p=&APP_ID.:8012:&SESSION.::&DEBUG.:RP,8012::'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(189506207222823462.4652)
...
wwv_flow_imp_page.create_page(
 p_id=>8014.4652
,p_name=>'Modifier le suivi des informations en retour'
,p_alias=>'EDIT-FEEDBACK-FOLLOW-UP'
,p_page_mode=>'MODAL'
,p_step_title=>'Modifier le suivi des informations en retour'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_step_template=>wwv_flow_imp.id(676701755252252907.4652)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_height=>'600'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(120624590485546673.4652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(120625190471546675.4652)
,p_plug_name=>'Informations en retour'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394873728911883775.4652)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(120628796802546678.4652)
,p_name=>'Suivi existant'
,p_template=>wwv_flow_imp.id(697050653416351401.4652)
,p_display_sequence=>60
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(120629009062546679.4652)
,p_query_column_id=>1
,p_column_alias=>'FOLLOW_UP'
,p_column_display_sequence=>2
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(120629083416546680.4652)
,p_query_column_id=>2
,p_column_alias=>'CREATED_ON'
,p_column_display_sequence=>1
,p_column_format=>'SINCE'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(120629202780546680.4652)
,p_query_column_id=>3
,p_column_alias=>'CREATED_BY'
,p_column_display_sequence=>3
,p_lov_show_nulls=>'NO'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(120756782151569464.4652)
,p_plug_name=>'Suivi'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(394867304186881833.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(976558551665280673.4652)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(120624590485546673.4652)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(411369261610169638.4652)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(120757089022569465.4652)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(120624590485546673.4652)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(120756998059569465.4652)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(120624590485546673.4652)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120625385175546675.4652)
,p_name=>'P8014_FEEDBACK'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(120625190471546675.4652)
,p_prompt=>'Informations en retour :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_imp.id(694415461746261220.4652)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Informations en retour fournies.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120625909068546675.4652)
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Identifie depuis combien de temps les informations en retour ont \00E9t\00E9 fournies.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120626386669546676.4652)
,p_name=>'P8014_FEEDBACK_CREATED_BY'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(120625190471546675.4652)
,p_prompt=>unistr('Enregistr\00E9 par :')
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_cAttributes=>'nowrap'
,p_tag_css_classes=>'fielddatabold'
,p_begin_on_new_line=>'N'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Utilisateur ayant fourni les informations en retour.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120626898484546676.4652)
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Application associ\00E9e.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120627394783546677.4652)
,p_name=>'P8014_PAGE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(120625190471546675.4652)
,p_prompt=>'Page :'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Page associ\00E9e aux informations en retour.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120758004158569468.4652)
,p_name=>'P8014_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_imp.id(120756782151569464.4652)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120758181571569474.4652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120758392033569476.4652)
...
,p_field_template=>wwv_flow_imp.id(493950978277259098.4652)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('Modifiez cette entr\00E9e d''informations en retour de suivi.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'auto_height', 'N',
  'character_counter', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120758591771569476.4652)
,p_name=>'P8014_EMAIL'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(120756782151569464.4652)
,p_use_cache_before_default=>'NO'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Courriel de la personne assurant le suivi.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'disabled', 'N',
  'send_on_page_submit', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120758781884569476.4652)
,p_name=>'P8014_CREATED_BY'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(120756782151569464.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Cr\00E9ation par :')
,p_source=>'CREATED_BY'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_label_alignment=>'RIGHT'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Utilisateur ayant cr\00E9\00E9 cette entr\00E9e de suivi.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120759010214569476.4652)
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Date de cr\00E9ation de cette entr\00E9e de suivi.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120759379158569478.4652)
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Utilisateur \00E0 l''origine de la derni\00E8re mise \00E0 jour de cette entr\00E9e de suivi.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120759598066569479.4652)
,p_name=>'P8014_UPDATED_ON'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(120756782151569464.4652)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Mis \00E0 jour :')
,p_format_mask=>'&DATE_FORMAT.'
,p_source=>'UPDATED_ON'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('Date de la derni\00E8re mise \00E0 jour de cette entr\00E9e de suivi.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(120760091879569479.4652)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
,p_attribute_04=>'ID'
,p_attribute_14=>'N'
,p_internal_uid=>120760091879569479.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(120630194421546687.4652)
,p_process_sequence=>20
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
'end loop;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>120630194421546687.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(120760307864569479.4652)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>unistr('Action trait\00E9e.')
,p_internal_uid=>120760307864569479.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(120760503471569480.4652)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_attribute_04=>'8014'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(120757089022569465.4652)
,p_internal_uid=>120760503471569480.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(761803538295376901.4652)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'New'
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>761803538295376901.4652
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(976558582481280674.4652)
,p_process_sequence=>60
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(976558551665280673.4652)
,p_internal_uid=>976558582481280674.4652
);
end;
/
