...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A128800226580716746')
...
,p_authentication_id=>wwv_flow_imp.id(108165525079033088.4702)
,p_populate_roles=>'A'
...
,p_substitution_value_12=>unistr('Copyright &copy; 1999, 2024, Oracle et/ou ses affili\00E9s.')
,p_substitution_string_13=>'MSG_JSCRIPT'
,p_substitution_value_13=>unistr('JavaScript doit \00EAtre activ\00E9 lorsque vous ex\00E9cutez ce produit.')
,p_substitution_string_14=>'MSG_WORKSPACE'
,p_substitution_value_14=>'Espace de travail'
,p_substitution_string_15=>'MSG_USER'
,p_substitution_value_15=>'Utilisateur'
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(4762183464.4702)
,p_name=>'ProvisionNewService'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557994
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4770195076.4702)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4836827003.4702)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(25699022299795195.4702)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(109218886058.4702)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(80382420312008140.4702)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4764187459.4702)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(925952726466721.4702)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1297112882451329.4702)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1303143975778395.4702)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>16259647
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1327407257185562.4702)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>243439631
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3216298345137227.4702)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(14848914952940932.4702)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(99821530050888928.4702)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(118451238301833015.4702)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(123182871270478451.4702)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(124362535886989292.4702)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37165931336888
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(176118302419506807.4702)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1765072946679712055.4702)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1831722819976993878.4702)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1917634925946939898.4702)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(116607181908334943.4702)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(510672326686703270.4702)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(825492061062393977.4702)
...
'    return false;',
'end if;'))
,p_error_message=>unistr('L''affichage des questions sur les informations d''utilisation est d\00E9sactiv\00E9.')
,p_version_scn=>2610038
,p_caching=>'BY_USER_BY_PAGE_VIEW'
);
end;
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25713507070566709.4702)
,p_name=>'A1'
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25715301313574483.4702)
,p_name=>'A10'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25713709840567432.4702)
,p_name=>'A2'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25713912264568155.4702)
,p_name=>'A3'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25714115727569121.4702)
,p_name=>'A4'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25714319190570197.4702)
,p_name=>'A5'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25714521961570954.4702)
,p_name=>'A6'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25714725078571880.4702)
,p_name=>'A7'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25714927155572445.4702)
,p_name=>'A8'
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25715129580573146.4702)
,p_name=>'A9'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(144047527689955702.4702)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(103247625354177724.4702)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(318946157429.4702)
,p_name=>'HELP_PAGE'
,p_escape_on_http_output=>'N'
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(8584002656832123.4702)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25782509996254728.4702)
,p_name=>'LOV_1'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25794005175480492.4702)
,p_name=>'LOV_10'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25792324437476584.4702)
,p_name=>'LOV_2'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25792625823477001.4702)
,p_name=>'LOV_3'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25792827554477507.4702)
,p_name=>'LOV_4'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25793029286478012.4702)
,p_name=>'LOV_5'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25793231017478467.4702)
,p_name=>'LOV_6'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25793400327479065.4702)
,p_name=>'LOV_7'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25793602058479541.4702)
,p_name=>'LOV_8'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25793803790480026.4702)
,p_name=>'LOV_9'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(8632704676428693.4702)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25700525687890714.4702)
,p_name=>'Q1'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25702323047899430.4702)
,p_name=>'Q10'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25700729496891839.4702)
,p_name=>'Q2'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25700931920892551.4702)
,p_name=>'Q3'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25701102269893436.4702)
,p_name=>'Q4'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25701305386894398.4702)
,p_name=>'Q5'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25701515775897352.4702)
,p_name=>'Q6'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25701717506897886.4702)
,p_name=>'Q7'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25701919238898391.4702)
,p_name=>'Q8'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(25702120970898892.4702)
,p_name=>'Q9'
,p_protection_level=>'N'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(70976882659217226.4702)
...
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(8650202046513064.4702)
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(70977000257223302.4702)
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(103248202067189926.4702)
,p_computation_sequence=>10
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(11450003334894502.4702)
,p_tab_set=>'TOP'
,p_tab_sequence=>20
,p_tab_name=>'T_TOP'
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(823478261872577596.4702)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(823478579527577599.4702)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Afghanistan'
,p_lov_return_value=>'AFG'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824143289933039249.4702)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Albanie'
,p_lov_return_value=>'ALB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824143661180039254.4702)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>unistr('Alg\00E9rie')
,p_lov_return_value=>'DZA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824144090492039259.4702)
,p_lov_disp_sequence=>4
,p_lov_disp_value=>unistr('Samoa am\00E9ricaines')
,p_lov_return_value=>'ASM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824144465808039263.4702)
,p_lov_disp_sequence=>5
,p_lov_disp_value=>'Andorre'
,p_lov_return_value=>'AND'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824144840858039268.4702)
,p_lov_disp_sequence=>6
,p_lov_disp_value=>'Angola'
,p_lov_return_value=>'AGO'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824145206949039273.4702)
,p_lov_disp_sequence=>7
,p_lov_disp_value=>'Anguilla'
,p_lov_return_value=>'AIA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824145537327039278.4702)
,p_lov_disp_sequence=>8
,p_lov_disp_value=>'Antarctique'
,p_lov_return_value=>'ATA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824145913938039283.4702)
,p_lov_disp_sequence=>9
,p_lov_disp_value=>'Antigua-et-Barbuda'
,p_lov_return_value=>'ATG'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824146303479039287.4702)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Argentine'
,p_lov_return_value=>'ARG'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824146767443039292.4702)
,p_lov_disp_sequence=>11
,p_lov_disp_value=>unistr('Arm\00E9nie')
,p_lov_return_value=>'ARM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824147194532039297.4702)
,p_lov_disp_sequence=>12
,p_lov_disp_value=>'Aruba'
,p_lov_return_value=>'ABW'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824147548141039302.4702)
,p_lov_disp_sequence=>13
,p_lov_disp_value=>'Australie'
,p_lov_return_value=>'AUS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824147941823039307.4702)
,p_lov_disp_sequence=>14
,p_lov_disp_value=>'Autriche'
,p_lov_return_value=>'AUT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824148385733039312.4702)
,p_lov_disp_sequence=>15
,p_lov_disp_value=>unistr('Azerba\00EFdjan')
,p_lov_return_value=>'AZE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824148758358039316.4702)
,p_lov_disp_sequence=>16
,p_lov_disp_value=>'Bahamas'
,p_lov_return_value=>'BHS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824149199217039322.4702)
,p_lov_disp_sequence=>17
,p_lov_disp_value=>unistr('Bahre\00EFn')
,p_lov_return_value=>'BHR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824149507221039326.4702)
,p_lov_disp_sequence=>18
,p_lov_disp_value=>'Bangladesh'
,p_lov_return_value=>'BGD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824149927526039331.4702)
,p_lov_disp_sequence=>19
,p_lov_disp_value=>'Barbade'
,p_lov_return_value=>'BRB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824150360126039336.4702)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>unistr('B\00E9larus')
,p_lov_return_value=>'BLR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824150773820039341.4702)
,p_lov_disp_sequence=>21
,p_lov_disp_value=>'Belgique'
,p_lov_return_value=>'BEL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824151102399039345.4702)
,p_lov_disp_sequence=>22
,p_lov_disp_value=>'Belize'
,p_lov_return_value=>'BLZ'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824151574155039350.4702)
,p_lov_disp_sequence=>23
,p_lov_disp_value=>unistr('B\00E9nin')
,p_lov_return_value=>'BEN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824151987035039355.4702)
,p_lov_disp_sequence=>24
,p_lov_disp_value=>'Bermudes'
,p_lov_return_value=>'BMU'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824152325866039360.4702)
,p_lov_disp_sequence=>25
,p_lov_disp_value=>'Bhoutan'
,p_lov_return_value=>'BTN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824152787845039365.4702)
,p_lov_disp_sequence=>26
,p_lov_disp_value=>'Bolivie (Etat plurinational de)'
,p_lov_return_value=>'BOL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824153167556039370.4702)
,p_lov_disp_sequence=>27
,p_lov_disp_value=>'Bonaire, Saint-Eustache et Saba'
,p_lov_return_value=>'BES'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824153561740039375.4702)
,p_lov_disp_sequence=>28
,p_lov_disp_value=>unistr('Bosnie-Herz\00E9govine')
,p_lov_return_value=>'BIH'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824154021065039379.4702)
,p_lov_disp_sequence=>29
,p_lov_disp_value=>'Botswana'
,p_lov_return_value=>'BWA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824154759578039384.4702)
,p_lov_disp_sequence=>30
,p_lov_disp_value=>'Ile Bouvet'
,p_lov_return_value=>'BVT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824155184809039389.4702)
,p_lov_disp_sequence=>31
,p_lov_disp_value=>unistr('Br\00E9sil')
,p_lov_return_value=>'BRA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824155531817039394.4702)
,p_lov_disp_sequence=>32
,p_lov_disp_value=>unistr('Territoire britannique de l''oc\00E9an Indien')
,p_lov_return_value=>'IOT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824155917819039400.4702)
,p_lov_disp_sequence=>33
,p_lov_disp_value=>unistr('Brun\00E9i Darussalam')
,p_lov_return_value=>'BRN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824156356286039404.4702)
,p_lov_disp_sequence=>34
,p_lov_disp_value=>'Bulgarie'
,p_lov_return_value=>'BGR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824156744089039409.4702)
,p_lov_disp_sequence=>35
,p_lov_disp_value=>'Burkina Faso'
,p_lov_return_value=>'BFA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824157113717039414.4702)
,p_lov_disp_sequence=>36
,p_lov_disp_value=>'Burundi'
,p_lov_return_value=>'BDI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824157569621039419.4702)
,p_lov_disp_sequence=>37
,p_lov_disp_value=>'Cap-Vert'
,p_lov_return_value=>'CPV'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824157985211039424.4702)
,p_lov_disp_sequence=>38
,p_lov_disp_value=>'Cambodge'
,p_lov_return_value=>'KHM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824158324108039429.4702)
,p_lov_disp_sequence=>39
,p_lov_disp_value=>'Cameroun'
,p_lov_return_value=>'CMR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824158766990039434.4702)
,p_lov_disp_sequence=>40
,p_lov_disp_value=>'Canada'
,p_lov_return_value=>'CAN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824159117308039438.4702)
,p_lov_disp_sequence=>41
,p_lov_disp_value=>unistr('Iles Ca\00EFmans')
,p_lov_return_value=>'CYM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824159592937039443.4702)
,p_lov_disp_sequence=>42
,p_lov_disp_value=>unistr('R\00E9publique centrafricaine')
,p_lov_return_value=>'CAF'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824159964540039448.4702)
,p_lov_disp_sequence=>43
,p_lov_disp_value=>'Tchad'
,p_lov_return_value=>'TCD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824160345441039453.4702)
,p_lov_disp_sequence=>44
,p_lov_disp_value=>'Chili'
,p_lov_return_value=>'CHL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824160755378039457.4702)
,p_lov_disp_sequence=>45
,p_lov_disp_value=>'Chine'
,p_lov_return_value=>'CHN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824161181568039462.4702)
,p_lov_disp_sequence=>46
,p_lov_disp_value=>'Ile Christmas'
,p_lov_return_value=>'CXR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824161513302039467.4702)
,p_lov_disp_sequence=>47
,p_lov_disp_value=>'Iles Cocos (Keeling)'
,p_lov_return_value=>'CCK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824161976195039472.4702)
,p_lov_disp_sequence=>48
,p_lov_disp_value=>'Colombie'
,p_lov_return_value=>'COL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824162318849039477.4702)
,p_lov_disp_sequence=>49
,p_lov_disp_value=>'Comores'
,p_lov_return_value=>'COM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824162659027039482.4702)
,p_lov_disp_sequence=>50
,p_lov_disp_value=>'Congo'
,p_lov_return_value=>'COG'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824163068869039487.4702)
,p_lov_disp_sequence=>51
,p_lov_disp_value=>unistr('Congo, R\00E9publique d\00E9mocratique')
,p_lov_return_value=>'COD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824163467630039492.4702)
,p_lov_disp_sequence=>52
,p_lov_disp_value=>'Iles Cook'
,p_lov_return_value=>'COK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824163859361039497.4702)
,p_lov_disp_sequence=>53
,p_lov_disp_value=>'Costa Rica'
,p_lov_return_value=>'CRI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824164207335039502.4702)
,p_lov_disp_sequence=>54
,p_lov_disp_value=>'Croatie'
,p_lov_return_value=>'HRV'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824164608813039507.4702)
,p_lov_disp_sequence=>55
,p_lov_disp_value=>'Cuba'
,p_lov_return_value=>'CUB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824165091155039511.4702)
,p_lov_disp_sequence=>56
,p_lov_disp_value=>unistr('Cura\00E7ao')
,p_lov_return_value=>'CUW'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824165452808039517.4702)
,p_lov_disp_sequence=>57
,p_lov_disp_value=>'Chypre'
,p_lov_return_value=>'CYP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824165810913039521.4702)
,p_lov_disp_sequence=>58
,p_lov_disp_value=>unistr('R\00E9publique tch\00E8que')
,p_lov_return_value=>'CZE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824166275284039526.4702)
,p_lov_disp_sequence=>59
,p_lov_disp_value=>unistr('C\00F4te d''Ivoire')
,p_lov_return_value=>'CIV'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824166649759039531.4702)
,p_lov_disp_sequence=>60
,p_lov_disp_value=>'Danemark'
,p_lov_return_value=>'DNK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824167091955039536.4702)
,p_lov_disp_sequence=>61
,p_lov_disp_value=>'Djibouti'
,p_lov_return_value=>'DJI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824167432207039540.4702)
,p_lov_disp_sequence=>62
,p_lov_disp_value=>'Dominique'
,p_lov_return_value=>'DMA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824167874106039545.4702)
,p_lov_disp_sequence=>63
,p_lov_disp_value=>unistr('R\00E9publique dominicaine')
,p_lov_return_value=>'DOM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824168240526039550.4702)
,p_lov_disp_sequence=>64
,p_lov_disp_value=>'Equateur'
,p_lov_return_value=>'ECU'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824168658094039555.4702)
,p_lov_disp_sequence=>65
,p_lov_disp_value=>'Egypte'
,p_lov_return_value=>'EGY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824169018249039559.4702)
,p_lov_disp_sequence=>66
,p_lov_disp_value=>'El Salvador'
,p_lov_return_value=>'SLV'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824169470333039564.4702)
,p_lov_disp_sequence=>67
,p_lov_disp_value=>unistr('Guin\00E9e \00E9quatoriale')
,p_lov_return_value=>'GNQ'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824169852776039569.4702)
,p_lov_disp_sequence=>68
,p_lov_disp_value=>unistr('Erythr\00E9e')
,p_lov_return_value=>'ERI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824170241369039576.4702)
,p_lov_disp_sequence=>69
,p_lov_disp_value=>'Estonie'
,p_lov_return_value=>'EST'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824170556111039580.4702)
,p_lov_disp_sequence=>70
,p_lov_disp_value=>'Eswatini'
,p_lov_return_value=>'SWZ'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824170935274039585.4702)
,p_lov_disp_sequence=>71
,p_lov_disp_value=>'Ethiopie'
,p_lov_return_value=>'ETH'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824171301854039590.4702)
,p_lov_disp_sequence=>72
,p_lov_disp_value=>'Iles Falkland (Malvinas)'
,p_lov_return_value=>'FLK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824171769336039595.4702)
,p_lov_disp_sequence=>73
,p_lov_disp_value=>unistr('Iles F\00E9ro\00E9')
,p_lov_return_value=>'FRO'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824172115476039599.4702)
,p_lov_disp_sequence=>74
,p_lov_disp_value=>'Iles Fidji'
,p_lov_return_value=>'FJI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824172506566039604.4702)
,p_lov_disp_sequence=>75
,p_lov_disp_value=>'Finlande'
,p_lov_return_value=>'FIN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824172964667039609.4702)
,p_lov_disp_sequence=>76
,p_lov_disp_value=>'France'
,p_lov_return_value=>'FRA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824173333310039614.4702)
,p_lov_disp_sequence=>77
,p_lov_disp_value=>unistr('Guyane fran\00E7aise')
,p_lov_return_value=>'GUF'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824173722536039619.4702)
,p_lov_disp_sequence=>78
,p_lov_disp_value=>unistr('Polyn\00E9sie fran\00E7aise')
,p_lov_return_value=>'PYF'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824174127989039624.4702)
,p_lov_disp_sequence=>79
,p_lov_disp_value=>unistr('Terres australes fran\00E7aises')
,p_lov_return_value=>'ATF'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824174509650039629.4702)
,p_lov_disp_sequence=>80
,p_lov_disp_value=>'Gabon'
,p_lov_return_value=>'GAB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824174933703039634.4702)
,p_lov_disp_sequence=>81
,p_lov_disp_value=>'Gambie'
,p_lov_return_value=>'GMB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824175371819039638.4702)
,p_lov_disp_sequence=>82
,p_lov_disp_value=>unistr('G\00E9orgie')
,p_lov_return_value=>'GEO'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824175797087039643.4702)
,p_lov_disp_sequence=>83
,p_lov_disp_value=>'Allemagne'
,p_lov_return_value=>'DEU'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824176105610039648.4702)
,p_lov_disp_sequence=>84
,p_lov_disp_value=>'Ghana'
,p_lov_return_value=>'GHA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824176557598039652.4702)
,p_lov_disp_sequence=>85
,p_lov_disp_value=>'Gibraltar'
,p_lov_return_value=>'GIB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824176939297039657.4702)
,p_lov_disp_sequence=>86
,p_lov_disp_value=>unistr('Gr\00E8ce')
,p_lov_return_value=>'GRC'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824177324405039662.4702)
,p_lov_disp_sequence=>87
,p_lov_disp_value=>'Groenland'
,p_lov_return_value=>'GRL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824177704043039667.4702)
,p_lov_disp_sequence=>88
,p_lov_disp_value=>'Grenade'
,p_lov_return_value=>'GRD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824178145529039672.4702)
,p_lov_disp_sequence=>89
,p_lov_disp_value=>'Guadeloupe'
,p_lov_return_value=>'GLP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824178557303039677.4702)
,p_lov_disp_sequence=>90
,p_lov_disp_value=>'Guam'
,p_lov_return_value=>'GUM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824178897828039682.4702)
,p_lov_disp_sequence=>91
,p_lov_disp_value=>'Guatemala'
,p_lov_return_value=>'GTM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824179214159039686.4702)
,p_lov_disp_sequence=>92
,p_lov_disp_value=>'Guernesey'
,p_lov_return_value=>'GGY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824179699484039691.4702)
,p_lov_disp_sequence=>93
,p_lov_disp_value=>unistr('Guin\00E9e')
,p_lov_return_value=>'GIN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824180062358039696.4702)
,p_lov_disp_sequence=>94
,p_lov_disp_value=>unistr('Guin\00E9e-Bissau')
,p_lov_return_value=>'GNB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824180406269039701.4702)
,p_lov_disp_sequence=>95
,p_lov_disp_value=>'Guyane'
,p_lov_return_value=>'GUY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824180839883039705.4702)
,p_lov_disp_sequence=>96
,p_lov_disp_value=>unistr('Ha\00EFti')
,p_lov_return_value=>'HTI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824181202939039710.4702)
,p_lov_disp_sequence=>97
,p_lov_disp_value=>'Ile Heard et Iles McDonald'
,p_lov_return_value=>'HMD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824181650040039715.4702)
,p_lov_disp_sequence=>98
,p_lov_disp_value=>'Vatican'
,p_lov_return_value=>'VAT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824182018552039720.4702)
,p_lov_disp_sequence=>99
,p_lov_disp_value=>'Honduras'
,p_lov_return_value=>'HND'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824182486368039725.4702)
,p_lov_disp_sequence=>100
,p_lov_disp_value=>'Hong Kong'
,p_lov_return_value=>'HKG'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824182815248039730.4702)
,p_lov_disp_sequence=>101
,p_lov_disp_value=>'Hongrie'
,p_lov_return_value=>'HUN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824183270757039734.4702)
,p_lov_disp_sequence=>102
,p_lov_disp_value=>'Islande'
,p_lov_return_value=>'ISL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824183653975039739.4702)
,p_lov_disp_sequence=>103
,p_lov_disp_value=>'Inde'
,p_lov_return_value=>'IND'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824184097465039744.4702)
,p_lov_disp_sequence=>104
,p_lov_disp_value=>unistr('Indon\00E9sie')
,p_lov_return_value=>'IDN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824184440467039748.4702)
,p_lov_disp_sequence=>105
,p_lov_disp_value=>unistr('Iran (R\00E9publique islamique)')
,p_lov_return_value=>'IRN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824184895912039753.4702)
,p_lov_disp_sequence=>106
,p_lov_disp_value=>'Irak'
,p_lov_return_value=>'IRQ'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824185254165039758.4702)
,p_lov_disp_sequence=>107
,p_lov_disp_value=>'Irlande'
,p_lov_return_value=>'IRL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824185658713039762.4702)
,p_lov_disp_sequence=>108
,p_lov_disp_value=>'Ile de Man'
,p_lov_return_value=>'IMN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824186050349039767.4702)
,p_lov_disp_sequence=>109
,p_lov_disp_value=>unistr('Isra\00EBl')
,p_lov_return_value=>'ISR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824186421362039772.4702)
,p_lov_disp_sequence=>110
,p_lov_disp_value=>'Italie'
,p_lov_return_value=>'ITA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824186841443039777.4702)
,p_lov_disp_sequence=>111
,p_lov_disp_value=>unistr('Jama\00EFque')
,p_lov_return_value=>'JAM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824187167656039782.4702)
,p_lov_disp_sequence=>112
,p_lov_disp_value=>'Japon'
,p_lov_return_value=>'JPN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824187582112039787.4702)
,p_lov_disp_sequence=>113
,p_lov_disp_value=>'Jersey'
,p_lov_return_value=>'JEY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824187938400039792.4702)
,p_lov_disp_sequence=>114
,p_lov_disp_value=>'Jordanie'
,p_lov_return_value=>'JOR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824188398508039796.4702)
,p_lov_disp_sequence=>115
,p_lov_disp_value=>'Kazakhstan'
,p_lov_return_value=>'KAZ'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824188767332039801.4702)
,p_lov_disp_sequence=>116
,p_lov_disp_value=>'Kenya'
,p_lov_return_value=>'KEN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824189189188039806.4702)
,p_lov_disp_sequence=>117
,p_lov_disp_value=>'Kiribati'
,p_lov_return_value=>'KIR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824189521667039811.4702)
,p_lov_disp_sequence=>118
,p_lov_disp_value=>unistr('Kowe\00EFt')
,p_lov_return_value=>'KWT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824189902733039815.4702)
,p_lov_disp_sequence=>119
,p_lov_disp_value=>'Kirghizistan'
,p_lov_return_value=>'KGZ'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824190399290039821.4702)
,p_lov_disp_sequence=>120
,p_lov_disp_value=>unistr('Laos (R\00E9publique populaire d\00E9mocratique)')
,p_lov_return_value=>'LAO'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824190796580039826.4702)
,p_lov_disp_sequence=>121
,p_lov_disp_value=>'Lettonie'
,p_lov_return_value=>'LVA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824191126746039830.4702)
,p_lov_disp_sequence=>122
,p_lov_disp_value=>'Liban'
,p_lov_return_value=>'LBN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824191505534039835.4702)
,p_lov_disp_sequence=>123
,p_lov_disp_value=>'Lesotho'
,p_lov_return_value=>'LSO'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824191995602039840.4702)
,p_lov_disp_sequence=>124
,p_lov_disp_value=>unistr('Lib\00E9ria')
,p_lov_return_value=>'LBR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824192339533039845.4702)
,p_lov_disp_sequence=>125
,p_lov_disp_value=>'Libye'
,p_lov_return_value=>'LBY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824192750154039849.4702)
,p_lov_disp_sequence=>126
,p_lov_disp_value=>'Liechtenstein'
,p_lov_return_value=>'LIE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824193192147039854.4702)
,p_lov_disp_sequence=>127
,p_lov_disp_value=>'Lituanie'
,p_lov_return_value=>'LTU'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824193542324039859.4702)
,p_lov_disp_sequence=>128
,p_lov_disp_value=>'Luxembourg'
,p_lov_return_value=>'LUX'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824193976386039863.4702)
,p_lov_disp_sequence=>129
,p_lov_disp_value=>'Macao'
,p_lov_return_value=>'MAC'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824194385416039868.4702)
,p_lov_disp_sequence=>130
,p_lov_disp_value=>'Madagascar'
,p_lov_return_value=>'MDG'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824194754466039874.4702)
,p_lov_disp_sequence=>131
,p_lov_disp_value=>'Malawi'
,p_lov_return_value=>'MWI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824195061916039878.4702)
,p_lov_disp_sequence=>132
,p_lov_disp_value=>'Malaisie'
,p_lov_return_value=>'MYS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824195458252039883.4702)
,p_lov_disp_sequence=>133
,p_lov_disp_value=>'Maldives'
,p_lov_return_value=>'MDV'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824195826525039888.4702)
,p_lov_disp_sequence=>134
,p_lov_disp_value=>'Mali'
,p_lov_return_value=>'MLI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824196286157039893.4702)
,p_lov_disp_sequence=>135
,p_lov_disp_value=>'Malte'
,p_lov_return_value=>'MLT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824196692891039898.4702)
,p_lov_disp_sequence=>136
,p_lov_disp_value=>'Iles Marshall'
,p_lov_return_value=>'MHL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824197043836039902.4702)
,p_lov_disp_sequence=>137
,p_lov_disp_value=>'Martinique'
,p_lov_return_value=>'MTQ'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824197462014039907.4702)
,p_lov_disp_sequence=>138
,p_lov_disp_value=>'Mauritanie'
,p_lov_return_value=>'MRT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824197868846039912.4702)
,p_lov_disp_sequence=>139
,p_lov_disp_value=>'Maurice'
,p_lov_return_value=>'MUS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824198222840039917.4702)
,p_lov_disp_sequence=>140
,p_lov_disp_value=>'Mayotte'
,p_lov_return_value=>'MYT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824198626928039921.4702)
,p_lov_disp_sequence=>141
,p_lov_disp_value=>'Mexique'
,p_lov_return_value=>'MEX'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824199026329039927.4702)
,p_lov_disp_sequence=>142
,p_lov_disp_value=>unistr('Micron\00E9sie (Etats f\00E9d\00E9r\00E9s de)')
,p_lov_return_value=>'FSM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824199454247039932.4702)
,p_lov_disp_sequence=>143
,p_lov_disp_value=>unistr('Moldavie (R\00E9publique de)')
,p_lov_return_value=>'MDA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824199861141039936.4702)
,p_lov_disp_sequence=>144
,p_lov_disp_value=>'Monaco'
,p_lov_return_value=>'MCO'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824200247174039941.4702)
,p_lov_disp_sequence=>145
,p_lov_disp_value=>'Mongolie'
,p_lov_return_value=>'MNG'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824200620797039946.4702)
,p_lov_disp_sequence=>146
,p_lov_disp_value=>unistr('Mont\00E9n\00E9gro')
,p_lov_return_value=>'MNE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824201056397039951.4702)
,p_lov_disp_sequence=>147
,p_lov_disp_value=>'Montserrat'
,p_lov_return_value=>'MSR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824201436210039956.4702)
,p_lov_disp_sequence=>148
,p_lov_disp_value=>'Maroc'
,p_lov_return_value=>'MAR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824201856487039960.4702)
,p_lov_disp_sequence=>149
,p_lov_disp_value=>'Mozambique'
,p_lov_return_value=>'MOZ'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824202242934039965.4702)
,p_lov_disp_sequence=>150
,p_lov_disp_value=>'Myanmar'
,p_lov_return_value=>'MMR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824202662131039970.4702)
,p_lov_disp_sequence=>151
,p_lov_disp_value=>'Namibie'
,p_lov_return_value=>'NAM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824203014160039975.4702)
,p_lov_disp_sequence=>152
,p_lov_disp_value=>'Nauru'
,p_lov_return_value=>'NRU'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824203352960039980.4702)
,p_lov_disp_sequence=>153
,p_lov_disp_value=>unistr('N\00E9pal')
,p_lov_return_value=>'NPL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824203760226039985.4702)
,p_lov_disp_sequence=>154
,p_lov_disp_value=>'Pays-Bas'
,p_lov_return_value=>'NLD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824204154757039990.4702)
,p_lov_disp_sequence=>155
,p_lov_disp_value=>unistr('Nouvelle-Cal\00E9donie')
,p_lov_return_value=>'NCL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824204517683039995.4702)
,p_lov_disp_sequence=>156
,p_lov_disp_value=>unistr('Nouvelle-Z\00E9lande')
,p_lov_return_value=>'NZL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824204959877040000.4702)
,p_lov_disp_sequence=>157
,p_lov_disp_value=>'Nicaragua'
,p_lov_return_value=>'NIC'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824205348746040005.4702)
,p_lov_disp_sequence=>158
,p_lov_disp_value=>'Niger'
,p_lov_return_value=>'NER'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824205748763040009.4702)
,p_lov_disp_sequence=>159
,p_lov_disp_value=>unistr('Nig\00E9ria')
,p_lov_return_value=>'NGA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824206167179040014.4702)
,p_lov_disp_sequence=>160
,p_lov_disp_value=>unistr('Niu\00E9')
,p_lov_return_value=>'NIU'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824206565429040019.4702)
,p_lov_disp_sequence=>161
,p_lov_disp_value=>'Ile Norfolk'
,p_lov_return_value=>'NFK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824206943433040024.4702)
,p_lov_disp_sequence=>162
,p_lov_disp_value=>unistr('Cor\00E9e du Nord (R\00E9publique populaire d\00E9mocratique)')
,p_lov_return_value=>'PRK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824207387143040028.4702)
,p_lov_disp_sequence=>163
,p_lov_disp_value=>unistr('Mac\00E9doine du Nord')
,p_lov_return_value=>'MKD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824207783126040033.4702)
,p_lov_disp_sequence=>164
,p_lov_disp_value=>'Iles Mariannes du Nord'
,p_lov_return_value=>'MNP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824208161555040038.4702)
,p_lov_disp_sequence=>165
,p_lov_disp_value=>unistr('Norv\00E8ge')
,p_lov_return_value=>'NOR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824208513033040043.4702)
,p_lov_disp_sequence=>166
,p_lov_disp_value=>'Oman'
,p_lov_return_value=>'OMN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824208968260040048.4702)
,p_lov_disp_sequence=>167
,p_lov_disp_value=>'Pakistan'
,p_lov_return_value=>'PAK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824209356965040052.4702)
,p_lov_disp_sequence=>168
,p_lov_disp_value=>'Palaos'
,p_lov_return_value=>'PLW'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824209706547040057.4702)
,p_lov_disp_sequence=>169
,p_lov_disp_value=>'Palestine, Etat de'
,p_lov_return_value=>'PSE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824210135909040062.4702)
,p_lov_disp_sequence=>170
,p_lov_disp_value=>'Panama'
,p_lov_return_value=>'PAN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824210508653040067.4702)
,p_lov_disp_sequence=>171
,p_lov_disp_value=>unistr('Papouasie-Nouvelle Guin\00E9e')
,p_lov_return_value=>'PNG'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824210959245040071.4702)
,p_lov_disp_sequence=>172
,p_lov_disp_value=>'Paraguay'
,p_lov_return_value=>'PRY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824211375561040076.4702)
,p_lov_disp_sequence=>173
,p_lov_disp_value=>unistr('P\00E9rou')
,p_lov_return_value=>'PER'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824211667800040081.4702)
,p_lov_disp_sequence=>174
,p_lov_disp_value=>'Philippines'
,p_lov_return_value=>'PHL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824212017395040086.4702)
,p_lov_disp_sequence=>175
,p_lov_disp_value=>'Pitcairn'
,p_lov_return_value=>'PCN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824212432128040091.4702)
,p_lov_disp_sequence=>176
,p_lov_disp_value=>'Pologne'
,p_lov_return_value=>'POL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824212892941040096.4702)
,p_lov_disp_sequence=>177
,p_lov_disp_value=>'Portugal'
,p_lov_return_value=>'PRT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824213237691040101.4702)
,p_lov_disp_sequence=>178
,p_lov_disp_value=>'Porto Rico'
,p_lov_return_value=>'PRI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824213628322040105.4702)
,p_lov_disp_sequence=>179
,p_lov_disp_value=>'Qatar'
,p_lov_return_value=>'QAT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824214045494040110.4702)
,p_lov_disp_sequence=>180
,p_lov_disp_value=>'Roumanie'
,p_lov_return_value=>'ROU'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824214477087040115.4702)
,p_lov_disp_sequence=>181
,p_lov_disp_value=>unistr('F\00E9d\00E9ration de Russie')
,p_lov_return_value=>'RUS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824214828213040120.4702)
,p_lov_disp_sequence=>182
,p_lov_disp_value=>'Rwanda'
,p_lov_return_value=>'RWA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824215282184040124.4702)
,p_lov_disp_sequence=>183
,p_lov_disp_value=>unistr('R\00E9union')
,p_lov_return_value=>'REU'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824215625743040129.4702)
,p_lov_disp_sequence=>184
,p_lov_disp_value=>unistr('Saint-Barth\00E9lemy')
,p_lov_return_value=>'BLM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824216035692040134.4702)
,p_lov_disp_sequence=>185
,p_lov_disp_value=>unistr('Sainte-H\00E9l\00E8ne, Ascension et Tristan da Cunha')
,p_lov_return_value=>'SHN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824216419070040138.4702)
,p_lov_disp_sequence=>186
,p_lov_disp_value=>'Saint-Kitts-et-Nevis'
,p_lov_return_value=>'KNA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824216890396040143.4702)
,p_lov_disp_sequence=>187
,p_lov_disp_value=>'Sainte-Lucie'
,p_lov_return_value=>'LCA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824217282638040149.4702)
,p_lov_disp_sequence=>188
,p_lov_disp_value=>unistr('Saint Martin (partie fran\00E7aise)')
,p_lov_return_value=>'MAF'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824217628811040153.4702)
,p_lov_disp_sequence=>189
,p_lov_disp_value=>'Saint-Pierre-et-Miquelon'
,p_lov_return_value=>'SPM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824218024054040158.4702)
,p_lov_disp_sequence=>190
,p_lov_disp_value=>'Saint-Vincent-et-les-Grenadines'
,p_lov_return_value=>'VCT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824218450726040163.4702)
,p_lov_disp_sequence=>191
,p_lov_disp_value=>'Samoa'
,p_lov_return_value=>'WSM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824218890357040167.4702)
,p_lov_disp_sequence=>192
,p_lov_disp_value=>'Saint-Marin'
,p_lov_return_value=>'SMR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824219203141040172.4702)
,p_lov_disp_sequence=>193
,p_lov_disp_value=>unistr('S\00E3o Tom\00E9-et-Principe')
,p_lov_return_value=>'STP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824219664100040177.4702)
,p_lov_disp_sequence=>194
,p_lov_disp_value=>'Arabie saoudite'
,p_lov_return_value=>'SAU'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824219910146040182.4702)
,p_lov_disp_sequence=>195
,p_lov_disp_value=>unistr('S\00E9n\00E9gal')
,p_lov_return_value=>'SEN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824220335238040186.4702)
,p_lov_disp_sequence=>196
,p_lov_disp_value=>'Serbie'
,p_lov_return_value=>'SRB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824220730515040191.4702)
,p_lov_disp_sequence=>197
,p_lov_disp_value=>'Seychelles'
,p_lov_return_value=>'SYC'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824221164669040195.4702)
,p_lov_disp_sequence=>198
,p_lov_disp_value=>'Sierra Leone'
,p_lov_return_value=>'SLE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824221555171040200.4702)
,p_lov_disp_sequence=>199
,p_lov_disp_value=>'Singapour'
,p_lov_return_value=>'SGP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824221979517040205.4702)
,p_lov_disp_sequence=>200
,p_lov_disp_value=>unistr('Saint-Martin (partie n\00E9erlandaise)')
,p_lov_return_value=>'SXM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824222343418040209.4702)
,p_lov_disp_sequence=>201
,p_lov_disp_value=>'Slovaquie'
,p_lov_return_value=>'SVK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824222742416040214.4702)
,p_lov_disp_sequence=>202
,p_lov_disp_value=>unistr('Slov\00E9nie')
,p_lov_return_value=>'SVN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824223178434040219.4702)
,p_lov_disp_sequence=>203
,p_lov_disp_value=>'Iles Salomon'
,p_lov_return_value=>'SLB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824223529714040223.4702)
,p_lov_disp_sequence=>204
,p_lov_disp_value=>'Somalie'
,p_lov_return_value=>'SOM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824223979093040228.4702)
,p_lov_disp_sequence=>205
,p_lov_disp_value=>'Afrique du Sud'
,p_lov_return_value=>'ZAF'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824224354986040232.4702)
,p_lov_disp_sequence=>206
,p_lov_disp_value=>unistr('G\00E9orgie du Sud-et-les Iles Sandwich du Sud')
,p_lov_return_value=>'SGS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824224795028040237.4702)
,p_lov_disp_sequence=>207
,p_lov_disp_value=>unistr('Cor\00E9e du Sud (R\00E9publique de)')
,p_lov_return_value=>'KOR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824225184295040241.4702)
,p_lov_disp_sequence=>208
,p_lov_disp_value=>'Soudan du Sud'
,p_lov_return_value=>'SSD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824225597343040246.4702)
,p_lov_disp_sequence=>209
,p_lov_disp_value=>'Espagne'
,p_lov_return_value=>'ESP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824225920869040250.4702)
,p_lov_disp_sequence=>210
,p_lov_disp_value=>'Sri Lanka'
,p_lov_return_value=>'LKA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824226350700040255.4702)
,p_lov_disp_sequence=>211
,p_lov_disp_value=>'Soudan'
,p_lov_return_value=>'SDN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824226760685040260.4702)
,p_lov_disp_sequence=>212
,p_lov_disp_value=>'Suriname'
,p_lov_return_value=>'SUR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824227110257040264.4702)
,p_lov_disp_sequence=>213
,p_lov_disp_value=>'Svalbard et Ile Jan Mayen'
,p_lov_return_value=>'SJM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824227559092040269.4702)
,p_lov_disp_sequence=>214
,p_lov_disp_value=>unistr('Su\00E8de')
,p_lov_return_value=>'SWE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824227981168040274.4702)
,p_lov_disp_sequence=>215
,p_lov_disp_value=>'Suisse'
,p_lov_return_value=>'CHE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824228267412040279.4702)
,p_lov_disp_sequence=>216
,p_lov_disp_value=>unistr('R\00E9publique arabe syrienne')
,p_lov_return_value=>'SYR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824228672432040283.4702)
,p_lov_disp_sequence=>217
,p_lov_disp_value=>unistr('Ta\00EFwan (Province de Chine)')
,p_lov_return_value=>'TWN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824229068608040288.4702)
,p_lov_disp_sequence=>218
,p_lov_disp_value=>'Tadjikistan'
,p_lov_return_value=>'TJK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824229461777040293.4702)
,p_lov_disp_sequence=>219
,p_lov_disp_value=>unistr('Tanzanie (R\00E9publique unie de)')
,p_lov_return_value=>'TZA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824229879017040298.4702)
,p_lov_disp_sequence=>220
,p_lov_disp_value=>unistr('Tha\00EFlande')
,p_lov_return_value=>'THA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824230252868040302.4702)
,p_lov_disp_sequence=>221
,p_lov_disp_value=>'Timor oriental'
,p_lov_return_value=>'TLS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824230627563040307.4702)
,p_lov_disp_sequence=>222
,p_lov_disp_value=>'Togo'
,p_lov_return_value=>'TGO'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824231089167040312.4702)
,p_lov_disp_sequence=>223
,p_lov_disp_value=>'Tokelau'
,p_lov_return_value=>'TKL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824231429479040317.4702)
,p_lov_disp_sequence=>224
,p_lov_disp_value=>'Tonga'
,p_lov_return_value=>'TON'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824231839788040322.4702)
,p_lov_disp_sequence=>225
,p_lov_disp_value=>unistr('Trinit\00E9-et-Tobago')
,p_lov_return_value=>'TTO'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824232259416040327.4702)
,p_lov_disp_sequence=>226
,p_lov_disp_value=>'Tunisie'
,p_lov_return_value=>'TUN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824232681326040331.4702)
,p_lov_disp_sequence=>227
,p_lov_disp_value=>'Turquie'
,p_lov_return_value=>'TUR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824233010783040336.4702)
,p_lov_disp_sequence=>228
,p_lov_disp_value=>unistr('Turkm\00E9nistan')
,p_lov_return_value=>'TKM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824233487085040340.4702)
,p_lov_disp_sequence=>229
,p_lov_disp_value=>unistr('Iles Turques-et-Ca\00EFques')
,p_lov_return_value=>'TCA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824233880593040345.4702)
,p_lov_disp_sequence=>230
,p_lov_disp_value=>'Tuvalu'
,p_lov_return_value=>'TUV'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824234219912040350.4702)
,p_lov_disp_sequence=>231
,p_lov_disp_value=>'Ouganda'
,p_lov_return_value=>'UGA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824234640790040355.4702)
,p_lov_disp_sequence=>232
,p_lov_disp_value=>'Ukraine'
,p_lov_return_value=>'UKR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824235022516040359.4702)
,p_lov_disp_sequence=>233
,p_lov_disp_value=>'Emirats arabes unis'
,p_lov_return_value=>'ARE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824235413266040364.4702)
,p_lov_disp_sequence=>234
,p_lov_disp_value=>'Royaume-Uni de Grande-Bretagne et d''Irlande du Nord'
,p_lov_return_value=>'GBR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824235898318040370.4702)
,p_lov_disp_sequence=>235
,p_lov_disp_value=>unistr('Iles mineures \00E9loign\00E9es des Etats-Unis')
,p_lov_return_value=>'UMI'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824236251901040374.4702)
,p_lov_disp_sequence=>236
,p_lov_disp_value=>unistr('Etats-Unis d''Am\00E9rique')
,p_lov_return_value=>'USA'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824236528753040379.4702)
,p_lov_disp_sequence=>237
,p_lov_disp_value=>'Uruguay'
,p_lov_return_value=>'URY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824236994052040384.4702)
,p_lov_disp_sequence=>238
,p_lov_disp_value=>unistr('Ouzb\00E9kistan')
,p_lov_return_value=>'UZB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824237304166040388.4702)
,p_lov_disp_sequence=>239
,p_lov_disp_value=>'Vanuatu'
,p_lov_return_value=>'VUT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824237773816040393.4702)
,p_lov_disp_sequence=>240
,p_lov_disp_value=>unistr('Venezuela (R\00E9publique bolivarienne du)')
,p_lov_return_value=>'VEN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824238191827040398.4702)
,p_lov_disp_sequence=>241
,p_lov_disp_value=>'Vietnam'
,p_lov_return_value=>'VNM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824238589489040403.4702)
,p_lov_disp_sequence=>242
,p_lov_disp_value=>'Iles vierges (Grande-Bretagne)'
,p_lov_return_value=>'VGB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824238926608040407.4702)
,p_lov_disp_sequence=>243
,p_lov_disp_value=>'Iles Vierges (Etats-Unis)'
,p_lov_return_value=>'VIR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824239380281040412.4702)
,p_lov_disp_sequence=>244
,p_lov_disp_value=>'Wallis-et-Futuna'
,p_lov_return_value=>'WLF'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824239765313040417.4702)
,p_lov_disp_sequence=>245
,p_lov_disp_value=>'Sahara occidental'
,p_lov_return_value=>'ESH'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824240139823040421.4702)
,p_lov_disp_sequence=>246
,p_lov_disp_value=>unistr('Y\00E9men')
,p_lov_return_value=>'YEM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824240529218040427.4702)
,p_lov_disp_sequence=>247
,p_lov_disp_value=>'Zambie'
,p_lov_return_value=>'ZMB'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824240904886040432.4702)
,p_lov_disp_sequence=>248
,p_lov_disp_value=>'Zimbabwe'
,p_lov_return_value=>'ZWE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824241383447040436.4702)
,p_lov_disp_sequence=>249
,p_lov_disp_value=>unistr('Iles \00C5land')
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(150771414457811401.4702)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(150771902162811402.4702)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>unistr('Demander un nouveau sch\00E9ma')
,p_lov_return_value=>'YES'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(150771702466811402.4702)
,p_lov_disp_sequence=>2
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(824610978117256327.4702)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824611611527256327.4702)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Personnel'
,p_lov_return_value=>'PERSONAL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(824611248260256327.4702)
,p_lov_disp_sequence=>20
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(728312584834618523.4702)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(728312822592618530.4702)
,p_lov_disp_sequence=>1
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(728313109611618535.4702)
,p_lov_disp_sequence=>2
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4674102852.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140045294411349498.4702)
,p_page_template_id=>wwv_flow_imp.id(4674102852.4702)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(18107622439281852.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140045371814349497.4702)
,p_page_template_id=>wwv_flow_imp.id(18107622439281852.4702)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140045463101349495.4702)
,p_page_template_id=>wwv_flow_imp.id(18107622439281852.4702)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140045568641349495.4702)
,p_page_template_id=>wwv_flow_imp.id(18107622439281852.4702)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140045696148349495.4702)
,p_page_template_id=>wwv_flow_imp.id(18107622439281852.4702)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140045705910349495.4702)
,p_page_template_id=>wwv_flow_imp.id(18107622439281852.4702)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140045841273349495.4702)
,p_page_template_id=>wwv_flow_imp.id(18107622439281852.4702)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140045988449349495.4702)
,p_page_template_id=>wwv_flow_imp.id(18107622439281852.4702)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140046040073349495.4702)
,p_page_template_id=>wwv_flow_imp.id(18107622439281852.4702)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140046137068349494.4702)
,p_page_template_id=>wwv_flow_imp.id(18107622439281852.4702)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(728298792391563586.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115218801923289458.4702)
,p_page_template_id=>wwv_flow_imp.id(728298792391563586.4702)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115219385115289458.4702)
,p_page_template_id=>wwv_flow_imp.id(728298792391563586.4702)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115219889935289459.4702)
,p_page_template_id=>wwv_flow_imp.id(728298792391563586.4702)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115220395009289459.4702)
,p_page_template_id=>wwv_flow_imp.id(728298792391563586.4702)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115220894282289459.4702)
,p_page_template_id=>wwv_flow_imp.id(728298792391563586.4702)
,p_name=>'Page Position 4'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115221312980289460.4702)
,p_page_template_id=>wwv_flow_imp.id(728298792391563586.4702)
,p_name=>'Page Position 7'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115221898616289460.4702)
,p_page_template_id=>wwv_flow_imp.id(728298792391563586.4702)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(728299018883563592.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1536977403875382.4702)
,p_page_template_id=>wwv_flow_imp.id(728299018883563592.4702)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1537404988875382.4702)
,p_page_template_id=>wwv_flow_imp.id(728299018883563592.4702)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1537944468875382.4702)
,p_page_template_id=>wwv_flow_imp.id(728299018883563592.4702)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1538418261875382.4702)
,p_page_template_id=>wwv_flow_imp.id(728299018883563592.4702)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1538999226875382.4702)
,p_page_template_id=>wwv_flow_imp.id(728299018883563592.4702)
,p_name=>'Page Position 4'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1539485775875383.4702)
,p_page_template_id=>wwv_flow_imp.id(728299018883563592.4702)
,p_name=>'Page Position 7'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1539944815875383.4702)
,p_page_template_id=>wwv_flow_imp.id(728299018883563592.4702)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1540468825875383.4702)
,p_page_template_id=>wwv_flow_imp.id(728299018883563592.4702)
,p_name=>'Control Bar'
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(728303139008563600.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293540632026992208.4702)
,p_page_template_id=>wwv_flow_imp.id(728303139008563600.4702)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293541186357992209.4702)
,p_page_template_id=>wwv_flow_imp.id(728303139008563600.4702)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293541640513992209.4702)
,p_page_template_id=>wwv_flow_imp.id(728303139008563600.4702)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(18109103748352135.4702)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(18109222795357646.4702)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(18109301108360805.4702)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(18109418424365879.4702)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(481975242743888810.4702)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(481975658518888812.4702)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(481975923749888812.4702)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(481976264382888813.4702)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(516411350946385636.4702)
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18108515260336521.4702)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140589729503344419.4702)
,p_plug_template_id=>wwv_flow_imp.id(18108515260336521.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140589837075344418.4702)
,p_plug_template_id=>wwv_flow_imp.id(18108515260336521.4702)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140589919306344418.4702)
,p_plug_template_id=>wwv_flow_imp.id(18108515260336521.4702)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140590092278344418.4702)
,p_plug_template_id=>wwv_flow_imp.id(18108515260336521.4702)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140590123579344418.4702)
,p_plug_template_id=>wwv_flow_imp.id(18108515260336521.4702)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140590250558344418.4702)
,p_plug_template_id=>wwv_flow_imp.id(18108515260336521.4702)
,p_name=>'Previous'
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18113207959457422.4702)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140590318049344418.4702)
,p_plug_template_id=>wwv_flow_imp.id(18113207959457422.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140590406705344418.4702)
,p_plug_template_id=>wwv_flow_imp.id(18113207959457422.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29133613931545850.4702)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140590559109344418.4702)
,p_plug_template_id=>wwv_flow_imp.id(29133613931545850.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140590657613344418.4702)
,p_plug_template_id=>wwv_flow_imp.id(29133613931545850.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(481965601614717220.4702)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32615856998747570.4702)
,p_plug_template_id=>wwv_flow_imp.id(481965601614717220.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32616300362747570.4702)
,p_plug_template_id=>wwv_flow_imp.id(481965601614717220.4702)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32616860498747571.4702)
,p_plug_template_id=>wwv_flow_imp.id(481965601614717220.4702)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32617312976747571.4702)
,p_plug_template_id=>wwv_flow_imp.id(481965601614717220.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(481969298650741033.4702)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140591114954344417.4702)
,p_plug_template_id=>wwv_flow_imp.id(481969298650741033.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140591206251344417.4702)
,p_plug_template_id=>wwv_flow_imp.id(481969298650741033.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140591396875344417.4702)
,p_plug_template_id=>wwv_flow_imp.id(481969298650741033.4702)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140591408515344417.4702)
,p_plug_template_id=>wwv_flow_imp.id(481969298650741033.4702)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140591525805344417.4702)
,p_plug_template_id=>wwv_flow_imp.id(481969298650741033.4702)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(481970015003751305.4702)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140591624773344417.4702)
,p_plug_template_id=>wwv_flow_imp.id(481970015003751305.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140591745863344416.4702)
,p_plug_template_id=>wwv_flow_imp.id(481970015003751305.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2279638100232365.4702)
,p_plug_template_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2280174205232365.4702)
,p_plug_template_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2280639297232365.4702)
,p_plug_template_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2281145196232366.4702)
,p_plug_template_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2281674011232366.4702)
,p_plug_template_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2282180090232366.4702)
,p_plug_template_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2282617165232366.4702)
,p_plug_template_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2283169776232366.4702)
,p_plug_template_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2283602548232366.4702)
,p_plug_template_id=>wwv_flow_imp.id(728272729796557092.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(728279364278557123.4702)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140592784021344415.4702)
,p_plug_template_id=>wwv_flow_imp.id(728279364278557123.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140592807833344415.4702)
,p_plug_template_id=>wwv_flow_imp.id(728279364278557123.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140592959588344415.4702)
,p_plug_template_id=>wwv_flow_imp.id(728279364278557123.4702)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140593092669344415.4702)
,p_plug_template_id=>wwv_flow_imp.id(728279364278557123.4702)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2816540422491372.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2817065201491372.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2817526560491372.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2818088247491372.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2818522726491372.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2819071208491372.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2819511997491372.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2820043835491372.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2820585132491373.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2821064684491373.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2821574759491373.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2822001222491373.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2822588006491373.4702)
,p_plug_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3295428515506007.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3295905523506007.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3296473011506007.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3296917603506007.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3297453322506007.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3297984775506007.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3298481323506007.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3298973290506008.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3299491762506008.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3299989051506008.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3300408358506008.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3300902630506008.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292067255557137.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(728292709128557138.4702)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88195249341816933.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292709128557138.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88195763484816933.4702)
,p_plug_template_id=>wwv_flow_imp.id(728292709128557138.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(728293431473557139.4702)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3360941751508594.4702)
,p_plug_template_id=>wwv_flow_imp.id(728293431473557139.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3361429491508594.4702)
,p_plug_template_id=>wwv_flow_imp.id(728293431473557139.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(728294112567557139.4702)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3387462433510522.4702)
,p_plug_template_id=>wwv_flow_imp.id(728294112567557139.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3387938416510522.4702)
,p_plug_template_id=>wwv_flow_imp.id(728294112567557139.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(860617531457119334.4702)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140596204722344412.4702)
,p_plug_template_id=>wwv_flow_imp.id(860617531457119334.4702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140596300021344412.4702)
,p_plug_template_id=>wwv_flow_imp.id(860617531457119334.4702)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(4794278052.4702)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(18108230235321990.4702)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(481972912021825750.4702)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(18117622573511758.4702)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(18117725602511758.4702)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(18341322111783282.4702)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(481972669929805619.4702)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(481972771960821314.4702)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(516405744549268368.4702)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(516405998930268369.4702)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(805564588331659193.4702)
...
wwv_flow_imp_shared.create_popup_lov_template(
 p_id=>wwv_flow_imp.id(14663214008465131.4702)
,p_page_name=>'winlov'
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(72333216619538152.4702)
,p_theme_id=>3
,p_name=>'DARK'
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(204024310335769388.4702)
,p_theme_id=>3
,p_name=>'STANDARD'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#IMAGE_PREFIX#apex_ui/css/Core#MIN#.css',
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(556402214051120170.4702)
,p_theme_id=>3
,p_name=>'DARK_AUTO'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#IMAGE_PREFIX#apex_ui/css/Core#MIN#.css',
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(556402525655120954.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2346703868041176.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(728273198308557106.4702)
,p_theme_id=>3
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(728273812208557117.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(728274811074557119.4702)
,p_theme_id=>3
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(728281789702557125.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(728282779546557126.4702)
,p_theme_id=>3
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(728284958660557127.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746434995533421149.4702)
,p_theme_id=>3
,p_name=>'HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746436279201421149.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746436594439421149.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746436840999421149.4702)
,p_theme_id=>3
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746437988722421151.4702)
,p_theme_id=>3
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746438219342421151.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746438589659421151.4702)
,p_theme_id=>3
,p_name=>'BUTTON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746438816241421151.4702)
,p_theme_id=>3
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746439137924421151.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746439645845421152.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746439918130421152.4702)
,p_theme_id=>3
,p_name=>'BUTTON_TYPE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2347056978052005.4702)
,p_theme_id=>3
,p_name=>'HEADING_LEVEL_H1'
,p_display_name=>'H1'
,p_display_sequence=>10
,p_css_classes=>'js-headingLevel-1'
,p_group_id=>wwv_flow_imp.id(2346703868041176.4702)
,p_template_types=>'REGION'
,p_help_text=>'H1'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2347349517052005.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2347793139052005.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2348168091052005.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2348559807052005.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2348991248052005.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(728276986572557122.4702)
,p_theme_id=>3
,p_name=>'REGIONCONTAINSITEMSTEXT'
,p_display_name=>'Region Contains Items / Text'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(728272729796557092.4702)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(728277248569557122.4702)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(728274811074557119.4702)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(728277525479557122.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(728277818941557122.4702)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
...
,p_group_id=>wwv_flow_imp.id(728273812208557117.4702)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(728278146450557122.4702)
,p_theme_id=>3
,p_name=>'NOPADDING'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(728278498295557123.4702)
,p_theme_id=>3
,p_name=>'WIZARDDIALOG'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(728278798769557123.4702)
,p_theme_id=>3
,p_name=>'VISIBLE'
...
,p_group_id=>wwv_flow_imp.id(728273198308557106.4702)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(728279089427557123.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746435033845421149.4702)
,p_theme_id=>3
,p_name=>'180PX'
,p_display_name=>'180px'
,p_display_sequence=>10
,p_css_classes=>'h180'
,p_group_id=>wwv_flow_imp.id(746434995533421149.4702)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746435216989421149.4702)
,p_theme_id=>3
,p_name=>'240PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746435405988421149.4702)
,p_theme_id=>3
,p_name=>'320PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746435656825421149.4702)
,p_theme_id=>3
,p_name=>'480PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746435848002421149.4702)
,p_theme_id=>3
,p_name=>'540PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746436091506421149.4702)
,p_theme_id=>3
,p_name=>'640PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746436368676421149.4702)
,p_theme_id=>3
,p_name=>'ALIGNLABELSLEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_css_classes=>'a-Form--leftLabels'
,p_group_id=>wwv_flow_imp.id(746436279201421149.4702)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746436678574421149.4702)
,p_theme_id=>3
,p_name=>'AUTOWIDTH'
,p_display_name=>'Auto Width'
,p_display_sequence=>1
,p_css_classes=>'a-Form--autoWidthLabels'
,p_group_id=>wwv_flow_imp.id(746436594439421149.4702)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746436965719421149.4702)
,p_theme_id=>3
,p_name=>'FIRSTBUTTON'
,p_display_name=>'First Button'
,p_display_sequence=>1
,p_css_classes=>'a-Button--pillStart'
,p_group_id=>wwv_flow_imp.id(746436840999421149.4702)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746437112234421149.4702)
,p_theme_id=>3
,p_name=>'FIXEDLARGE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746437368469421149.4702)
,p_theme_id=>3
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746437581881421150.4702)
,p_theme_id=>3
,p_name=>'FIXEDWIDTH'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746437748876421150.4702)
,p_theme_id=>3
,p_name=>'INNERBUTTON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746438058857421151.4702)
,p_theme_id=>3
,p_name=>'LABELAUTOWIDTH'
,p_display_name=>'Auto Width'
,p_display_sequence=>1
,p_css_classes=>'a-Form-fieldContainer--autoLabelWidth'
,p_group_id=>wwv_flow_imp.id(746437988722421151.4702)
,p_template_types=>'FIELD'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746438384706421151.4702)
,p_theme_id=>3
,p_name=>'LABELSABOVE'
,p_display_name=>'Labels Above'
,p_display_sequence=>1
,p_css_classes=>'a-Form--labelsAbove'
,p_group_id=>wwv_flow_imp.id(746438219342421151.4702)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746438655416421151.4702)
,p_theme_id=>3
,p_name=>'LARGE'
,p_display_name=>'Large'
,p_display_sequence=>3
,p_css_classes=>'a-Button--large'
,p_group_id=>wwv_flow_imp.id(746438589659421151.4702)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746438901201421151.4702)
,p_theme_id=>3
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
,p_css_classes=>'a-Button--gapLeft'
,p_group_id=>wwv_flow_imp.id(746438816241421151.4702)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746439281590421151.4702)
,p_theme_id=>3
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
,p_css_classes=>'a-Button--gapRight'
,p_group_id=>wwv_flow_imp.id(746439137924421151.4702)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746439479283421151.4702)
,p_theme_id=>3
,p_name=>'LASTBUTTON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746439725429421152.4702)
,p_theme_id=>3
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_imp.id(746439645845421152.4702)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746440034159421152.4702)
,p_theme_id=>3
,p_name=>'PRIMARY'
,p_display_name=>'Primary'
,p_display_sequence=>1
,p_css_classes=>'a-Button--primary'
,p_group_id=>wwv_flow_imp.id(746439918130421152.4702)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746440162594421152.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746440362741421152.4702)
,p_theme_id=>3
,p_name=>'SMALL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746440520463421152.4702)
,p_theme_id=>3
,p_name=>'SMALLLEFT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746440758010421152.4702)
,p_theme_id=>3
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746440822788421152.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(746440925815421152.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1199561525047032426.4702)
,p_theme_id=>3
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_imp.id(481975658518888812.4702)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_imp.id(746439645845421152.4702)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554852920727542292.4702)
,p_theme_id=>3
,p_name=>'FLUSHREGION'
,p_display_name=>'Flush Region'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(728280005939557124.4702)
,p_css_classes=>'a-Region--flush'
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554853081668542293.4702)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554853269909542294.4702)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554853498802542294.4702)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554853672639542294.4702)
,p_theme_id=>3
,p_name=>'SIDEBAR'
...
,p_group_id=>wwv_flow_imp.id(728284958660557127.4702)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554853833133542294.4702)
,p_theme_id=>3
,p_name=>'BORDERLESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554854022496542294.4702)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(728281789702557125.4702)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554854201680542294.4702)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554854474957542294.4702)
,p_theme_id=>3
,p_name=>'EXPANDED'
...
,p_group_id=>wwv_flow_imp.id(728282779546557126.4702)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554854632648542294.4702)
,p_theme_id=>3
,p_name=>'COLLAPSED'
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(46948758488708852.4702)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121161735593667932)
,p_name=>'APEX.PAGE_ITEM_IS_REQUIRED'
,p_message_language=>'fr'
,p_message_text=>'#LABEL# est requis.'
,p_version_scn=>2566423
);
end;
/
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(108165525079033088.4702)
,p_name=>'Database'
...
begin
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(766219159606055235.4702)
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(118592600337930248.4702)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416848730038942515.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416849148847942516.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(416848730038942515.4702)
,p_display_sequence=>10
,p_display_value=>'OpenID Connect Provider'
,p_return_value=>'OPENID_CONNECT'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416849661785942516.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(416848730038942515.4702)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416850170886942516.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(416848730038942515.4702)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416850699117942517.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(416848730038942515.4702)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416851189591942517.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(416848730038942515.4702)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416851551045942517.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416851957058942518.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416852302749942518.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416852784836942518.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416853131571942518.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416853561778942519.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416853905557942519.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416854358382942519.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416854770075942519.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416855148060942520.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(416854770075942519.4702)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416855638295942520.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(416854770075942519.4702)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416856100635942520.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(416854770075942519.4702)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416856612426942521.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(416854770075942519.4702)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416857126648942521.4702)
,p_plugin_id=>wwv_flow_imp.id(118592600337930248.4702)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(766196516105997136.4702)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(766196759876997170.4702)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(766197021878997171.4702)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308190528687529862.4702)
,p_plugin_id=>wwv_flow_imp.id(766197021878997171.4702)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308190917299529862.4702)
,p_plugin_id=>wwv_flow_imp.id(766197021878997171.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308191304782529863.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(308190917299529862.4702)
,p_display_sequence=>10
,p_display_value=>'Redirect to Built-In URL'
,p_return_value=>'BUILTIN_URL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308191848079529863.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(308190917299529862.4702)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308192371618529863.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(308190917299529862.4702)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308192860636529864.4702)
,p_plugin_id=>wwv_flow_imp.id(766197021878997171.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
,p_display_length=>60
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(308190917299529862.4702)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308193214032529864.4702)
,p_plugin_id=>wwv_flow_imp.id(766197021878997171.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308193698677529864.4702)
,p_plugin_id=>wwv_flow_imp.id(766197021878997171.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308194046037529865.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(308193698677529864.4702)
,p_display_sequence=>10
,p_display_value=>'Each Request'
,p_return_value=>'ALWAYS'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308194566576529865.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(308193698677529864.4702)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308195031696529865.4702)
,p_plugin_id=>wwv_flow_imp.id(766197021878997171.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(766203167836997187.4702)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(766203355186997187.4702)
,p_plugin_id=>wwv_flow_imp.id(766203167836997187.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(766203742780997187.4702)
,p_plugin_id=>wwv_flow_imp.id(766203167836997187.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(766204192689997188.4702)
,p_plugin_id=>wwv_flow_imp.id(766203167836997187.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(766204501729997188.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(766204192689997188.4702)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(766205090281997190.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(766204192689997188.4702)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(766205526368997190.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(766204192689997188.4702)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(766206087018997190.4702)
,p_plugin_id=>wwv_flow_imp.id(766203167836997187.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(766206425955997191.4702)
,p_plugin_id=>wwv_flow_imp.id(766203167836997187.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(766206835038997191.4702)
,p_plugin_id=>wwv_flow_imp.id(766203167836997187.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(766206425955997191.4702)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(766207286081997191.4702)
,p_plugin_id=>wwv_flow_imp.id(766203167836997187.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(766207666923997191.4702)
,p_plugin_id=>wwv_flow_imp.id(766203167836997187.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(766208002519997192.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(766207666923997191.4702)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(766208532334997192.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(766207666923997191.4702)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(766209088734997192.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(766207666923997191.4702)
,p_display_sequence=>30
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(766209839828997194.4702)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(766210172744997195.4702)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(805561388021651744.4702)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(805561682413651902.4702)
,p_plugin_id=>wwv_flow_imp.id(805561388021651744.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(805562091226651903.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(805561682413651902.4702)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'S'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(805562552885651903.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(805561682413651902.4702)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(805563001543651903.4702)
,p_plugin_attribute_id=>wwv_flow_imp.id(805561682413651902.4702)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(805563507507651905.4702)
,p_plugin_id=>wwv_flow_imp.id(805561388021651744.4702)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(845155894988834530.4702)
,p_plugin_id=>wwv_flow_imp.id(805561388021651744.4702)
,p_name=>'LOV'
...
,p_step_template=>wwv_flow_imp.id(728298792391563586.4702)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(384692482059932839.4702)
,p_plug_name=>'APEX 5 - Header'
,p_region_css_classes=>'a-Header'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481965601614717220.4702)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_07'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<a href="f?p=4000:1500:&APP_SESSION." class="a-Header-logo" title="Accueil">',
...
,p_step_title=>'Demander un espace de travail - &PRODUCT_NAME.'
,p_warn_on_unsaved_changes=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(624348233786280075.4702)
,p_plug_name=>'Demander un espace de travail'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481970015003751305.4702)
,p_plug_display_sequence=>10
,p_landmark_label=>'Assistant Demander un espace de travail'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(624348462275280075.4702)
,p_plug_name=>'Barre de progression d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(624348233786280075.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481969298650741033.4702)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(624348630378280075.4702)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_imp.id(624348462275280075.4702)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(4762183464.4702)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(481972912021825750.4702)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(624348871164280076.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(825273288998768702.4702)
,p_plug_name=>'Basic Info'
,p_parent_plug_id=>wwv_flow_imp.id(624348871164280076.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(825273361595768703.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(825273467161768704.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(624350429513280083.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(624350696578280086.4702)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(624350429513280083.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(624391705621329097.4702)
...
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(481976264382888813.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(624350869612280090.4702)
...
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(481975242743888810.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(624352524796280096.4702)
,p_branch_name=>'Go To Page 25 (Schema)'
,p_branch_action=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(624350696578280086.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(74099388176078401.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(825273520608768705.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(711861644632245744.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(711861279470245740.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(624392091754336529.4702)
,p_branch_name=>'Go to Page 1'
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(624391705621329097.4702)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(741644387803197176.4702)
,p_branch_name=>'Redirect to Login Page'
,p_branch_action=>'f?p=4550:1'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(624350869612280090.4702)
,p_branch_sequence=>30
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2001116307897507.4702)
,p_name=>'ADMIN_USERNAME'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(825273288998768702.4702)
,p_prompt=>'Nom utilisateur de l''administrateur'
...
,p_field_template=>wwv_flow_imp.id(481972669929805619.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(624349012704280076.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(624349255885280079.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(624349478067280079.4702)
,p_name=>'ADMIN_EMAIL'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(825273288998768702.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(624349967806280083.4702)
,p_name=>'COMPANY_NAME'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(825273288998768702.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662393664144758438.4702)
,p_name=>'P2_COUNTRY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(825273361595768703.4702)
,p_prompt=>'Pays'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662393758741758439.4702)
,p_name=>'P2_USAGE_TYPE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(825273361595768703.4702)
,p_item_default=>'PERSONAL'
,p_prompt=>'Utilisation'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662393808220758440.4702)
,p_name=>'P2_ORG_NAME'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(825273361595768703.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1267106306489305003.4702)
,p_name=>'P2_TERMS_OF_USE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(825273467161768704.4702)
,p_prompt=>'Conditions d''utilisation'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(624351113308280091.4702)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(711861350344245741.4702)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(711861471568245742.4702)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(711861526274245743.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(624352336404280096.4702)
...
,p_when_button_pressed=>wwv_flow_imp.id(624350696578280086.4702)
,p_associated_item=>wwv_flow_imp.id(624349478067280079.4702)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(624351399015280093.4702)
...
,p_when_button_pressed=>wwv_flow_imp.id(624350696578280086.4702)
,p_associated_item=>wwv_flow_imp.id(624349967806280083.4702)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(624351561451280095.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(19981431654203440.4702)
...
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('L''adresse \00E9lectronique a un mod\00E8le de blocage. Indiquez une adresse \00E9lectronique valide pour poursuivre le processus de provisionnement de l''espace de travail.')
,p_associated_item=>wwv_flow_imp.id(624349478067280079.4702)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(662393984631758441.4702)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662394055847758442.4702)
,p_event_id=>wwv_flow_imp.id(662393984631758441.4702)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662394133246758443.4702)
,p_event_id=>wwv_flow_imp.id(662393984631758441.4702)
...
,p_step_title=>unistr('Espace de travail demand\00E9 - &PRODUCT_NAME.')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(26270707309302905.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516145500301081707.4702)
,p_plug_name=>'Wizard Body'
,p_parent_plug_id=>wwv_flow_imp.id(26270707309302905.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(235693425700565320.4702)
,p_name=>'P3_COMPANY_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(26270707309302905.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(235693721602567173.4702)
...
,p_step_title=>unistr('Demander un espace de travail - Enqu\00EAte - &PRODUCT_NAME.')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(728298792391563586.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(25696603898761468.4702)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(18108515260336521.4702)
,p_plug_display_sequence=>10
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516394643687212836.4702)
,p_plug_name=>'Demander un espace de travail'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516394851182212837.4702)
,p_plug_name=>'Barre de progression d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(516394643687212836.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481969298650741033.4702)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516145498582081706.4702)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_imp.id(516394851182212837.4702)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516395010313212838.4702)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_imp.id(516394643687212836.4702)
...
,p_plug_query_num_rows=>15
,p_landmark_type=>'form'
,p_landmark_label=>unistr('Enqu\00EAte')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(25696432164760206.4702)
,p_plug_name=>'Inscription de &PRODUCT_NAME.'
,p_parent_plug_id=>wwv_flow_imp.id(516395010313212838.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(26648304716757938.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(26648804847767366.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516395225562212838.4702)
,p_plug_name=>'Boutons d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(516394643687212836.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(25697412694761472.4702)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(516395225562212838.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(25697023233761471.4702)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(516395225562212838.4702)
,p_button_name=>'BACK'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(64572886936929402.4702)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(516395225562212838.4702)
,p_button_name=>'BACK2'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(25696820320761471.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(25698009916772677.4702)
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(25697412694761472.4702)
,p_branch_sequence=>10
,p_branch_condition_type=>'EXISTS'
,p_branch_condition=>'select 1 from WWV_FLOW_PROV_SIGNUP_Q where nvl(JUSTIFICATION_REQUIRED_YN,''Y'') = ''Y'''
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517470352545983375.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517470693841985745.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25699805554856566.4702)
,p_name=>'P24_Q1'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
,p_prompt=>'&Q1.'
,p_display_as=>'NATIVE_RADIOGROUP'
...
,p_field_template=>wwv_flow_imp.id(516405998930268369.4702)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25702726426919309.4702)
,p_name=>'P24_Q2'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25703326211928720.4702)
,p_name=>'P24_Q3'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25703724011994311.4702)
,p_name=>'P24_Q4'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25777606991111943.4702)
,p_name=>'P24_Q5'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25778026731117668.4702)
,p_name=>'P24_Q6'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25778229501118422.4702)
,p_name=>'P24_Q7'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25778431925119147.4702)
,p_name=>'P24_Q8'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25778601582119878.4702)
,p_name=>'P24_Q9'
,p_is_required=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25778810239122410.4702)
,p_name=>'P24_Q10'
,p_is_required=>true
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(25696432164760206.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517957195019106801.4702)
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_when_button_pressed=>wwv_flow_imp.id(25697412694761472.4702)
,p_associated_item=>wwv_flow_imp.id(25699805554856566.4702)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517957657444109073.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517958236752112011.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517958400795112554.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517958664493113319.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517958828394113925.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517959294776114427.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517959538183114913.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517959792447115409.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(517959974835115917.4702)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(25700112527886954.4702)
...
,p_internal_uid=>25700112527886954.4702
);
end;
/
...
,p_step_title=>unistr('Demander un espace de travail - Sch\00E9ma - &PRODUCT_NAME.')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4863831037.4702)
,p_plug_name=>'Demander un espace de travail'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(29261829463725446.4702)
,p_plug_name=>'Boutons d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(4863831037.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481969298650741033.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516145120027081703.4702)
,p_plug_name=>'Barre de progression d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(4863831037.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516145206173081704.4702)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_imp.id(516145120027081703.4702)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516145337648081705.4702)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_imp.id(4863831037.4702)
,p_region_css_classes=>'a-Wizard-body a-Form a-Form--large'
,p_region_template_options=>'#DEFAULT#'
...
,p_translate_title=>'N'
,p_landmark_type=>'form'
,p_landmark_label=>unistr('Sch\00E9ma')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'TEXT',
  'show_line_breaks', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18350230104012648.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4841831018.4702)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(29261829463725446.4702)
,p_button_name=>'Proceed'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(481975658518888812.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4893430263.4702)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(29261829463725446.4702)
,p_button_name=>'Back'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4839831015.4702)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(29261829463725446.4702)
,p_button_name=>'Cancel'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(177096326383922599.4702)
,p_branch_action=>'f?p=&APP_ID.:26:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(4841831018.4702)
,p_branch_sequence=>10
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(25800727750666745.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(66700008567178536.4702)
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>30
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(881357448284941741.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517333648995125819.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1617426846755257730.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4849831028.4702)
,p_name=>'DATABASE_SIZE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(516145337648081705.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(320269887457.4702)
,p_name=>'SCHEMA_NAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(516145337648081705.4702)
...
,p_field_template=>wwv_flow_imp.id(481972771960821314.4702)
,p_item_template_options=>'#DEFAULT#'
,p_protection_level=>'S'
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('Le nom de sch\00E9ma est l''utilisateur de base de donn\00E9es Oracle qui sera propri\00E9taire de vos objets de base de donn\00E9es. Choisissez-le soigneusement car le changement de sch\00E9ma peut \00EAtre laborieux. Apr\00E8s avoir provisionn\00E9 votre service, vous recevrez vot')
||unistr('re mot de passe de sch\00E9ma et votre mot de passe de connexion. Une fois que votre espace de travail est cr\00E9\00E9, vous pouvez y ajouter des sch\00E9mas suppl\00E9mentaires.'),
'',
'',
'',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(11472001772984287.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(36459510251028490.4702)
,p_name=>'NEW_SCHEMA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(516145337648081705.4702)
,p_item_default=>'YES'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(172217307242398784.4702)
...
,p_display_when2=>'YES'
,p_display_when_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_field_template=>wwv_flow_imp.id(18341322111783282.4702)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_escape_on_http_input=>'Y'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(172222728497414363.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(177097216171957551.4702)
,p_name=>'P25_SCHEMA'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(18350230104012648.4702)
,p_display_as=>'NATIVE_HIDDEN'
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WEB_SAFE'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(177098721282977925.4702)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1701190835973401.4702)
,p_computation_sequence=>20
,p_computation_item=>'SCHEMA_NAME'
,p_computation_type=>'EXPRESSION'
,p_computation_language=>'PLSQL'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(241344206807542545.4702)
,p_computation_sequence=>20
,p_computation_item=>'NEW_SCHEMA'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'FUNCTION_BODY'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(4348304649326378516.4702)
,p_computation_sequence=>30
,p_computation_item=>'DATABASE_SIZE'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'FUNCTION_BODY'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(174995802627402506.4702)
...
,p_associated_item=>wwv_flow_imp.id(320269887457.4702)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(174996724098408796.4702)
...
,p_validation_condition2=>'PLSQL'
,p_validation_condition_type=>'EXPRESSION'
,p_associated_item=>wwv_flow_imp.id(11472001772984287.4702)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(16910421773188557.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(31864751459513493.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(31865013913542993.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(47216914721574906.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(47217711926597880.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(59988904879054677.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(175009024256995482.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(426906789735388104.4702)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_imp.id(4849831028.4702)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(13059725120036431.4702)
,p_process_sequence=>10
...
':schema_name := replace(:schema_name,''^'','''');'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>13059725120036431.4702
);
end;
/
...
,p_step_title=>unistr('Demander un espace de travail - Avertisement de sch\00E9ma - &PRODUCT_NAME.')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(177082418885844385.4702)
,p_plug_name=>'Avertissement'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(18113207959457422.4702)
,p_plug_display_sequence=>10
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_plug_display_column=>1
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(195695513611201651.4702)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517949648797931799.4702)
,p_plug_name=>'Demander un espace de travail'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517949851182931801.4702)
,p_plug_name=>'Barre de progression d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(517949648797931799.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481969298650741033.4702)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517950053089931801.4702)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_imp.id(517949851182931801.4702)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517950234959931802.4702)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_imp.id(517949648797931799.4702)
,p_region_css_classes=>'a-Wizard-body a-Form'
,p_region_template_options=>'#DEFAULT#'
...
,p_translate_title=>'N'
,p_landmark_type=>'region'
,p_landmark_label=>unistr('Avertissement de sch\00E9ma')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517952931820969756.4702)
,p_plug_name=>'Shared Schema Warning'
,p_parent_plug_id=>wwv_flow_imp.id(517950234959931802.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517953857557021232.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517950490437931802.4702)
,p_plug_name=>'Boutons d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(517949648797931799.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(752122034442695897.4702)
,p_plug_name=>'Demande d''espace de travail'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'DEFAULT'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(728294112567557139.4702)
,p_plug_display_sequence=>10
,p_plug_new_grid_column=>false
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(177082802719844403.4702)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(517950490437931802.4702)
,p_button_name=>'Proceed'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(481975658518888812.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(177083008639844403.4702)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(517950490437931802.4702)
,p_button_name=>'Back'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(177082609759844393.4702)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(517950490437931802.4702)
,p_button_name=>'Cancel'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(66706514632218067.4702)
,p_branch_action=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(177082802719844403.4702)
,p_branch_sequence=>10
,p_branch_condition_type=>'EXISTS'
,p_branch_condition=>'select 1 from WWV_FLOW_PROV_SIGNUP_Q where SURVEY_ENABLED_YN = ''Y'''
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(25801706888679653.4702)
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(177082802719844403.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517472394235011586.4702)
,p_branch_action=>'f?p=&APP_ID.:28:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(177082802719844403.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517472886591015296.4702)
,p_branch_action=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(177082802719844403.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(177095520711911576.4702)
,p_name=>'P26_SCHEMA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(517950234959931802.4702)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>2000
,p_cHeight=>1
...
,p_step_title=>'Demander un espace de travail - Justification - &PRODUCT_NAME.'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516408864658385622.4702)
,p_plug_name=>'Demander un espace de travail'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516409065144385626.4702)
,p_plug_name=>'Barre de progression d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(516408864658385622.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481969298650741033.4702)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516409204387385627.4702)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_imp.id(516409065144385626.4702)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516409441539385628.4702)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_imp.id(516408864658385622.4702)
,p_region_css_classes=>'a-Wizard-body a-Form a-Form--large'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516411073780385633.4702)
,p_plug_name=>'Boutons d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(516408864658385622.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(516411245858385636.4702)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(516411073780385633.4702)
,p_button_name=>'Proceed'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(481975658518888812.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(109157847214.4702)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(516411073780385633.4702)
,p_button_name=>'Back'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(516411647143385640.4702)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(516411073780385633.4702)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(516362650992934299.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(66702007660187721.4702)
,p_branch_action=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(516411245858385636.4702)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(825273683475768706.4702)
,p_branch_name=>'Go to Page 2 (Request Page)'
,p_branch_action=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(109157847214.4702)
,p_branch_sequence=>10
,p_branch_condition_type=>'EXISTS'
,p_branch_condition=>'select 1 from WWV_FLOW_PROV_SIGNUP_Q where SHOW_SCHEMA_YN = ''N'' and SURVEY_ENABLED_YN = ''N'''
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(25802015676691687.4702)
,p_branch_name=>'Go To Page 24 (Survey)'
,p_branch_action=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(25802200570696805.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(109173847225.4702)
,p_name=>'PROJECT_DESCRIPTION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(516409441539385628.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(109175847225.4702)
...
,p_field_template=>wwv_flow_imp.id(516405744549268368.4702)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_escape_on_http_input=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(177451430104093580.4702)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(177458508913257768.4702)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(109236958762.4702)
...
,p_associated_item=>wwv_flow_imp.id(109173847225.4702)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
,p_step_title=>'Demander un espace de travail - Accord de service - &PRODUCT_NAME.'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(728298792391563586.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80230402173993477.4702)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(18108515260336521.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517967421599265744.4702)
,p_plug_name=>'Demander un espace de travail'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517967654884265745.4702)
,p_plug_name=>'Barre de progression d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(517967421599265744.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481969298650741033.4702)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517967892852265745.4702)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_imp.id(517967654884265745.4702)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517968022564265746.4702)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_imp.id(517967421599265744.4702)
,p_region_css_classes=>'a-Wizard-body a-Form'
,p_region_template_options=>'#DEFAULT#'
...
,p_translate_title=>'N'
,p_landmark_type=>'form'
,p_landmark_label=>'Accord'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80170923513990161.4702)
,p_plug_name=>'Agreement'
,p_parent_plug_id=>wwv_flow_imp.id(517968022564265746.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(81409728268284890.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(517968214545265746.4702)
,p_plug_name=>'Boutons d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(517967421599265744.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(80231020051993478.4702)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(517968214545265746.4702)
,p_button_name=>'Proceed'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(481975658518888812.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(80230815227993478.4702)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(517968214545265746.4702)
,p_button_name=>'Back'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(80230614027993477.4702)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(517968214545265746.4702)
,p_button_name=>'Cancel'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(80315521913999183.4702)
,p_branch_action=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(80231020051993478.4702)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517475649795114509.4702)
,p_branch_action=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(80230815227993478.4702)
,p_branch_sequence=>30
,p_branch_condition_type=>'EXISTS'
,p_branch_condition=>'select 1 from WWV_FLOW_PROV_SIGNUP_Q where nvl(SURVEY_ENABLED_YN,''N'') = ''Y'''
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517475870611116622.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(64572937523929403.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517475139255103367.4702)
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(80230815227993478.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(80434718366017037.4702)
,p_name=>'P28_ACCEPT_TERMS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(81409728268284890.4702)
,p_use_cache_before_default=>'NO'
,p_prompt=>'J''accepte les conditions'
,p_display_as=>'NATIVE_SINGLE_CHECKBOX'
,p_field_template=>wwv_flow_imp.id(805564588331659193.4702)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(144094305310958675.4702)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(247493906498726082.4702)
...
,p_when_button_pressed=>wwv_flow_imp.id(80231020051993478.4702)
,p_associated_item=>wwv_flow_imp.id(80434718366017037.4702)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
end;
/
...
,p_step_title=>'Demander un espace de travail - Confirmation - &PRODUCT_NAME.'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516416294096463438.4702)
,p_plug_name=>'Demander un espace de travail'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(94840826419648214.4702)
,p_plug_name=>'Wizard Body'
,p_parent_plug_id=>wwv_flow_imp.id(516416294096463438.4702)
,p_region_css_classes=>'a-Wizard-body a-Form a-Form--large'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481965601614717220.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(662394585165758447.4702)
,p_plug_name=>'Basic Info'
,p_parent_plug_id=>wwv_flow_imp.id(94840826419648214.4702)
,p_region_css_classes=>'region-basic-info'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481965601614717220.4702)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(662394649248758448.4702)
,p_plug_name=>'Usage Info'
,p_parent_plug_id=>wwv_flow_imp.id(94840826419648214.4702)
,p_region_css_classes=>'region-usage-info'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516416468522463439.4702)
,p_plug_name=>'Barre de progression d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(516416294096463438.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516416609246463439.4702)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_imp.id(516416468522463439.4702)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(516418271756463442.4702)
,p_plug_name=>'Boutons d''assistant'
,p_parent_plug_id=>wwv_flow_imp.id(516416294096463438.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(318141939408.4702)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(516418271756463442.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(318938118262.4702)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(516418271756463442.4702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(516418625242463444.4702)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(516418271756463442.4702)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(60145132142214439.4702)
,p_branch_action=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(318141939408.4702)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517468015163944139.4702)
,p_branch_action=>'f?p=&APP_ID.:28:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(318938118262.4702)
,p_branch_sequence=>15
,p_branch_condition_type=>'EXISTS'
,p_branch_condition=>'select 1 from WWV_FLOW_PROV_SIGNUP_Q where nvl(AGREEMENT_ENABLED_YN,''N'') = ''Y'''
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(388346306877278713.4702)
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(318938118262.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517414131433361542.4702)
,p_branch_action=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(318938118262.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(517415202755367631.4702)
,p_branch_name=>'Go To Page 25 (Schema Selection)'
,p_branch_action=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(825273817288768708.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2001296539897508.4702)
,p_name=>'P30_ADMIN_USERNAME'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(662394585165758447.4702)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Nom utilisateur de l''administrateur'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26273021255363662.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26401719484160967.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26402116498169624.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26402322731171379.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26402504854175640.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26402731520183408.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26403006848195226.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26403223124199902.4702)
,p_name=>'P30_DB_SIZE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(662394585165758447.4702)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662394782361758449.4702)
,p_name=>'P30_COUNTRY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(662394649248758448.4702)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Pays'
,p_source=>'P2_COUNTRY'
,p_source_type=>'ITEM'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662394824050758450.4702)
,p_name=>'P30_USAGE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(662394649248758448.4702)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(825539283026735501.4702)
,p_name=>'P30_ORG_NAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(662394649248758448.4702)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(143943821324944409.4702)
...
,p_when_button_pressed=>wwv_flow_imp.id(318141939408.4702)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(247624218797767424.4702)
,p_validation_name=>'terms accepted'
,p_validation_sequence=>30
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2184197002254427848.4702)
,p_validation_name=>'new schema name not null'
,p_validation_sequence=>40
,p_validation=>'SCHEMA_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2184242065158429229.4702)
,p_validation_name=>'existing schema name not null'
,p_validation_sequence=>50
,p_validation=>'EXISTING_SCHEMA_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2184242341374430656.4702)
,p_validation_name=>'schema exists'
,p_validation_sequence=>60
,p_validation=>'wwv_flow_security.exists_db_user(upper(:EXISTING_SCHEMA_NAME))'
,p_validation2=>'PLSQL'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2184242602392431985.4702)
,p_validation_name=>'new schema does not exist'
,p_validation_sequence=>70
,p_validation=>'wwv_flow_security.get_db_user_or_role(upper(:SCHEMA_NAME)) is null'
,p_validation2=>'PLSQL'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2184247877095437803.4702)
,p_validation_name=>'no spaces in name'
,p_validation_sequence=>80
,p_validation=>'SCHEMA_NAME'
,p_validation_type=>'ITEM_CONTAINS_NO_SPACES'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2184248749119438943.4702)
,p_validation_name=>'schema name cant contain quotes'
,p_validation_sequence=>90
,p_validation=>'instr(:SCHEMA_NAME,'''''''')+instr(:SCHEMA_NAME,''"'') = 0'
,p_validation2=>'PLSQL'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2184249045719440018.4702)
,p_validation_name=>'cannot be an oracle reserved word'
,p_validation_sequence=>100
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'wwv_flow_provision.schema_name_valid(',
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2184249340031441378.4702)
,p_validation_name=>'schema name is valid'
,p_validation_sequence=>110
,p_validation=>'wwv_flow_utilities.is_valid_identifier(:SCHEMA_NAME)'
,p_validation2=>'PLSQL'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2184249626926442496.4702)
,p_validation_name=>'new schema not used in existing workspace'
,p_validation_sequence=>120
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select null',
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16952718581632268.4702)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(318141939408.4702)
,p_internal_uid=>16952718581632268.4702
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(235706412746607558.4702)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(318141939408.4702)
,p_internal_uid=>235706412746607558.4702
);
end;
/
...
,p_step_title=>unistr('Cr\00E9ation de l''espace de travail - &PRODUCT_NAME.')
,p_allow_duplicate_submissions=>'N'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(698805774605413350.4702)
,p_plug_name=>'Demander un espace de travail'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481970015003751305.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(785007731946389617.4702)
,p_plug_name=>'Approval Status'
,p_parent_plug_id=>wwv_flow_imp.id(698805774605413350.4702)
,p_region_css_classes=>'a-Wizard-body'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481965601614717220.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(785007904613389618.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2002492859897520.4702)
,p_plug_name=>unistr('Mot de passe de la base de donn\00E9es')
,p_parent_plug_id=>wwv_flow_imp.id(785007904613389618.4702)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(481965601614717220.4702)
,p_plug_display_sequence=>15
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(416033801984152703.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(825233966004277601.4702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(861065721162173096.4702)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_imp.id(698805774605413350.4702)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(861008913543170914.4702)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(861065721162173096.4702)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2002948647897525.4702)
,p_branch_name=>'Go to sign-in URL'
,p_branch_action=>'&P73_SIGN_IN_URL.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(861008913543170914.4702)
,p_branch_sequence=>5
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(785009012421389623.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2002595423897521.4702)
,p_name=>'P73_WKSP_PASSWORD'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2002492859897520.4702)
,p_prompt=>unistr('Mot de passe de la base de donn\00E9es')
,p_placeholder=>unistr('Mot de passe de la base de donn\00E9es')
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_field_template=>wwv_flow_imp.id(481972669929805619.4702)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('Saisissez le mot de passe du sch\00E9ma de base de donn\00E9es associ\00E9 \00E0 l''espace de travail.')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'submit_when_enter_pressed', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2002666835897522.4702)
,p_name=>'P73_WKSP_CONFIRM_PASSWORD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2002492859897520.4702)
,p_prompt=>unistr('Confirmer le mot de passe de base de donn\00E9es')
,p_placeholder=>unistr('Confirmer le mot de passe de base de donn\00E9es')
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_field_template=>wwv_flow_imp.id(481972669929805619.4702)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('Confirmez le mot de passe du sch\00E9ma de base de donn\00E9es associ\00E9 \00E0 l''espace de travail.')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'submit_when_enter_pressed', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2003023714897526.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(79232294700259812.4702)
,p_name=>'P73_SUCCESS_ICON_LABEL'
,p_item_sequence=>55
,p_item_plug_id=>wwv_flow_imp.id(785007904613389618.4702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(416033622824152701.4702)
,p_name=>'P73_WS_PROV_DISABLED'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(698805774605413350.4702)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(416033983865152704.4702)
,p_name=>'P73_STATUS_1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(416033801984152703.4702)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'I'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(785008112786389619.4702)
,p_name=>'P73_STATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(825233966004277601.4702)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'I'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(785603515624489906.4702)
,p_name=>'PROVISION_ID'
,p_item_sequence=>35
,p_item_plug_id=>wwv_flow_imp.id(785007904613389618.4702)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2210612504487687901.4702)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(416033728614152702.4702)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2002710211897523.4702)
...
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Le mot de passe de confirmation ne correspond pas au mot de passe.'
,p_validation_condition=>'P73_WKSP_PASSWORD'
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_imp.id(2002666835897522.4702)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2002865550897524.4702)
...
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Le mot de passe n''est pas conforme aux r\00E8gles de complexit\00E9 de mot de passe de base de donn\00E9es.')
,p_validation_condition=>'P73_WKSP_PASSWORD'
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_imp.id(2002595423897521.4702)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(107287619660340910.4702)
,p_name=>'Page Load'
,p_event_sequence=>10
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(107287728097340911.4702)
,p_event_id=>wwv_flow_imp.id(107287619660340910.4702)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(785008723931389621.4702)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_internal_uid=>785008723931389621.4702
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2003128521897527.4702)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_security_scheme=>wwv_flow_imp.id(116607181908334943)
,p_internal_uid=>2003128521897527.4702
);
end;
/
