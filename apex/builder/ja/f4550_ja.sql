...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A135800169939738020')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121679821726671272)
,p_name=>'USERNAME'
,p_message_language=>'ja'
,p_message_text=>unistr('\30E6\30FC\30B6\30FC\540D')
,p_version_scn=>2566741
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121679975375671272)
,p_name=>'USERNAME_DB'
,p_message_language=>'ja'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121680022081671272)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121679787837671272)
