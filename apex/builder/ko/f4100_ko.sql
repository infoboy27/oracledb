...
prompt APPLICATION 4108 - Oracle APEX Home
--
-- Application Export:
--   Application:     4108
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A133200350321730354')
...
,p_authentication_id=>wwv_flow_imp.id(1477739433453980.4108)
,p_populate_roles=>'A'
...
,p_substitution_value_15=>unistr('\C791\C5C5\C601\C5ED')
,p_substitution_string_16=>'TOP'
,p_substitution_value_16=>unistr('\CD5C\C0C1\C704')
...
wwv_flow_imp_shared.create_user_interface(
 p_id=>wwv_flow_imp.id(4108)
,p_theme_id=>3
,p_home_url=>'f?p=&APP_ID.:1:&SESSION.'
,p_login_url=>'f?p=4550:1:&SESSION.'
,p_theme_style_by_user_pref=>false
,p_global_page_id=>.4108
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1617849920194181.4108)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1618455056194184.4108)
,p_name=>'APEX 5 - Administration (Header)'
,p_list_status=>'PUBLIC'
,p_version_scn=>75558566
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1618783082194184.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1619173198194185.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1619525076194185.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1619987530194185.4108)
,p_list_item_display_sequence=>80
,p_list_item_link_text=>unistr('\C11C\BE44\C2A4 \AD00\B9AC')
,p_list_item_link_target=>'f?p=4350:21:&SESSION.'
,p_parent_list_item_id=>wwv_flow_imp.id(1619525076194185.4108)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1620329248194185.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1620710462194185.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1621148075194186.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1621594633194186.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1621946860194186.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1622378322194186.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1622789414194186.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1623111874194186.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1623530036194186.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1623931361194186.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1624363378194187.4108)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1627426286194188.4108)
,p_name=>'APEX 5 - Help'
,p_list_status=>'PUBLIC'
,p_version_scn=>75558566
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1627759179194188.4108)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1628124395194188.4108)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1628537632194188.4108)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1628923818194189.4108)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'---'
,p_list_item_link_target=>'separator'
,p_list_item_current_type=>'TARGET_PAGE'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1629305193194189.4108)
,p_list_item_display_sequence=>60
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1630037294194189.4108)
,p_name=>'APEX Shared Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>117449631
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2403843244227546.4108)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2404237488227546.4108)
,p_list_item_display_sequence=>50
...
,p_parent_list_item_id=>wwv_flow_imp.id(2403843244227546.4108)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2404619537227546.4108)
,p_list_item_display_sequence=>60
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2405089679227547.4108)
,p_list_item_display_sequence=>70
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2405403074227547.4108)
,p_list_item_display_sequence=>80
,p_list_item_link_text=>'-----'
,p_list_item_link_target=>'separator'
,p_parent_list_item_id=>wwv_flow_imp.id(2403843244227546.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2405818423227547.4108)
,p_list_item_display_sequence=>90
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2406216522227547.4108)
,p_list_item_display_sequence=>100
...
,p_parent_list_item_id=>wwv_flow_imp.id(2405818423227547.4108)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2406696349227547.4108)
,p_list_item_display_sequence=>110
,p_list_item_link_text=>'-----'
,p_list_item_link_target=>'separator'
,p_parent_list_item_id=>wwv_flow_imp.id(2405818423227547.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2407043537227547.4108)
,p_list_item_display_sequence=>120
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2407462853227547.4108)
,p_list_item_display_sequence=>130
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2407880221227547.4108)
,p_list_item_display_sequence=>140
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2408244733227547.4108)
,p_list_item_display_sequence=>150
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2408689689227548.4108)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2409068298227548.4108)
,p_list_item_display_sequence=>160
,p_list_item_link_text=>unistr('\AC1D\CCB4 \BE0C\B77C\C6B0\C800')
,p_list_item_link_target=>'f?p=4500:2000:&SESSION.'
,p_parent_list_item_id=>wwv_flow_imp.id(2408689689227548.4108)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2409468379227548.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2409858431227548.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2410231181227548.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2410677438227548.4108)
,p_list_item_display_sequence=>220
,p_list_item_link_text=>unistr('\BAA8\B4E0 \C720\D2F8\B9AC\D2F0')
,p_list_item_link_target=>'f?p=4500:1005:&SESSION.'
,p_parent_list_item_id=>wwv_flow_imp.id(2410231181227548.4108)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2411077057227548.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2411410188227548.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2411849897227548.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2412280619227549.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2412626517227549.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2413096377227549.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2413408594227549.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2413851734227549.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2414238158227549.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2414683084227549.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2415007234227549.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2415477456227549.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2415817620227550.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2416260382227550.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2416601343227550.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2417049908227550.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2417408089227550.4108)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2417833728227550.4108)
...
,p_parent_list_item_id=>wwv_flow_imp.id(2417408089227550.4108)
,p_security_scheme=>wwv_flow_imp.id(2224190594209629)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2418247493227550.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2418608489227550.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2419002732227551.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2419414186227551.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2419881466227551.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2420256494227551.4108)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2218105708209619.4108)
,p_name=>'APEX 5.0 - Homepage Large Icons'
,p_list_status=>'PUBLIC'
,p_version_scn=>75558571
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2218444371209623.4108)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('\C560\D50C\B9AC\CF00\C774\C158 \C791\C131\AE30')
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2218846300209623.4108)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>unistr('SQL \C6CC\D06C\C20D')
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2219293910209624.4108)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>unistr('\D300 \AC1C\BC1C')
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2220037679209624.4108)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>unistr('\AC24\B7EC\B9AC')
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2220705999209625.4108)
,p_name=>'HOME RESOURCES LINKS'
,p_list_status=>'PUBLIC'
,p_version_scn=>75558571
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2221029322209625.4108)
,p_list_item_display_sequence=>1
,p_list_item_link_text=>unistr('APEX \C6F9 \C0AC\C774\D2B8')
,p_list_item_link_target=>'https://apex.oracle.com'
,p_list_text_02=>'rel="noopener noreferrer" target="_blank"'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2221466786209625.4108)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2221896356209625.4108)
,p_list_item_display_sequence=>3
,p_list_item_link_text=>unistr('\C790\C2B5\C11C')
,p_list_item_link_target=>'https://apex.oracle.com/hols'
,p_list_text_02=>'rel="noopener noreferrer" target="_blank"'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2222240011209625.4108)
,p_list_item_display_sequence=>4
,p_list_item_link_text=>unistr('\BE44\B514\C624')
,p_list_item_link_target=>'https://apex.oracle.com/videos'
,p_list_text_02=>'rel="noopener noreferrer" target="_blank"'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2222649130209626.4108)
,p_list_item_display_sequence=>5
,p_list_item_link_text=>unistr('\AD50\C721 \B9AC\C18C\C2A4')
,p_list_item_link_target=>'https://apex.oracle.com/en/learn/training'
,p_list_text_02=>'rel="noopener noreferrer" target="_blank"'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2223026857209626.4108)
,p_list_item_display_sequence=>6
,p_list_item_link_text=>unistr('\C544\C774\B514\C5B4 & \AE30\B2A5 \C694\CCAD')
,p_list_item_link_target=>'https://apex.oracle.com/ideas'
,p_list_text_02=>'rel="noopener noreferrer" target="_blank"'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2223485071209626.4108)
,p_list_item_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1379109302453695.4108)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1385696208781672.4108)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>16260374
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1410424097182729.4108)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>243440456
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1815858492262215.4108)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3297538466139501.4108)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(16459931833762295.4108)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(101445796627710162.4108)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(120082043033654285.4108)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(124814912138299724.4108)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(125990604929810556.4108)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37165931336889
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(177729850064328075.4108)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1766673389073533311.4108)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1833381130509815410.4108)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1919233990275761144.4108)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(1601594384779894.4108)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(1602976254825538.4108)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(1605452165888276.4108)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(1605994067894491.4108)
,p_name=>'Flow: RESTFUL'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(1606493727894491.4108)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(1606732058896590.4108)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(2000440587529722.4108)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(2224190594209629.4108)
,p_name=>'Flow: EDIT'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'EDIT'
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(2232502732209663.4108)
,p_name=>'Flow: ADMIN'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(2233317028209664.4108)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(2611096505029836.4108)
,p_name=>'Flow: SQL'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'SQL'
,p_error_message=>unistr('SQL \C6CC\D06C\C20D\C744 \C0AC\C6A9\D560 \C218 \C788\B294 \AD8C\D55C\C774 \C5C6\C2B5\B2C8\B2E4.')
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3600276725917337.4108)
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(3218774193006818.4108)
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1601366600985622.4108)
,p_name=>'COMPANY'
,p_scope=>'GLOBAL'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(2120234306877780.4108)
,p_tab_set=>'main'
,p_tab_sequence=>1
,p_tab_name=>'One'
,p_tab_text=>'1'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(2120359237877780.4108)
,p_tab_set=>'main'
,p_tab_sequence=>2
,p_tab_name=>'Two'
,p_tab_text=>'2'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(2120443543877780.4108)
,p_tab_set=>'main'
,p_tab_sequence=>3
,p_tab_name=>'Three'
,p_tab_text=>'3'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(2120545101877780.4108)
,p_tab_set=>'main'
,p_tab_sequence=>4
,p_tab_name=>'Four'
,p_tab_text=>'4'
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3012084751088963.4108)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3026135455596117.4108)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3026546251596121.4108)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>unistr('\C608')
,p_lov_return_value=>'Y'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3026941068596121.4108)
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(123406906725078162.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1802292231311016.4108)
,p_page_template_id=>wwv_flow_imp.id(123406906725078162.4108)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1802738969311016.4108)
,p_page_template_id=>wwv_flow_imp.id(123406906725078162.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1803232667311016.4108)
,p_page_template_id=>wwv_flow_imp.id(123406906725078162.4108)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(389474351319109454.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1611259698131892.4108)
,p_page_template_id=>wwv_flow_imp.id(389474351319109454.4108)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1611725721131892.4108)
,p_page_template_id=>wwv_flow_imp.id(389474351319109454.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1612290535131892.4108)
,p_page_template_id=>wwv_flow_imp.id(389474351319109454.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1612732660131892.4108)
,p_page_template_id=>wwv_flow_imp.id(389474351319109454.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1613214988131893.4108)
,p_page_template_id=>wwv_flow_imp.id(389474351319109454.4108)
,p_name=>'After Body'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1613777858131893.4108)
,p_page_template_id=>wwv_flow_imp.id(389474351319109454.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1614229176131893.4108)
,p_page_template_id=>wwv_flow_imp.id(389474351319109454.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1614731065131893.4108)
,p_page_template_id=>wwv_flow_imp.id(389474351319109454.4108)
,p_name=>'Control Bar'
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(691639526441810142.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1805260100311015.4108)
,p_page_template_id=>wwv_flow_imp.id(691639526441810142.4108)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1805722909311015.4108)
,p_page_template_id=>wwv_flow_imp.id(691639526441810142.4108)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1806222055311015.4108)
,p_page_template_id=>wwv_flow_imp.id(691639526441810142.4108)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(705262749447911709.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1573939793875402.4108)
,p_page_template_id=>wwv_flow_imp.id(705262749447911709.4108)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1574498382875402.4108)
,p_page_template_id=>wwv_flow_imp.id(705262749447911709.4108)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1574975563875402.4108)
,p_page_template_id=>wwv_flow_imp.id(705262749447911709.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1575408320875402.4108)
,p_page_template_id=>wwv_flow_imp.id(705262749447911709.4108)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1575992253875402.4108)
,p_page_template_id=>wwv_flow_imp.id(705262749447911709.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1576489306875403.4108)
,p_page_template_id=>wwv_flow_imp.id(705262749447911709.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1576918475875403.4108)
,p_page_template_id=>wwv_flow_imp.id(705262749447911709.4108)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1577486896875403.4108)
,p_page_template_id=>wwv_flow_imp.id(705262749447911709.4108)
,p_name=>'Control Bar'
,p_placeholder=>'REGION_POSITION_09'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(2582194691768847.4108)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(177329393740370707.4108)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(356399210687168533.4108)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(407467631666671465.4108)
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3180613577501013.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3181113419501014.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3181626149501014.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3182174665501014.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3182609277501014.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3183174058501014.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3183628103501014.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3184159871501014.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3184609861501015.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3185172586501015.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3185609802501015.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3186131484501015.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3186607361501015.4108)
,p_plug_template_id=>wwv_flow_imp.id(177327211140356819.4108)
,p_name=>'Sub Regions'
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1855331088310993.4108)
,p_plug_template_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1855879072310993.4108)
,p_plug_template_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1856351730310993.4108)
,p_plug_template_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1856818750310993.4108)
,p_plug_template_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1857397455310993.4108)
,p_plug_template_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1857867496310992.4108)
,p_plug_template_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1858369180310992.4108)
,p_plug_template_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1858844776310992.4108)
,p_plug_template_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2342114575232392.4108)
,p_plug_template_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2342635925232392.4108)
,p_plug_template_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2343101102232392.4108)
,p_plug_template_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2343698204232392.4108)
,p_plug_template_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2344168466232392.4108)
,p_plug_template_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2344663901232392.4108)
,p_plug_template_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2345146063232393.4108)
,p_plug_template_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2345608769232393.4108)
,p_plug_template_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2346107904232393.4108)
,p_plug_template_id=>wwv_flow_imp.id(689731959698504608.4108)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(705356091066836147.4108)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3370958198508598.4108)
,p_plug_template_id=>wwv_flow_imp.id(705356091066836147.4108)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3371492470508598.4108)
,p_plug_template_id=>wwv_flow_imp.id(705356091066836147.4108)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(719473716690283992.4108)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1831423363311006.4108)
,p_plug_template_id=>wwv_flow_imp.id(719473716690283992.4108)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1831977568311005.4108)
,p_plug_template_id=>wwv_flow_imp.id(719473716690283992.4108)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1832447570311005.4108)
,p_plug_template_id=>wwv_flow_imp.id(719473716690283992.4108)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1832925515311005.4108)
,p_plug_template_id=>wwv_flow_imp.id(719473716690283992.4108)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(748940840395094996.4108)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2627160804486641.4108)
,p_plug_template_id=>wwv_flow_imp.id(748940840395094996.4108)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2627605140486641.4108)
,p_plug_template_id=>wwv_flow_imp.id(748940840395094996.4108)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2628132482486641.4108)
,p_plug_template_id=>wwv_flow_imp.id(748940840395094996.4108)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2628615909486641.4108)
,p_plug_template_id=>wwv_flow_imp.id(748940840395094996.4108)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2629137582486641.4108)
,p_plug_template_id=>wwv_flow_imp.id(748940840395094996.4108)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2629674370486641.4108)
,p_plug_template_id=>wwv_flow_imp.id(748940840395094996.4108)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(62797997509026315.4108)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(483868913244428740.4108)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(576186007498036655.4108)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(750166499508430361.4108)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li data-id="#A01#" data-disabled="#A02#" data-hide="#A03#" data-shortcut="#A05#" data-icon="#IMAGE#"><a href="#LINK#" title="#A04#" target="#A06#">#TEXT_ESC_SC#</a></li>',
''))
,p_list_template_noncurrent=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(19962201430770078.4108)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(45598789574081657.4108)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(126304304235156391.4108)
...
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(490022788869589047.4108)
...
wwv_flow_imp_shared.create_menu_template(
 p_id=>wwv_flow_imp.id(62693790206705397.4108)
...
wwv_flow_imp_shared.create_popup_lov_template(
 p_id=>wwv_flow_imp.id(19921604347467104.4108)
,p_page_name=>'winlov'
...
wwv_flow_imp_shared.create_calendar_template(
 p_id=>wwv_flow_imp.id(356488392221240483.4108)
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(74913758140436872.4108)
,p_theme_id=>3
,p_name=>'DARK'
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(206603805592668941.4108)
,p_theme_id=>3
,p_name=>'STANDARD'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#IMAGE_PREFIX#apex_ui/css/Core#MIN#.css',
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(558983391492013378.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(558983737888014296.4108)
,p_theme_id=>3
,p_name=>'DARK_AUTO'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#IMAGE_PREFIX#apex_ui/css/Core#MIN#.css',
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2331115830942766.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(43714721750457965.4108)
,p_theme_id=>3
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(43715061334460957.4108)
,p_theme_id=>3
,p_name=>'POSITION'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(43728767467520495.4108)
,p_theme_id=>3
,p_name=>'POSITION'
,p_display_name=>'Position'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(43729028014521705.4108)
,p_theme_id=>3
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691610009132341687.4108)
,p_theme_id=>3
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691610992308352426.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691614934496412684.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691616973788448155.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691619708705485573.4108)
,p_theme_id=>3
,p_name=>'HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691620535991491777.4108)
,p_theme_id=>3
,p_name=>'MIN_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691620827929493147.4108)
,p_theme_id=>3
,p_name=>'MAX_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691629687688573743.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691629899553589712.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691630283009598174.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691632805063632016.4108)
,p_theme_id=>3
,p_name=>'REPORT_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691634866703732289.4108)
,p_theme_id=>3
,p_name=>'BADGE_LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(691635167633733230.4108)
,p_theme_id=>3
,p_name=>'BADGE_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(692166612263600144.4108)
,p_theme_id=>3
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(692167000894602128.4108)
,p_theme_id=>3
,p_name=>'BUTTON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(692167571247604773.4108)
,p_theme_id=>3
,p_name=>'BUTTON_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(692167828637612722.4108)
,p_theme_id=>3
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(692168169601613874.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(692541160455046908.4108)
,p_theme_id=>3
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(695298623325664539.4108)
,p_theme_id=>3
,p_name=>'LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(699194246855963220.4108)
,p_theme_id=>3
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(699801854632577609.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(705257415511784923.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(705257788687787397.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(705258067077791834.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(705259938635865472.4108)
,p_theme_id=>3
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(705260442622868445.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(748946183635152772.4108)
,p_theme_id=>3
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(973241007478085524.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1144032929399219984.4108)
,p_theme_id=>3
,p_name=>'DIALOG_SIZE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2331409322953323.4108)
,p_theme_id=>3
,p_name=>'HEADING_LEVEL_H1'
,p_display_name=>'H1'
,p_display_sequence=>10
,p_css_classes=>'js-headingLevel-1'
,p_group_id=>wwv_flow_imp.id(2331115830942766.4108)
,p_template_types=>'REGION'
,p_help_text=>'H1'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2331780264953323.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2332111475953323.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2332514641953323.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2332971622953323.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2333391540953323.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691608851221337889.4108)
,p_theme_id=>3
,p_name=>'REGIONCONTAINSITEMSTEXT'
,p_display_name=>'Region Contains Items / Text'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(689731959698504608.4108)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691610454539345839.4108)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(691610009132341687.4108)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691610726982348768.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691611804103356909.4108)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
...
,p_group_id=>wwv_flow_imp.id(691610992308352426.4108)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691612599896358434.4108)
,p_theme_id=>3
,p_name=>'NOPADDING'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691612949932361868.4108)
,p_theme_id=>3
,p_name=>'WIZARDDIALOG'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691613980489402455.4108)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
,p_region_template_id=>wwv_flow_imp.id(177327211140356819.4108)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691614593048408669.4108)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691615602198416769.4108)
,p_theme_id=>3
,p_name=>'SIDEBAR'
...
,p_group_id=>wwv_flow_imp.id(691614934496412684.4108)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691615855398424614.4108)
,p_theme_id=>3
,p_name=>'BORDERLESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691617156639451379.4108)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(691616973788448155.4108)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691617330946458221.4108)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691624039714518094.4108)
,p_theme_id=>3
,p_name=>'180PX'
,p_display_name=>'180px'
,p_display_sequence=>10
,p_css_classes=>'h180'
,p_group_id=>wwv_flow_imp.id(691619708705485573.4108)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691624271615518898.4108)
,p_theme_id=>3
,p_name=>'240PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691624442879519682.4108)
,p_theme_id=>3
,p_name=>'320PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691625258734526314.4108)
,p_theme_id=>3
,p_name=>'480PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691625404573527240.4108)
,p_theme_id=>3
,p_name=>'540PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691625648264528093.4108)
,p_theme_id=>3
,p_name=>'640PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691630735559611921.4108)
,p_theme_id=>3
,p_name=>'DISABLE'
,p_display_name=>'Disable'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(126304304235156391.4108)
,p_css_classes=>'a-Report--staticRowColors'
,p_group_id=>wwv_flow_imp.id(691629899553589712.4108)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691630958176614505.4108)
,p_theme_id=>3
,p_name=>'ENABLE'
...
,p_group_id=>wwv_flow_imp.id(691630283009598174.4108)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691631092229617685.4108)
,p_theme_id=>3
,p_name=>'NOBORDERS'
...
,p_group_id=>wwv_flow_imp.id(691629687688573743.4108)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691631346547619111.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691631508974620465.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691631820026625155.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(691633179518635720.4108)
,p_theme_id=>3
,p_name=>'STRETCH'
...
,p_group_id=>wwv_flow_imp.id(691632805063632016.4108)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692381362484194510.4108)
,p_theme_id=>3
,p_name=>'FIRSTBUTTON'
,p_display_name=>'First Button'
,p_display_sequence=>1
,p_css_classes=>'a-Button--pillStart'
,p_group_id=>wwv_flow_imp.id(692166612263600144.4108)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692381524691195682.4108)
,p_theme_id=>3
,p_name=>'INNERBUTTON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692381790962197051.4108)
,p_theme_id=>3
,p_name=>'LASTBUTTON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692382206620198280.4108)
,p_theme_id=>3
,p_name=>'LARGE'
,p_display_name=>'Large'
,p_display_sequence=>3
,p_css_classes=>'a-Button--large'
,p_group_id=>wwv_flow_imp.id(692167000894602128.4108)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692382487369199773.4108)
,p_theme_id=>3
,p_name=>'SMALL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692382740539201226.4108)
,p_theme_id=>3
,p_name=>'PRIMARY'
,p_display_name=>'Primary'
,p_display_sequence=>1
,p_css_classes=>'a-Button--primary'
,p_group_id=>wwv_flow_imp.id(692167571247604773.4108)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692383241675208198.4108)
,p_theme_id=>3
,p_name=>'SMALLLEFT'
,p_display_name=>'Small'
,p_display_sequence=>1
,p_css_classes=>'a-Button--padLeft'
,p_group_id=>wwv_flow_imp.id(692167828637612722.4108)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692383426308209580.4108)
,p_theme_id=>3
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692383661650210808.4108)
,p_theme_id=>3
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
,p_css_classes=>'a-Button--padRight'
,p_group_id=>wwv_flow_imp.id(692168169601613874.4108)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692383832606212043.4108)
,p_theme_id=>3
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(692384041509216663.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(696142711566578093.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699195070516973851.4108)
,p_theme_id=>3
,p_name=>'VISIBLE'
...
,p_group_id=>wwv_flow_imp.id(699194246855963220.4108)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699357621055593644.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699626763905279667.4108)
,p_theme_id=>3
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699626966036282201.4108)
,p_theme_id=>3
,p_name=>'HIDDEN'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699802068476581269.4108)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(62797997509026315.4108)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699802407718583122.4108)
,p_theme_id=>3
,p_name=>'SHOWBADGES'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699802972727584497.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699803979532586784.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699804114369588930.4108)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(699801854632577609.4108)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699804349283590370.4108)
,p_theme_id=>3
,p_name=>'FORALLITEMS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699929437455355707.4108)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(19962201430770078.4108)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699929674377357548.4108)
,p_theme_id=>3
,p_name=>'SHOWRIGHTARROW'
,p_display_name=>'Show Right Arrow'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(699929867457360285.4108)
,p_theme_id=>3
,p_name=>'USEBRIGHTHOVERS'
,p_display_name=>'Use Bright Hovers'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(701377614177264047.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(701504954354104541.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705258498509815758.4108)
,p_theme_id=>3
,p_name=>'ALIGNLABELSLEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_css_classes=>'a-Form--leftLabels'
,p_group_id=>wwv_flow_imp.id(705257415511784923.4108)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705258728607823091.4108)
,p_theme_id=>3
,p_name=>'LABELSABOVE'
,p_display_name=>'Labels Above'
,p_display_sequence=>1
,p_css_classes=>'a-Form--labelsAbove'
,p_group_id=>wwv_flow_imp.id(705258067077791834.4108)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705258984972828407.4108)
,p_theme_id=>3
,p_name=>'FIXEDWIDTH'
,p_display_name=>'Fixed'
,p_display_sequence=>10
,p_css_classes=>'a-Form--fixedLabels'
,p_group_id=>wwv_flow_imp.id(705257788687787397.4108)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705259180947833097.4108)
,p_theme_id=>3
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705259337581834791.4108)
,p_theme_id=>3
,p_name=>'FIXEDLARGE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705259659387844782.4108)
,p_theme_id=>3
,p_name=>'AUTOWIDTH'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(705261079402877880.4108)
,p_theme_id=>3
,p_name=>'LABELAUTOWIDTH'
,p_display_name=>'Auto Width'
,p_display_sequence=>1
,p_css_classes=>'a-Form-fieldContainer--autoLabelWidth'
,p_group_id=>wwv_flow_imp.id(705259938635865472.4108)
,p_template_types=>'FIELD'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(748943467101110290.4108)
,p_theme_id=>3
,p_name=>'REMOVE_ICON'
,p_display_name=>'Remove Icons'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(748940840395094996.4108)
,p_css_classes=>'a-Alert--noIcon'
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(748943499375112133.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(748943683837113689.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(748947363084163363.4108)
,p_theme_id=>3
,p_name=>'WARNING'
...
,p_group_id=>wwv_flow_imp.id(748946183635152772.4108)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(748947628094165279.4108)
,p_theme_id=>3
,p_name=>'ERROR'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(748947933370166382.4108)
,p_theme_id=>3
,p_name=>'SUCCESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(748948074977167724.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(748949147694178185.4108)
,p_theme_id=>3
,p_name=>'HORIZONTAL'
...
,p_group_id=>wwv_flow_imp.id(692541160455046908.4108)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(748949259689179148.4108)
,p_theme_id=>3
,p_name=>'WIZARD'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(753358265381424737.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(761297057995689749.4108)
,p_theme_id=>3
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_imp.id(407467631666671465.4108)
,p_css_classes=>'a-Button--iconLeft'
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(928101457292899068.4108)
,p_theme_id=>3
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(750166499508430361.4108)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(928101585277900103.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(973251040702199002.4108)
,p_theme_id=>3
,p_name=>'FLOAT_ITEMS_LEFT'
,p_display_name=>'Float Items Left'
,p_display_sequence=>1
,p_css_classes=>'a-Form--floatFieldsLeft'
,p_group_id=>wwv_flow_imp.id(973241007478085524.4108)
,p_template_types=>'REGION'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(973251321881205391.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(976279658598162905.4108)
,p_theme_id=>3
,p_name=>'INLINE_FIELD'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1069063365685659519.4108)
,p_theme_id=>3
,p_name=>'SIMPLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1140386536161755172.4108)
,p_theme_id=>3
,p_name=>'RESIZABLE'
,p_display_name=>'Resizable'
,p_display_sequence=>2
,p_region_template_id=>wwv_flow_imp.id(431176191030605311.4108)
,p_css_classes=>'js-resizable'
,p_template_types=>'REGION'
,p_help_text=>'Allow dialog to be resized.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1140392434476761157.4108)
,p_theme_id=>3
,p_name=>'DRAGGABLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1144033764467234743.4108)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(1144032929399219984.4108)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1144034175264237920.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1144037051374282290.4108)
,p_theme_id=>3
,p_name=>'MODAL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1144813515822739415.4108)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(3475503069093017.4108)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121664761316670185)
,p_name=>'LEARN_MORE_APEX_HOME'
,p_message_language=>'ko'
,p_message_text=>unistr('Oracle APEX\C5D0 \B300\D55C \C790\C138\D55C \C815\BCF4')
,p_version_scn=>2566609
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121664889926670185)
,p_name=>'LEARN_MORE_APEX_HOME_ADB'
,p_message_language=>'ko'
,p_message_text=>unistr('\C790\C728\C6B4\C601 \B370\C774\D130\BCA0\C774\C2A4\C758 Oracle APEX\C5D0 \B300\D574 \C790\C138\D788 \C54C\C544\BCF4\AE30')
,p_version_scn=>2566609
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121664406342670185)
,p_name=>'P1_NO_WS_MESSAGE'
,p_message_language=>'ko'
,p_message_text=>unistr('\C791\C5C5\C601\C5ED \BA54\C2DC\C9C0 \C5C6\C74C')
,p_version_scn=>2566609
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121664583430670185)
,p_name=>'P1_RESULT_CACHE_MODE'
,p_message_language=>'ko'
,p_message_text=>unistr('\C774 \B370\C774\D130\BCA0\C774\C2A4\B294 <code>result_cache_mode</code> \B9E4\AC1C\BCC0\C218\B97C <code>%0</code>\C73C\B85C \AD6C\C131\D588\C2B5\B2C8\B2E4. \C571\C5D0\C11C <code>v()</code> \B610\B294 <code>APEX_PAGE.get_url()</code>\ACFC \AC19\C774 \BA85\D655\D558\C9C0 \C54A\C740 PL/SQL \D568\C218\B97C \D638\CD9C\D558\B294 \C9C8\C758\B97C \C2E4\D589\D558\BA74 \BAA8\B4E0 \C77C\BC18 \C0AC\C6A9\C790\C5D0 \B300\D574 \CE90\C2DC\C5D0 \C800\C7A5\B41C \C9C8\C758 \ACB0\ACFC\AC00 \BC18\D658\B420 \C218 \C788\C2B5\B2C8\B2E4. \C774 \B3D9\C791\C744 \C6D0\CE58 \C54A\C744 \ACBD\C6B0 \D574\B2F9 \B370\C774\D130\BCA0\C774\C2A4 \B9E4\AC1C\BCC0\C218\B97C \BCC0\ACBD\D558\B294 \AC83\C774 \C88B\C2B5\B2C8')
||unistr('\B2E4. \C790\C138\D788 \C54C\C544\BCF4\B824\BA74 <a href="%1" target="_blank" rel="noreferrer">Oracle Database \C124\BA85\C11C</a>\B97C \CC38\C870\D558\C2ED\C2DC\C624.')
,p_version_scn=>2566609
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(121664640240670185)
,p_name=>'P1_RESULT_CACHE_MODE_SHORT'
,p_message_language=>'ko'
,p_message_text=>unistr('\C774 \B370\C774\D130\BCA0\C774\C2A4\C758 <code>result_cache_mode</code> \C124\C815\C740 \C560\D50C\B9AC\CF00\C774\C158 \B3D9\C791\C5D0 \C601\D5A5\C744 \C904 \C218 \C788\C2B5\B2C8\B2E4. <a href="%0" id="result_cache_learn_link">\C790\C138\D788 \C54C\C544\BCF4\AE30</a>')
,p_version_scn=>2566609
);
end;
/
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(1477739433453980.4108)
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1477230449450263.4108)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1889518129864667.4108)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1890025788864657.4108)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1890432358864657.4108)
,p_plugin_id=>wwv_flow_imp.id(1890025788864657.4108)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1890812090864656.4108)
,p_plugin_id=>wwv_flow_imp.id(1890025788864657.4108)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1891258021864656.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1890812090864656.4108)
,p_display_sequence=>10
,p_display_value=>'Redirect to Built-In URL'
,p_return_value=>'BUILTIN_URL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1891717534864656.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1890812090864656.4108)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1892269154864655.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1890812090864656.4108)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1892768324864655.4108)
,p_plugin_id=>wwv_flow_imp.id(1890025788864657.4108)
,p_attribute_scope=>'COMPONENT'
...
,p_display_length=>60
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1890812090864656.4108)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893190016864655.4108)
,p_plugin_id=>wwv_flow_imp.id(1890025788864657.4108)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893593897864655.4108)
,p_plugin_id=>wwv_flow_imp.id(1890025788864657.4108)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1893974205864655.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1893593897864655.4108)
,p_display_sequence=>10
,p_display_value=>'Each Request'
,p_return_value=>'ALWAYS'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1894485900864654.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1893593897864655.4108)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1894912481864654.4108)
,p_plugin_id=>wwv_flow_imp.id(1890025788864657.4108)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1896143759864653.4108)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_version_scn=>2617774
,p_subscribe_plugin_settings=>true
,p_help_text=>unistr('<p>\B85C\ADF8\C778 \D398\C774\C9C0\C5D0\C11C \C2DD\BCC4\B41C LDAP \B514\B809\D1A0\B9AC \C778\C99D\C744 \C704\D55C \C0AC\C6A9\C790 \C774\B984 \BC0F \BE44\BC00\BC88\D638\B97C \C785\B825\D558\C2ED\C2DC\C624. \BE44\BC00\BC88\D638\B294 \B300\C18C\BB38\C790\B97C \AD6C\BD84\D558\C5EC \C785\B825\D558\C2ED\C2DC\C624.</p>')
,p_version_identifier=>'1.0'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1896575338864653.4108)
,p_plugin_id=>wwv_flow_imp.id(1896143759864653.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1896903444864652.4108)
,p_plugin_id=>wwv_flow_imp.id(1896143759864653.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1897383756864652.4108)
,p_plugin_id=>wwv_flow_imp.id(1896143759864653.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1897758536864652.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1897383756864652.4108)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1898207168864652.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1897383756864652.4108)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1898703720864652.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1897383756864652.4108)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1899295016864652.4108)
,p_plugin_id=>wwv_flow_imp.id(1896143759864653.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1899670484864652.4108)
,p_plugin_id=>wwv_flow_imp.id(1896143759864653.4108)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1900044163864652.4108)
,p_plugin_id=>wwv_flow_imp.id(1896143759864653.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1899670484864652.4108)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1900436460864651.4108)
,p_plugin_id=>wwv_flow_imp.id(1896143759864653.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1900854612864651.4108)
,p_plugin_id=>wwv_flow_imp.id(1896143759864653.4108)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1901224819864651.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1900854612864651.4108)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1901709439864651.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1900854612864651.4108)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1902262866864651.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1900854612864651.4108)
,p_display_sequence=>30
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1903249764864650.4108)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1903814493864649.4108)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1904438596864649.4108)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1905420116864648.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1905880543864648.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1905420116864648.4108)
,p_display_sequence=>10
,p_display_value=>'OpenID Connect Provider'
,p_return_value=>'OPENID_CONNECT'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1906315580864648.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1905420116864648.4108)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1906830768864648.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1905420116864648.4108)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1907357037864648.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1905420116864648.4108)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1907814075864647.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1905420116864648.4108)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1908200442864647.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1908608358864647.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1909025339864647.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1909474775864647.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1909874923864647.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1910206099864647.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1910626896864647.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1911053478864646.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1911463347864646.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1911829961864646.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1911463347864646.4108)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1912335157864646.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1911463347864646.4108)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1912891054864646.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1911463347864646.4108)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1913370748864646.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1911463347864646.4108)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1913862346864646.4108)
,p_plugin_id=>wwv_flow_imp.id(1905040324864648.4108)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(2224503320209632.4108)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_plugin_id=>wwv_flow_imp.id(2224503320209632.4108)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1489698288965353.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>10
,p_display_value=>'ADMIN: Ability to manage flow developer privileges'
,p_return_value=>'ADMIN'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1490127846965353.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1490625778965353.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1484681493965355.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1485119212965354.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1485651771965354.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1486104638965354.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1486639045965354.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1487186085965354.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1487604740965354.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1488141603965353.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1488667037965353.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1489141163965353.4108)
,p_plugin_attribute_id=>wwv_flow_imp.id(1484282387965356.4108)
...
,p_step_title=>unistr('\C804\C5ED \D398\C774\C9C0')
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'D'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(390755402636297329.4108)
,p_plug_name=>'APEX 5 - Header'
,p_region_css_classes=>'a-Header apex-home'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(719473716690283992.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(390755785478302692.4108)
,p_plug_name=>'APEX 5 - Header Left'
,p_parent_plug_id=>wwv_flow_imp.id(390755402636297329.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35954042180401544.4108)
,p_plug_name=>'Navigation Tabs Landmark'
,p_parent_plug_id=>wwv_flow_imp.id(390755785478302692.4108)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(719473716690283992.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(389644738049643917.4108)
,p_plug_name=>'APEX 5 - Tabs'
,p_region_name=>'a_Header_menu'
,p_parent_plug_id=>wwv_flow_imp.id(35954042180401544.4108)
...
,p_list_id=>wwv_flow_imp.id(1630037294194189.4108)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(576186007498036655.4108)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(390756182006302692.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(390755978988302692.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(389656483844859551.4108)
,p_plug_name=>'APEX 5 - Header Navigation Links'
,p_parent_plug_id=>wwv_flow_imp.id(390755978988302692.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6251565515611624.4108)
,p_plug_name=>'Extension Menu'
,p_region_name=>'extensionsMenu'
,p_parent_plug_id=>wwv_flow_imp.id(389656483844859551.4108)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(719473716690283992.4108)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(1617849920194181.4108)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(750166499508430361.4108)
,p_translate_title=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(389664299829868619.4108)
...
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(1618455056194184.4108)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(750166499508430361.4108)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(490621346807921535.4108)
...
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(1627426286194188.4108)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(750166499508430361.4108)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(389666198313909817.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2250875259425711.4108)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(389656483844859551.4108)
,p_button_name=>'UPGRADE_AVAILABLE'
,p_button_static_id=>'header-upgradeAvailable'
,p_button_action=>'REDIRECT_APP'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(356399210687168533.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2251294259425712.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2251639324425712.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2252080422425712.4108)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(389656483844859551.4108)
,p_button_name=>'HEADER_EXTENSIONS'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(2582194691768847.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2252406557425712.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2252820641425713.4108)
...
,p_required_patch=>wwv_flow_imp.id(3475503069093017.4108)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2253269813425713.4108)
...
,p_name=>unistr('\D648')
,p_alias=>'HOME'
,p_step_title=>unistr('Oracle APEX \D648')
...
''))
,p_step_template=>wwv_flow_imp.id(389474351319109454.4108)
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>'MUST_NOT_BE_PUBLIC_USER'
,p_help_text=>'start_db_home.htm'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3455065591806801.4108)
...
,p_plug_template=>wwv_flow_imp.id(177327211140356819.4108)
,p_plug_display_sequence=>110
,p_plug_display_point=>'REGION_POSITION_03'
,p_location=>null
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>',
unistr('    \C774 APEX \C778\C2A4\D134\C2A4\B294 Oracle Fusion Applications\C640 \D1B5\D569\B418\C5C8\C2B5\B2C8\B2E4.'),
'</p>',
'<p>',
unistr('    <a href="f?p=4020:3000:&APP_SESSION.:::3000">Fusion \D1B5\D569 \C0DD\C131</a> '),
'</p>'))
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(11180401733396706.4108)
,p_plug_name=>'Hidden'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22820803259610573.4108)
,p_plug_name=>unistr('\CD5C\C0C1\C704 \C571')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22823018909145001.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22826817850343343.4108)
,p_plug_name=>unistr('\AE30\AC04 \C124\C815')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(32806801881614102.4108)
,p_plug_name=>unistr('\C791\C5C5\C601\C5ED &COMPANY.')
...
,p_plug_template=>wwv_flow_imp.id(177327211140356819.4108)
,p_plug_display_sequence=>10
,p_list_id=>wwv_flow_imp.id(2218105708209619.4108)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(483868913244428740.4108)
,p_landmark_type=>'navigation'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(50223690593879168.4108)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>unistr('&PRODUCT_NAME.\C740(\B294) \C5B4\B514\B4E0 \BC30\CE58\D560 \C218 \C788\B294 \C138\ACC4 \C77C\B958\C758 \AE30\B2A5\C744 \D1B5\D574, \C548\C804\D558\ACE0 \D655\C7A5\C131\C744 \AC16\CD98 \C5D4\D130\D504\B77C\C774\C988 \C571\C744 \AD6C\CD95\D558\B3C4\B85D \B3D5\B294 \B85C\C6B0\CF54\B4DC \AC1C\BC1C \D50C\B7AB\D3FC\C785\B2C8\B2E4.')
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows=>15
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74407113994779056.4108)
...
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(689731959698504608.4108)
...
,p_plug_source_type=>'NATIVE_PLSQL'
,p_translate_title=>'N'
,p_landmark_label=>unistr('&PRODUCT_NAME.\C5D0 \B300\D574 \C790\C138\D788 \C54C\C544\BCF4\AE30')
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(389936382386693217.4108)
...
,p_plug_column_width=>'apex-col--leftBorder'
,p_landmark_type=>'region'
,p_landmark_label=>unistr('\AC1C\C694')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'TEXT',
  'show_line_breaks', 'N')).to_clob
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(29174009977064440.4108)
,p_plug_name=>unistr('\C5C5\ADF8\B808\C774\B4DC \BA54\C2DC\C9C0')
,p_parent_plug_id=>wwv_flow_imp.id(389936382386693217.4108)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(41016507787428664.4108)
,p_name=>unistr('\B9AC\C18C\C2A4')
,p_parent_plug_id=>wwv_flow_imp.id(389936382386693217.4108)
,p_template=>wwv_flow_imp.id(177327211140356819.4108)
,p_display_sequence=>80
...
,p_query_row_template=>wwv_flow_imp.id(19962201430770078.4108)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1602494530247513.4108)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1602510280247514.4108)
,p_query_column_id=>2
,p_column_alias=>'TASK_NAME'
,p_column_display_sequence=>20
,p_column_heading=>unistr('\C791\C5C5 \C774\B984')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(54029762205417585.4108)
,p_plug_name=>unistr('\ACB0\ACFC \CE90\C2DC \BAA8\B4DC')
,p_parent_plug_id=>wwv_flow_imp.id(389936382386693217.4108)
...
,p_plug_template=>wwv_flow_imp.id(748940840395094996.4108)
,p_plug_display_sequence=>40
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140996302794317848.4108)
,p_plug_name=>unistr('\C2DC\C2A4\D15C \BA54\C2DC\C9C0')
,p_parent_plug_id=>wwv_flow_imp.id(389936382386693217.4108)
,p_region_css_classes=>'a-Region--simple a-Region--noBottomBorder margin-bottom-md'
,p_region_template_options=>'#DEFAULT#:a-Region--paddedBody'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(494102986912824336.4108)
,p_plug_name=>unistr('\C0AC\C6A9 \AC00\B2A5\D55C \C5C5\B370\C774\D2B8')
,p_parent_plug_id=>wwv_flow_imp.id(389936382386693217.4108)
,p_region_css_classes=>'a-Region--simple a-Region--noBottomBorder margin-bottom-md'
,p_region_template_options=>'#DEFAULT#:a-Region--paddedBody'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(722105589619546488.4108)
...
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_imp.id(45598789574081657.4108)
,p_query_num_rows=>7
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2210959857209596.4108)
,p_query_column_id=>1
,p_column_alias=>'APPLICATIONS'
,p_column_display_sequence=>1
,p_column_heading=>unistr('\C560\D50C\B9AC\CF00\C774\C158')
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2211302214209596.4108)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2211744498209596.4108)
,p_query_column_id=>3
,p_column_alias=>'DEVELOPERS'
,p_column_display_sequence=>14
,p_column_heading=>unistr('\AC1C\BC1C\C790')
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(737233745436378280.4108)
,p_plug_name=>unistr('\C791\C5C5\C601\C5ED \BA54\C2DC\C9C0')
,p_parent_plug_id=>wwv_flow_imp.id(389936382386693217.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(426859213848767635.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(448938046502410974.4108)
,p_plug_name=>unistr('\C790\C138\D788')
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(177327211140356819.4108)
,p_plug_display_sequence=>120
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(2220705999209625.4108)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(62797997509026315.4108)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(448938094568410975.4108)
,p_plug_name=>unistr('\C18C\C15C')
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_plug_template=>wwv_flow_imp.id(177327211140356819.4108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(490537026777036356.4108)
,p_plug_name=>unistr('\ACB0\ACFC \CE90\C2DC')
,p_region_template_options=>'js-draggable:js-modal:js-dialog-size480x320:h240'
,p_plug_template=>wwv_flow_imp.id(431176191030605311.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2212522592209597.4108)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(737233745436378280.4108)
,p_button_name=>'UPDATE_WS_MESSAGE'
,p_button_action=>'REDIRECT_APP'
,p_button_template_options=>'#DEFAULT#:a-Button--regionHeader'
,p_button_template_id=>wwv_flow_imp.id(356399210687168533.4108)
,p_button_image_alt=>unistr('\C791\C5C5\C601\C5ED \BA54\C2DC\C9C0 \C815\C758')
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2206380726209588.4108)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(74407113994779056.4108)
,p_button_name=>'GET_STARTED'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:a-Button--strongLabel'
,p_button_template_id=>wwv_flow_imp.id(177329393740370707.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2210141297209595.4108)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(494102986912824336.4108)
,p_button_name=>'SET_PREFERENCES_UPDATES'
,p_button_action=>'REDIRECT_APP'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(356399210687168533.4108)
,p_button_image_alt=>unistr('\C0AC\C6A9 \AC00\B2A5\D55C \C5C5\B370\C774\D2B8\C5D0 \B300\D55C \D658\ACBD\C124\C815 \C124\C815')
,p_button_position=>'NEXT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2217850974209616.4108)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24891665126836406.4108)
,p_name=>'P1_WARNING'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(32806801881614102.4108)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29620081536758893.4108)
,p_name=>'P1_DAYS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(32806801881614102.4108)
,p_item_default=>'7'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29620958483913064.4108)
,p_name=>'P1_ACTIVITY'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(32806801881614102.4108)
,p_item_default=>'V'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(32776391273114716.4108)
,p_name=>'P1_TIMEFRAME'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(11180401733396706.4108)
,p_item_default=>'3600'
,p_display_as=>'NATIVE_HIDDEN'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('\C774 \D398\C774\C9C0\C5D0 \D45C\C2DC\B41C \BAA8\B2C8\D130 \C9C8\C758\B97C \C81C\C57D\D560 \C2DC\AC04\BC94\C704\B97C \C124\C815\D569\B2C8\B2E4.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(54038373733417627.4108)
,p_name=>'P1_RESULT_CACHE_MODE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(54029762205417585.4108)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(281312126583015690.4108)
,p_name=>'P1_GET_STARTED_URL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(74407113994779056.4108)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(2214080637209612.4108)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(2214458992209612.4108)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2215545708209613.4108)
,p_name=>'Updates - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2210141297209595.4108)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2216027220209615.4108)
,p_event_id=>wwv_flow_imp.id(2215545708209613.4108)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(494102986912824336.4108)
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2216453649209615.4108)
,p_name=>'News - Dialog Closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(389936382386693217.4108)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2216820694209615.4108)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2217388776209616.4108)
,p_event_id=>wwv_flow_imp.id(2216820694209615.4108)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'Open Region'
...
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(490537026777036356.4108)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2215185492209612.4108)
...
,p_internal_uid=>2215185492209612.4108
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>3.4108
,p_name=>unistr('\D648 \D398\C774\C9C0 \BCF4\ACE0 \AE30\AC04')
,p_alias=>'HOME-PAGE-REPORTING-TIMEFRAME'
,p_page_mode=>'MODAL'
,p_step_title=>unistr('\D648 \D398\C774\C9C0 \BCF4\ACE0 \AE30\AC04')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(691639526441810142.4108)
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(206673210832101485.4108)
,p_plug_name=>unistr('\D648 \D398\C774\C9C0 \BCF4\ACE0 \AE30\AC04')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(719473716690283992.4108)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(283304705083615747.4108)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(689731959698504608.4108)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3009307345088951.4108)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(283304705083615747.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3009769630088952.4108)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(283304705083615747.4108)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3011713789088961.4108)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(206674939772160695.4108)
,p_name=>'P3_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(206673210832101485.4108)
...
,p_cHeight=>1
,p_grid_column=>3
,p_field_template=>wwv_flow_imp.id(490022788869589047.4108)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>unistr('\D648 \D398\C774\C9C0\C5D0 \C791\C5C5 \BCF4\ACE0\C11C\B97C \C81C\D55C\D560 \AE30\AC04\C744 \C124\C815\D569\B2C8\B2E4.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3010782007088959.4108)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3009769630088952.4108)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3011282070088960.4108)
,p_event_id=>wwv_flow_imp.id(3010782007088959.4108)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3010326903088959.4108)
...
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(3009307345088951.4108)
,p_internal_uid=>3010326903088959.4108
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>4.4108
,p_name=>unistr('\C0AC\C6A9 \AC00\B2A5\D55C \C5C5\B370\C774\D2B8 \D655\C778')
,p_alias=>'CHECK-FOR-AVAILABLE-UPDATES'
,p_page_mode=>'MODAL'
,p_step_title=>unistr('\C0AC\C6A9 \AC00\B2A5\D55C \C5C5\B370\C774\D2B8 \D655\C778')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(123406906725078162.4108)
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_imp.id(2611096505029836)
,p_dialog_height=>'240'
,p_dialog_width=>'600'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(495602372147457383.4108)
,p_plug_name=>unistr('\C0AC\C6A9 \AC00\B2A5\D55C \C5C5\B370\C774\D2B8 \D655\C778')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(705356091066836147.4108)
,p_plug_display_sequence=>20
,p_plug_item_display_point=>'BELOW'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows=>15
...
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>unistr('<p>\C774 \D398\C774\C9C0\B294 \C9C8\C758\B418\C5B4 Oracle Corporation\C5D0 \AC8C\C2DC\B418\B294 \C815\BCF4\B97C \C81C\C5B4\D569\B2C8\B2E4.</p>')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(496017867699817006.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3018054203596095.4108)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(496017867699817006.4108)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(177329393740370707.4108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3018423755596095.4108)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(496017867699817006.4108)
,p_button_name=>'APPLY_CHANGES'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(495612249832520242.4108)
,p_name=>'P4_SHOW_UPDATES'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(495602372147457383.4108)
,p_use_cache_before_default=>'NO'
,p_item_default=>'Y'
,p_prompt=>unistr('\C0AC\C6A9 \AC00\B2A5\D55C \C5C5\B370\C774\D2B8 \D655\C778')
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>\C774 \C18D\C131\C740 &PRODUCT_NAME. \BC0F Oracle REST Data Services\C5D0 \B300\D574 \C5C5\B370\C774\D2B8 \C0AC\C6A9 \AC00\B2A5 \C5EC\BD80\B97C &PRODUCT_NAME.\C774(\AC00) \D655\C778\D560 \C218 \C788\B294\C9C0 \C5EC\BD80\B97C \C81C\C5B4\D569\B2C8\B2E4.</p>'),
'',
unistr('<p>\CC38\ACE0: \C774 \AC80\C0AC\B97C \C218\D589\D558\AE30 \C704\D574 &PRODUCT_NAME.\C740(\B294) &PRODUCT_NAME. \BC0F \B2E4\B978 \C2DC\C2A4\D15C \AD6C\C131\C694\C18C\C758 \BC84\C804 \BC88\D638\B97C Oracle Corporation\C5D0 \C804\C1A1\D569\B2C8\B2E4. \C9C0\C18D\C801\C778 \C81C\D488 \D5A5\C0C1\C744 \C704\D574 Oracle\C740 \C81C\D488 \C0AC\C6A9 \AD00\B828 \C815\BCF4\B97C \C218\C9D1\D558\ACE0 \C788\C2B5\B2C8\B2E4. \C774\B7EC\D55C \BAA9\C801\C744 \C704\D574 \C0AC\C6A9 \C911\C778 \C81C\D488 \AE30\B2A5\C5D0 \B300\D55C \D1B5\ACC4 \C815\BCF4\AC00 \ACBD\C6B0\C5D0 \B530\B77C Oracle\C5D0 \C804\C1A1\B420 \C218 \C788\C2B5\B2C8\B2E4. \AC1C\C778 \C2DD\BCC4\C774 \AC00\B2A5\D55C \C815\BCF4\B294 \C804\C1A1\B418\C9C0 \C54A\C2B5\B2C8\B2E4. <a rel="noop')
||unistr('ener noreferrer" href="https://www.oracle.com/privacy">\C624\B77C\D074 \AC1C\C778\C815\BCF4 \BCF4\D638\C815\CC45</a>\C744 \CC38\C870\D558\C2ED\C2DC\C624.'),
'</p>'))
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3025282235596115.4108)
,p_name=>'Cancel Dialog'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3018054203596095.4108)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3025798892596115.4108)
,p_event_id=>wwv_flow_imp.id(3025282235596115.4108)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3023052304596112.4108)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
...
,p_process_when_button_id=>wwv_flow_imp.id(3018423755596095.4108)
,p_internal_uid=>3023052304596112.4108
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3023445334596112.4108)
...
,p_process_when_button_id=>wwv_flow_imp.id(3018423755596095.4108)
,p_internal_uid=>3023445334596112.4108
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>5.4108
,p_name=>unistr('\D648\C73C\B85C \C774\B3D9')
,p_alias=>'GO-HOME'
,p_step_title=>unistr('\D648\C73C\B85C \C774\B3D9')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1801951393082309.4108)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
