...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A122400878216686345')
...
,p_authentication_id=>wwv_flow_imp.id(655487206132077960.4158)
,p_populate_roles=>'A'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(214728703440958.4158)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(729705784761864.4158)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>16254507
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(729973388438584.4158)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(738148027200247.4158)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>243431110
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2658383525125448.4158)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(14858802044941038.4158)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(99844666838888905.4158)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(118480913244833028.4158)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(123213782349478467.4158)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(124389475140989299.4158)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37165931336889
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(176128720275506818.4158)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1765072259284712054.4158)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1831780000720994153.4158)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1917632860486939887.4158)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(2001350114556715.4158)
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(26310914319937994.4158)
...
wwv_flow_imp_shared.create_tab(
 p_id=>wwv_flow_imp.id(519013824056522.4158)
,p_tab_set=>'One'
,p_tab_sequence=>1
,p_tab_name=>'T_PAGE_1'
,p_tab_text=>'Seite&nbsp;1'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(519104518056523.4158)
,p_tab_set=>'main'
,p_tab_sequence=>1
,p_tab_name=>'One'
,p_tab_text=>'Eins'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(519229449056523.4158)
,p_tab_set=>'main'
,p_tab_sequence=>2
,p_tab_name=>'Two'
,p_tab_text=>'Zwei'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(519313755056523.4158)
,p_tab_set=>'main'
,p_tab_sequence=>3
,p_tab_name=>'Three'
,p_tab_text=>'Drei'
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(519415313056523.4158)
,p_tab_set=>'main'
,p_tab_sequence=>4
,p_tab_name=>'Four'
,p_tab_text=>'Vier'
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(24029824597247454.4158)
,p_theme_id=>101
,p_name=>'[x] Popup.de'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72728360925039215.4158)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454.4158)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72728876711039216.4158)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454.4158)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72729330291039216.4158)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454.4158)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72729853624039217.4158)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454.4158)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72730323826039217.4158)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454.4158)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72730870062039218.4158)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454.4158)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72731313676039218.4158)
,p_page_template_id=>wwv_flow_imp.id(24029824597247454.4158)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1146777630795684705.4158)
,p_theme_id=>101
,p_name=>'Init 101 - Wizard Page.de'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140000736737349573.4158)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705.4158)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140000865476349569.4158)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705.4158)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140000946667349569.4158)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705.4158)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140001066237349569.4158)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705.4158)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140001170251349569.4158)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705.4158)
,p_name=>'Page Position 4'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140001263551349569.4158)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705.4158)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140001364638349569.4158)
,p_page_template_id=>wwv_flow_imp.id(1146777630795684705.4158)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(3791751542872.4158)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(297140727685898042.4158)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(1146918375616882531.4158)
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(517201101056507.4158)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2215041129476413.4158)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507.4158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2215527167476413.4158)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507.4158)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2216042234476413.4158)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507.4158)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2216504575476413.4158)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507.4158)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2217084962476413.4158)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507.4158)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2217506554476414.4158)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507.4158)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2218055132476414.4158)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507.4158)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2218552890476414.4158)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507.4158)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2219033408476414.4158)
,p_plug_template_id=>wwv_flow_imp.id(517201101056507.4158)
,p_name=>'Sub Regions'
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1740330628446135.4158)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1740827628446136.4158)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1741391521446136.4158)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1741895363446136.4158)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1742395931446136.4158)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1742896231446136.4158)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1743362700446136.4158)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1743898517446136.4158)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1744376232446136.4158)
,p_plug_template_id=>wwv_flow_imp.id(498992332002296754.4158)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146723779286487855.4158)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2536211860486609.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855.4158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2536743325486610.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855.4158)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2537292037486610.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855.4158)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2537709426486610.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855.4158)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2538299282486610.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855.4158)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2538786661486610.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146723779286487855.4158)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2217162739232335.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2217682972232335.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2218186498232335.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2218624330232335.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2219115152232335.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2219697118232335.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2220127729232336.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2220668832232336.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2221156155232336.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2980501821500941.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2981059332500941.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2981517806500941.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2982076945500941.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2982580614500941.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2983067930500942.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2983505583500942.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2984018080500942.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2984545795500942.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2985064312500942.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2985552919500942.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2986080343500942.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2986567494500943.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146833868130703375.4158)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88181214486816922.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146833868130703375.4158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88181795297816922.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146833868130703375.4158)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146834495802703415.4158)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3348953398508588.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146834495802703415.4158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3349463369508589.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146834495802703415.4158)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1146873381156733851.4158)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3375472609510517.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146873381156733851.4158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3375920234510517.4158)
,p_plug_template_id=>wwv_flow_imp.id(1146873381156733851.4158)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3218497363505982.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3218920376505982.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3219452134505982.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3219932417505982.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3220401325505982.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3220999613505982.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3221415442505982.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3221997967505983.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3222426479505983.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3222900779505983.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3223423656505983.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3223959907505983.4158)
,p_plug_template_id=>wwv_flow_imp.id(1147008167971256777.4158)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(517018400056507.4158)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(107535106471295136.4158)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(1146837484282708152.4158)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(1146837615734708160.4158)
...
wwv_flow_imp_shared.create_popup_lov_template(
 p_id=>wwv_flow_imp.id(518927322056521.4158)
,p_page_name=>'winlov'
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(204026132314798041.4158)
,p_theme_id=>101
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146724143104487863.4158)
,p_theme_id=>101
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146724462659487863.4158)
,p_theme_id=>101
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146754092014658878.4158)
,p_theme_id=>101
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146754358989658879.4158)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146754729789658879.4158)
,p_theme_id=>101
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146758446175658891.4158)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1146759398601658893.4158)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146725670811487866.4158)
,p_theme_id=>101
,p_name=>'USE_COLORED_BACKGROUND'
,p_display_name=>'Use Colored Background'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(1146723779286487855.4158)
,p_css_classes=>'a-Alert--colorBG'
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146725750422487866.4158)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146725914274487866.4158)
,p_theme_id=>101
,p_name=>'WARNING'
...
,p_group_id=>wwv_flow_imp.id(1146724143104487863.4158)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726163815487867.4158)
,p_theme_id=>101
,p_name=>'ERROR'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726316311487867.4158)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726506076487867.4158)
,p_theme_id=>101
,p_name=>'HORIZONTAL'
...
,p_group_id=>wwv_flow_imp.id(1146724462659487863.4158)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726718245487867.4158)
,p_theme_id=>101
,p_name=>'WIZARD'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146726819613487867.4158)
,p_theme_id=>101
,p_name=>'REMOVE_ICON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146727036922487867.4158)
,p_theme_id=>101
,p_name=>'SUCCESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146755698969658883.4158)
,p_theme_id=>101
,p_name=>'REGIONCONTAINSITEMSTEXT'
,p_display_name=>'Region Contains Items / Text'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(1146753630500658875.4158)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146755801158658885.4158)
,p_theme_id=>101
...
,p_group_id=>wwv_flow_imp.id(1146754729789658879.4158)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756082978658885.4158)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756265184658888.4158)
,p_theme_id=>101
,p_name=>'SLIMPADDING'
...
,p_group_id=>wwv_flow_imp.id(1146754358989658879.4158)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756454000658889.4158)
,p_theme_id=>101
,p_name=>'NOPADDING'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756528427658889.4158)
,p_theme_id=>101
,p_name=>'WIZARDDIALOG'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756794417658889.4158)
,p_theme_id=>101
,p_name=>'VISIBLE'
...
,p_group_id=>wwv_flow_imp.id(1146754092014658878.4158)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1146756999993658889.4158)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554803565325408341.4158)
,p_theme_id=>101
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(1146757828351658890.4158)
,p_css_classes=>'a-Region--hideHeader'
,p_group_id=>wwv_flow_imp.id(1146754092014658878.4158)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554803717040408342.4158)
,p_theme_id=>101
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554803989855408342.4158)
,p_theme_id=>101
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804189766408342.4158)
,p_theme_id=>101
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804330090408342.4158)
,p_theme_id=>101
,p_name=>'SIDEBAR'
...
,p_group_id=>wwv_flow_imp.id(1146759398601658893.4158)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804537318408342.4158)
,p_theme_id=>101
,p_name=>'BORDERLESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804780569408343.4158)
,p_theme_id=>101
...
,p_group_id=>wwv_flow_imp.id(1146758446175658891.4158)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554804971600408343.4158)
,p_theme_id=>101
,p_name=>'AUTOSCROLL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554805190489408343.4158)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554805239267408343.4158)
,p_theme_id=>101
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554805471106408343.4158)
,p_theme_id=>101
,p_name=>'SIMPLE'
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(655487206132077960.4158)
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1025089530051554947.4158)
...
,p_step_template=>wwv_flow_imp.id(1146777630795684705.4158)
,p_page_template_options=>'#DEFAULT#'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7642519848874484.4158)
...
,p_plug_template=>wwv_flow_imp.id(1146723779286487855.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8191525547492034.4158)
,p_plug_name=>'reset'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8191706236492034.4158)
,p_plug_name=>unistr('Kennwort \00E4ndern - Hauptteil')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146834495802703415.4158)
,p_plug_display_sequence=>20
,p_plug_new_grid_row=>false
,p_plug_display_column=>1
,p_plug_query_row_template=>wwv_flow_imp.id(1939532588110833.4158)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(923579772962744043.4158)
,p_plug_name=>unistr('Kennwort \00E4ndern')
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146873381156733851.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(923580432969744050.4158)
,p_plug_name=>unistr('Kennwort \00E4ndern - Schaltfl\00E4chen')
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146753630500658875.4158)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1146875645787737806.4158)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(923580432969744050.4158)
,p_button_name=>'Save'
,p_button_static_id=>'Save'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(1146918375616882531.4158)
,p_button_is_hot=>'Y'
,p_button_image_alt=>unistr('\00C4nderungen anwenden')
,p_button_position=>'NEXT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8192329780492035.4158)
,p_name=>'P50_USER_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8191706236492034.4158)
,p_prompt=>'Benutzername'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_imp.id(1146837615734708160.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8192820569492035.4158)
,p_name=>'P50_PASSWORD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8191706236492034.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8193305833492036.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8193806723492036.4158)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(12378622409765411.4158)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8194403614492037.4158)
...
,p_associated_item=>wwv_flow_imp.id(8193806723492036.4158)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8194629425492037.4158)
,p_validation_name=>'P50_PASSWORD Not Null'
,p_validation_sequence=>1
,p_validation=>'P50_PASSWORD'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Das Kennwort muss angegeben werden.'
,p_associated_item=>wwv_flow_imp.id(8192820569492035.4158)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 07-AUG-2002 16:59'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8194822652492037.4158)
...
,p_associated_item=>wwv_flow_imp.id(8193305833492036.4158)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 07-AUG-2002 16:59'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8195026061492037.4158)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8195417294492037.4158)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(25690303485866343.4158)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8195726390492038.4158)
...
,p_internal_uid=>8195726390492038.4158
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(12382112282781418.4158)
...
'end if;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>12382112282781418.4158
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498926816038101235.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498929027949101251.4158)
,p_plug_name=>'Do Not Purge Workspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146834495802703415.4158)
,p_plug_display_sequence=>30
,p_plug_source=>unistr('<p>Durch Klicken auf <b>Workspace nicht bereinigen</b> geben Sie an, dass der Workspace &P99_WORKSPACE_NAME. nicht gel\00F6scht werden soll. <b>Sie m\00FCssen diese Aktion durchf\00FChren, um zu verhindern, dass Workspace &P99_WORKSPACE_NAME. gel\00F6scht wird.</str')
||'ong></p>'
,p_translate_title=>'N'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498929409062101254.4158)
...
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>&P99_LAST_UPDATED_BY., ein Workspace-Administrator des Workspace &P99_WORKSPACE_NAME., hat bereits vorgegeben, dass dieser Workspace nicht gel\00F6scht werden soll. Dies wurde von &P99_LAST_UPDATED_BY. am &P99_LAST_UPDATED. aktualisiert.</p>'),
'',
unistr('<p>Wenn Sie diesen Workspace nicht mehr ben\00F6tigen, klicken Sie auf <b>Ich habe meine Meinung ge\00E4ndert - bitte Workspace doch bereinigen</b>. Der Workspace wird dann automatisch am oder nach dem <span class="u-danger-text"><strong>&P99_DATE_TO_BE_PURG')
||unistr('ED.</strong></span> gel\00F6scht.</p>')))
,p_translate_title=>'N'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
,p_plug_display_condition_type=>'EXPRESSION'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498929808292101255.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498930028451101256.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(498930208776101256.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878093898737830.4158)
...
,p_plug_display_sequence=>20
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>unistr('<p>Der inaktive Workspace &P99_WORKSPACE_NAME. wird gem\00E4\00DF Ausf\00FChrungsplan am &P99_DATE_TO_BE_PURGED. gel\00F6scht.</p>')
,p_translate_title=>'N'
,p_plug_display_condition_type=>'EXPRESSION'
,p_plug_display_when_condition=>':P99_SGID is not null and :P99_RID is not null and :P99_EID is not null and :P99_DATE_PURGED is null'
,p_plug_display_when_cond2=>'PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878195005737831.4158)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>Workspace <strong>&P99_WORKSPACE_NAME.</strong> wurde am <strong>&P99_DATE_PURGED.</strong> gel\00F6scht.</p>'),
'<p>Vielen Dank, dass Sie &PRODUCT_NAME. auf &P99_APEX_URL. verwendet haben.</p>'))
,p_translate_title=>'N'
,p_plug_display_condition_type=>'EXPRESSION'
,p_plug_display_when_condition=>':P99_SGID is not null and :P99_RID is not null and :P99_EID is not null and :P99_DATE_PURGED is not null'
,p_plug_display_when_cond2=>'PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878222526737832.4158)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(498929226472101252.4158)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1146878222526737832.4158)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(498929614547101255.4158)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(498931017585101269.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927015083101242.4158)
,p_name=>'P99_EID'
,p_item_sequence=>25
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927201924101248.4158)
...
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_imp.id(1146837484282708152.4158)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927400231101248.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927620508101249.4158)
,p_name=>'P99_SGID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235.4158)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498927813465101249.4158)
,p_name=>'P99_RID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235.4158)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928004161101250.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928221678101250.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928405763101250.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928608702101251.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(498928817636101251.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(502441507830936748.4158)
,p_name=>'P99_APEX_URL'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(498926816038101235.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(504639132530012441.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(504753932501485476.4158)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(498930401204101258.4158)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'commit;'))
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(498929226472101252.4158)
,p_process_success_message=>'Workspace &P99_WORKSPACE_NAME. wird nicht bereinigt. Vielen Dank.'
,p_internal_uid=>498930401204101258.4158
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(498930608172101261.4158)
...
'commit;'))
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(498929614547101255.4158)
,p_process_success_message=>'Workspace &P99_WORKSPACE_NAME. wird am oder nach dem &P99_DATE_TO_BE_PURGED. bereinigt. Vielen Dank.'
,p_internal_uid=>498930608172101261.4158
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(498930813327101266.4158)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
,p_internal_uid=>498930813327101266.4158
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>200.4158
,p_name=>unistr('Subscription interaktiver Berichte k\00FCndigen')
,p_alias=>'UNSUBSCRIBE-INTERACTIVE-REPORT-SUBSCRIPTION'
,p_step_title=>unistr('Subscription interaktiver Berichte k\00FCndigen')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(1146777630795684705.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23238304177115429.4158)
...
,p_plug_display_column=>1
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>unistr('Sie haben den unten stehenden Bericht derzeit als <strong>&P200_EMAIL.</strong> abonniert. Wenn Sie keine weiteren E-Mails unter der E-Mail-Adresse erhalten m\00F6chten, klicken Sie unten auf <strong>Subscription aufheben</strong>:')
,p_translate_title=>'N'
,p_plug_display_condition_type=>'EXPRESSION'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24076722086058097.4158)
,p_plug_name=>'Vielen Dank. - Subscription aufgehoben'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Vielen Dank. Die Subscription der Berichts-E-Mails wurde nun aufgehoben.  '
,p_plug_display_condition_type=>'EXPRESSION'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24076913092131160.4158)
,p_plug_name=>unistr('Ung\00FCltige Anforderung')
,p_region_template_options=>'#DEFAULT#:a-Alert--warning:a-Alert--wizard'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146723779286487855.4158)
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_plug_source=>unistr('Mit dieser Anwendung wird die Subscription von Berichten gek\00FCndigt. Sie haben diese Seite mit einer ung\00FCltigen URL aufgerufen.')
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24078523883238409.4158)
,p_plug_name=>'Report'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>20
,p_plug_new_grid_row=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878390734737833.4158)
,p_plug_name=>'Subscription aufheben'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146873381156733851.4158)
,p_plug_display_sequence=>30
,p_plug_new_grid_row=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146878524267737835.4158)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146753630500658875.4158)
,p_plug_display_sequence=>50
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(23241020416235620.4158)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1146878524267737835.4158)
,p_button_name=>'UNSUBSCRIBE'
,p_button_action=>'SUBMIT'
,p_button_template_id=>wwv_flow_imp.id(1146918375616882531.4158)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Subscription aufheben'
,p_button_position=>'NEXT'
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(24075027356965025.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23239325947161488.4158)
,p_name=>'P200_EMAIL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409.4158)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23240324656217886.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23240509896223103.4158)
,p_name=>'P200_PAGE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409.4158)
,p_prompt=>'Seite:'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23240719592225871.4158)
,p_name=>'P200_REPORT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409.4158)
,p_prompt=>'Bericht:'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23240927557228254.4158)
,p_name=>'P200_ID'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409.4158)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23241516784272398.4158)
,p_name=>'P200_SGID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409.4158)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24080425624314564.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24084004265516600.4158)
,p_name=>'P200_RID'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(24078523883238409.4158)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(24070713831809643.4158)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(23241020416235620.4158)
,p_process_success_message=>'Subscription aufgehoben. Vielen Dank.'
,p_internal_uid=>24070713831809643.4158
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(24059901749058684.4158)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>unistr('Ung\00FCltige Subscription- und Anforderungs-ID.')
,p_internal_uid=>24059901749058684.4158
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1402815470381580.4158)
,p_plug_name=>'Tips'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146834495802703415.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(57075215208721471.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(643964332163437775.4158)
,p_plug_name=>'Help'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1146834495802703415.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146876836521737818.4158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1146877779285737827.4158)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(57079816296853917.4158)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1146876836521737818.4158)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(34456324362177919.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(476622691412236.4158)
,p_name=>'F4155_P1000_USERNAME'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(57075215208721471.4158)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Benutzername'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(477505160416649.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(485932199001641.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1441703804737288.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(643811309110241934.4158)
,p_name=>'F4155_PLUGIN_HELP_TEXT'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(1402815470381580.4158)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(643833917075244221.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(643856524001246239.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(644127827193502573.4158)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1146877882588737828.4158)
,p_name=>'F4155_P1000_APP_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1146877779285737827.4158)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(57188216053643298.4158)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(475708492408121.4158)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>475708492408121.4158
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643777621100235936.4158)
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>643777621100235936.4158
);
end;
/
