...
prompt APPLICATION 4753 - Oracle APEX Productivity and Sample Applications
--
-- Application Export:
--   Application:     4753
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A125200297744700064')
...
,p_authentication_id=>wwv_flow_imp.id(539943211297143567.4753)
,p_populate_roles=>'A'
...
,p_substitution_value_10=>'Fertig'
,p_substitution_string_11=>'TOP'
,p_substitution_value_11=>'Oben'
,p_substitution_string_12=>'CLOSE'
,p_substitution_value_12=>unistr('Schlie\00DFen')
,p_substitution_string_13=>'CONFIRM'
,p_substitution_value_13=>unistr('Best\00E4tigen')
...
,p_substitution_value_18=>unistr('Zur\00FCck zu Anwendung')
,p_substitution_string_19=>'DELETE_MSG'
,p_substitution_value_19=>unistr('Soll dieser L\00F6schvorgang ausgef\00FChrt werden?')
,p_substitution_string_20=>'PAGE'
,p_substitution_value_20=>'Seite'
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(4800278867383473.4753)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(563238341577468350.4753)
,p_name=>'Gallery Get Started List'
,p_list_status=>'PUBLIC'
,p_version_scn=>75558046
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(580144763635932270.4753)
,p_list_item_display_sequence=>1
,p_list_item_link_text=>'Beispiele'
,p_list_item_link_target=>'https://apex.oracle.com/go/#APEX_BASE_VERSION#/samples'
,p_list_item_icon=>'gi-icon-gallery-samples'
,p_list_text_01=>unistr('Diese Apps sollen bestimmte Funktionen demonstrieren und dienen als Anleitung f\00FCr Entwickler, wie ein bestimmtes Feature verwendet wird.')
,p_list_text_03=>'rel="noopener noreferrer" target="_blank"'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(580145100987932275.4753)
...
,p_list_text_01=>unistr('Mit Plug-ins k\00F6nnen Sie die Funktionen von APEX erweitern und Ihren Apps ganz einfach neue Funktionen hinzuf\00FCgen.')
,p_list_text_03=>'rel="noopener noreferrer" target="_blank"'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(563238596465468352.4753)
,p_list_item_display_sequence=>3
,p_list_item_link_text=>'Apps'
,p_list_item_link_target=>'https://apex.oracle.com/go/#APEX_BASE_VERSION#/apps'
,p_list_item_icon=>'gi-icon-gallery-apps'
,p_list_text_01=>unistr('Diese Apps sind voll funktionsf\00E4hig und sollen als eigenst\00E4ndige Punktl\00F6sungen dienen, die einfache Anforderungen erf\00FCllen. Sie k\00F6nnen diese Apps unver\00E4ndert verwenden oder an Ihre Anforderungen anpassen.')
,p_list_text_03=>'rel="noopener noreferrer" target="_blank"'
,p_translate_list_text_y_n=>'Y'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(697584654501422607.4753)
,p_name=>'APEX 5 - Administration (Header)'
,p_list_status=>'PUBLIC'
,p_version_scn=>75558046
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697584848032422609.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697585197430422609.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697585449821422609.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697585763975422610.4753)
,p_list_item_display_sequence=>80
,p_list_item_link_text=>'Service verwalten'
,p_list_item_link_target=>'f?p=4350:21:&SESSION.'
,p_parent_list_item_id=>wwv_flow_imp.id(697585449821422609.4753)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697586015426422610.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697586354477422610.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(190382223832948637.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697586992140422611.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(190383564554937398.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(190383875470934120.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3800699627422285.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(195363471390772712.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697587582961422612.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697588196393422612.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1250834841571213656.4753)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(697615600061428203.4753)
,p_name=>'APEX 5 - Help'
,p_list_status=>'PUBLIC'
,p_version_scn=>75558048
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697615898751428203.4753)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2105955959214049535.4753)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2185501568508575816.4753)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697616716682428203.4753)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'---'
,p_list_item_link_target=>'separator'
,p_list_item_current_type=>'TARGET_PAGE'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(697617094963428203.4753)
,p_list_item_display_sequence=>60
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(719097510387175373.4753)
,p_name=>'APEX Shared Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>117449631
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2240217097227497.4753)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2240624309227497.4753)
,p_list_item_display_sequence=>50
...
,p_parent_list_item_id=>wwv_flow_imp.id(2240217097227497.4753)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2241046878227497.4753)
,p_list_item_display_sequence=>60
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2241438166227497.4753)
,p_list_item_display_sequence=>70
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2241824867227497.4753)
,p_list_item_display_sequence=>80
,p_list_item_link_text=>'-----'
,p_list_item_link_target=>'separator'
,p_parent_list_item_id=>wwv_flow_imp.id(2240217097227497.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2242224741227498.4753)
,p_list_item_display_sequence=>90
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2242614934227498.4753)
,p_list_item_display_sequence=>100
,p_list_item_link_text=>'Alle Workspace-Utilitys'
,p_list_item_link_target=>'f?p=4000:182:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_imp.id(2242224741227498.4753)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2243080963227498.4753)
,p_list_item_display_sequence=>110
,p_list_item_link_text=>'-----'
,p_list_item_link_target=>'separator'
,p_parent_list_item_id=>wwv_flow_imp.id(2242224741227498.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2243433502227498.4753)
,p_list_item_display_sequence=>120
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2243808115227498.4753)
,p_list_item_display_sequence=>130
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2244207637227498.4753)
,p_list_item_display_sequence=>140
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2244682780227498.4753)
,p_list_item_display_sequence=>150
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2245097830227498.4753)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2245442386227498.4753)
,p_list_item_display_sequence=>160
,p_list_item_link_text=>'Objektbrowser'
,p_list_item_link_target=>'f?p=4500:2000:&SESSION.'
,p_parent_list_item_id=>wwv_flow_imp.id(2245097830227498.4753)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2245886427227499.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2246218822227499.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2246624592227499.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2247050116227499.4753)
,p_list_item_display_sequence=>220
,p_list_item_link_text=>'Alle Utilitys'
,p_list_item_link_target=>'f?p=4500:1005:&SESSION.'
,p_parent_list_item_id=>wwv_flow_imp.id(2246624592227499.4753)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2247447182227499.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2247895401227499.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2248258943227499.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2248628873227499.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2249078073227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2249425180227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2249823391227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2250219778227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2250623393227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2251054890227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2251415174227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2251818081227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2252294768227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2252678260227500.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2253018793227501.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2253435765227501.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2253889841227501.4753)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2254227290227501.4753)
,p_list_item_display_sequence=>370
,p_list_item_link_text=>'Labels'
,p_list_item_link_target=>'f?p=4600:300:&SESSION.::&DEBUG.:RP:::'
,p_parent_list_item_id=>wwv_flow_imp.id(2253889841227501.4753)
,p_security_scheme=>wwv_flow_imp.id(750863634498892275)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2254628052227501.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2255091762227501.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2255446777227501.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2255809287227501.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2256201609227502.4753)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2256648891227502.4753)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(798354195880640621.4753)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(798364561880730346.4753)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(802137241064353033.4753)
,p_name=>'users and groups APEX 5.0'
,p_list_status=>'PUBLIC'
,p_version_scn=>75558048
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(802137757188353046.4753)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Gruppen'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(802138028621353046.4753)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Gruppenzuweisungen'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(805116320497552727.4753)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(805118624066572072.4753)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(805137189383669602.4753)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(808592810483273051.4753)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(808614585475666760.4753)
,p_name=>'admin_tasks'
,p_list_status=>'PUBLIC'
,p_version_scn=>75558048
);
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(928563942467078.4753)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1300167560451479.4753)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1306207112778621.4753)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>16259698
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1330694894185392.4753)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>243439673
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3219139608137369.4753)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(99845125616888905.4753)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(118481594111833028.4753)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(123214308339478467.4753)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(124390088921989299.4753)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37165931336889
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(176129341884506820.4753)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(539923825535132353.4753)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1765073051796712055.4753)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1831780486249994155.4753)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1917695181258940200.4753)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2010925785324119040.4753)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(1756663806012965.4753)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(4800798041174947.4753)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(11405370394704937.4753)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(404682514053862570.4753)
,p_name=>'Flow: ADMIN'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(404690492509862587.4753)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(404692541807863512.4753)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(404693461378863512.4753)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(404702144894863525.4753)
,p_name=>'Flow: RESTFUL'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(517057690758689585.4753)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(746087390984722118.4753)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(750863634498892275.4753)
,p_name=>'Flow: EDIT'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'EDIT'
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(805137509572669602.4753)
...
,p_error_message=>'Die Entwicklungsumgebung verwendet die externe Authentifizierung'
,p_version_scn=>2599878
,p_caching=>'BY_USER_BY_SESSION'
);
end;
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(805427695742857816.4753)
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(539940611479132428.4753)
,p_icon_sequence=>10
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(234071020630412401.4753)
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(805305720618296184.4753)
,p_name=>'COMPANY'
,p_scope=>'GLOBAL'
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(805473839925021275.4753)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(801935533242345735.4753)
,p_name=>'LAST_VIEW'
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_version_scn=>37165770887405
...
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(805306383623314462.4753)
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(2104303530588118.4753)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2104694212588227.4753)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Beispiel-Apps'
,p_lov_return_value=>'SAMPLE_APPS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2105009678588233.4753)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Start-Apps'
,p_lov_return_value=>'STARTER_APPS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(278121939301114725.4753)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Utilitys'
,p_lov_return_value=>'UTILITY_APPS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2105458011588234.4753)
,p_lov_disp_sequence=>4
,p_lov_disp_value=>'Benutzerdefinierte Apps'
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(2706600591276099.4753)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(4007216121720968.4753)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(4007552694721124.4753)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Neue Anwendungs-ID automatisch zuweisen'
,p_lov_return_value=>'AUTO'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(4007913496721129.4753)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>unistr('Anwendungs-ID \00E4ndern')
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(49858589128480256.4753)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(632592103695134630.4753)
,p_lov_disp_sequence=>5
,p_lov_disp_value=>'Facet-Suche'
,p_lov_return_value=>'Faceted Search'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(49859193897480260.4753)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Verbesserte Popup-Werteliste'
,p_lov_return_value=>'Enhanced Popup LOV'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(49859564794480260.4753)
,p_lov_disp_sequence=>15
,p_lov_disp_value=>'Erweiterte gemeinsame Wertelisten'
,p_lov_return_value=>'Expanded Shared LOVs'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(49859901359480260.4753)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>unistr('REST-f\00E4higes interaktives Grid')
,p_lov_return_value=>'REST Enabled Interactive Grid'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(632592811832140769.4753)
,p_lov_disp_sequence=>30
,p_lov_disp_value=>'Neues Team Development'
,p_lov_return_value=>'New Team Development'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(49858779305480258.4753)
,p_lov_disp_sequence=>40
,p_lov_disp_value=>'Assistent zum Erstellen von Anwendungen'
,p_lov_return_value=>'Create Application Wizard'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(49860319574480261.4753)
,p_lov_disp_sequence=>50
,p_lov_disp_value=>'Oracle JET-Diagramme'
,p_lov_return_value=>'Oracle JET Charts'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(49860715620480261.4753)
,p_lov_disp_sequence=>60
,p_lov_disp_value=>'SQL Workshop'
,p_lov_return_value=>'SQL Workshop'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(49861101819480262.4753)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(49861512099480262.4753)
,p_lov_disp_sequence=>80
,p_lov_disp_value=>'Sicherheit'
,p_lov_return_value=>'Security'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(49862347729480262.4753)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(539941826945132432.4753)
,p_name=>' Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(5084810742446784.4753)
,p_short_name=>'<span class="u-VisuallyHidden">Apps</span><span class="a-Icon icon-breadcrumb-previous" title="Apps"></span>'
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(740687851443061408.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293543573349992211.4753)
,p_page_template_id=>wwv_flow_imp.id(740687851443061408.4753)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293544003214992211.4753)
,p_page_template_id=>wwv_flow_imp.id(740687851443061408.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293544543759992212.4753)
,p_page_template_id=>wwv_flow_imp.id(740687851443061408.4753)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(741365982136994250.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293493647935977323.4753)
,p_page_template_id=>wwv_flow_imp.id(741365982136994250.4753)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293494161530977323.4753)
,p_page_template_id=>wwv_flow_imp.id(741365982136994250.4753)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(293494644231977323.4753)
,p_page_template_id=>wwv_flow_imp.id(741365982136994250.4753)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(741366253443994295.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2545350256702152.4753)
,p_page_template_id=>wwv_flow_imp.id(741366253443994295.4753)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2545831613702152.4753)
,p_page_template_id=>wwv_flow_imp.id(741366253443994295.4753)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2546314171702153.4753)
,p_page_template_id=>wwv_flow_imp.id(741366253443994295.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2546871480702153.4753)
,p_page_template_id=>wwv_flow_imp.id(741366253443994295.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2547386962702153.4753)
,p_page_template_id=>wwv_flow_imp.id(741366253443994295.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2547844723702153.4753)
,p_page_template_id=>wwv_flow_imp.id(741366253443994295.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2548309828702153.4753)
,p_page_template_id=>wwv_flow_imp.id(741366253443994295.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2548882993702154.4753)
,p_page_template_id=>wwv_flow_imp.id(741366253443994295.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2549317040702154.4753)
,p_page_template_id=>wwv_flow_imp.id(741366253443994295.4753)
,p_name=>'Control Bar'
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(741368521013994306.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2453635239706111.4753)
,p_page_template_id=>wwv_flow_imp.id(741368521013994306.4753)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2454185243706111.4753)
,p_page_template_id=>wwv_flow_imp.id(741368521013994306.4753)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2454608726706111.4753)
,p_page_template_id=>wwv_flow_imp.id(741368521013994306.4753)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2455181758706111.4753)
,p_page_template_id=>wwv_flow_imp.id(741368521013994306.4753)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2455626935706112.4753)
,p_page_template_id=>wwv_flow_imp.id(741368521013994306.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2456195166706112.4753)
,p_page_template_id=>wwv_flow_imp.id(741368521013994306.4753)
,p_name=>'Page Position 7'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2456666163706112.4753)
,p_page_template_id=>wwv_flow_imp.id(741368521013994306.4753)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2457128380706112.4753)
,p_page_template_id=>wwv_flow_imp.id(741368521013994306.4753)
,p_name=>'Control Bar'
,p_placeholder=>'REGION_POSITION_09'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(741369094170994311.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1581624490131879.4753)
,p_page_template_id=>wwv_flow_imp.id(741369094170994311.4753)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1582167771131879.4753)
,p_page_template_id=>wwv_flow_imp.id(741369094170994311.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1582615292131880.4753)
,p_page_template_id=>wwv_flow_imp.id(741369094170994311.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1583150686131880.4753)
,p_page_template_id=>wwv_flow_imp.id(741369094170994311.4753)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1583687644131880.4753)
,p_page_template_id=>wwv_flow_imp.id(741369094170994311.4753)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1584186191131880.4753)
,p_page_template_id=>wwv_flow_imp.id(741369094170994311.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1584636011131880.4753)
,p_page_template_id=>wwv_flow_imp.id(741369094170994311.4753)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1585194599131880.4753)
,p_page_template_id=>wwv_flow_imp.id(741369094170994311.4753)
,p_name=>'Control Bar'
,p_placeholder=>'REGION_POSITION_09'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(741370435290994312.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115225378021289463.4753)
,p_page_template_id=>wwv_flow_imp.id(741370435290994312.4753)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115225851606289463.4753)
,p_page_template_id=>wwv_flow_imp.id(741370435290994312.4753)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115226383171289463.4753)
,p_page_template_id=>wwv_flow_imp.id(741370435290994312.4753)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115226869943289464.4753)
,p_page_template_id=>wwv_flow_imp.id(741370435290994312.4753)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115227355594289464.4753)
,p_page_template_id=>wwv_flow_imp.id(741370435290994312.4753)
,p_name=>'Page Position 4'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115227854333289464.4753)
,p_page_template_id=>wwv_flow_imp.id(741370435290994312.4753)
,p_name=>'Page Position 7'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(115228300168289465.4753)
,p_page_template_id=>wwv_flow_imp.id(741370435290994312.4753)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(741371098457994312.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1544377764875385.4753)
,p_page_template_id=>wwv_flow_imp.id(741371098457994312.4753)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1544860614875385.4753)
,p_page_template_id=>wwv_flow_imp.id(741371098457994312.4753)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1545313252875385.4753)
,p_page_template_id=>wwv_flow_imp.id(741371098457994312.4753)
,p_name=>'Page Position 2'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1545880022875386.4753)
,p_page_template_id=>wwv_flow_imp.id(741371098457994312.4753)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1546334943875386.4753)
,p_page_template_id=>wwv_flow_imp.id(741371098457994312.4753)
,p_name=>'Page Position 4'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1546880552875386.4753)
,p_page_template_id=>wwv_flow_imp.id(741371098457994312.4753)
,p_name=>'Page Position 7'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1547358313875386.4753)
,p_page_template_id=>wwv_flow_imp.id(741371098457994312.4753)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1547871971875386.4753)
,p_page_template_id=>wwv_flow_imp.id(741371098457994312.4753)
,p_name=>'Control Bar'
,p_placeholder=>'REGION_POSITION_09'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(404710483554908976.4753)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(404710812892908978.4753)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(404711161197908978.4753)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(510958289243179645.4753)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(510958400671179662.4753)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(758581488338548971.4753)
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3107850363500989.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3108303540500989.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3108868881500989.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3109367574500989.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3109864202500989.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3110328896500990.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3110807394500990.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3111394778500990.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3111809336500990.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3112325206500990.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3112851557500990.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3113380790500990.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3113878903500991.4753)
,p_plug_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_name=>'Sub Regions'
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(404672496027804677.4753)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32619671565747573.4753)
,p_plug_template_id=>wwv_flow_imp.id(404672496027804677.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32620114120747574.4753)
,p_plug_template_id=>wwv_flow_imp.id(404672496027804677.4753)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32620640780747574.4753)
,p_plug_template_id=>wwv_flow_imp.id(404672496027804677.4753)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32621102307747575.4753)
,p_plug_template_id=>wwv_flow_imp.id(404672496027804677.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3306435106506010.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3306942993506010.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3307451523506010.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3307911908506011.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3308440430506011.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3308943918506011.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3309496354506011.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3309977207506011.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3310402869506011.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3310935308506011.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3311430820506012.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3311921441506012.4753)
,p_plug_template_id=>wwv_flow_imp.id(662132465401686364.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2292112508232370.4753)
,p_plug_template_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2292635406232371.4753)
,p_plug_template_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2293102807232371.4753)
,p_plug_template_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2293666190232371.4753)
,p_plug_template_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2294120894232371.4753)
,p_plug_template_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2294655893232371.4753)
,p_plug_template_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2295152367232371.4753)
,p_plug_template_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2295623044232371.4753)
,p_plug_template_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2296193696232372.4753)
,p_plug_template_id=>wwv_flow_imp.id(740735067061086300.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(740771588500180474.4753)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3362931134508595.4753)
,p_plug_template_id=>wwv_flow_imp.id(740771588500180474.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3363437993508595.4753)
,p_plug_template_id=>wwv_flow_imp.id(740771588500180474.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(746534672114889110.4753)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2596871931486631.4753)
,p_plug_template_id=>wwv_flow_imp.id(746534672114889110.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2597341118486631.4753)
,p_plug_template_id=>wwv_flow_imp.id(746534672114889110.4753)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2597857889486631.4753)
,p_plug_template_id=>wwv_flow_imp.id(746534672114889110.4753)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2598323104486631.4753)
,p_plug_template_id=>wwv_flow_imp.id(746534672114889110.4753)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2598889833486631.4753)
,p_plug_template_id=>wwv_flow_imp.id(746534672114889110.4753)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2599328377486631.4753)
,p_plug_template_id=>wwv_flow_imp.id(746534672114889110.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(805131422007607886.4753)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88197260378816934.4753)
,p_plug_template_id=>wwv_flow_imp.id(805131422007607886.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88197717416816934.4753)
,p_plug_template_id=>wwv_flow_imp.id(805131422007607886.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(805132117516607920.4753)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3389483342510522.4753)
,p_plug_template_id=>wwv_flow_imp.id(805132117516607920.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3389981937510522.4753)
,p_plug_template_id=>wwv_flow_imp.id(805132117516607920.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(805538978589340502.4753)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2937036520493392.4753)
,p_plug_template_id=>wwv_flow_imp.id(805538978589340502.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2937585126493392.4753)
,p_plug_template_id=>wwv_flow_imp.id(805538978589340502.4753)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2938099027493392.4753)
,p_plug_template_id=>wwv_flow_imp.id(805538978589340502.4753)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2938510026493393.4753)
,p_plug_template_id=>wwv_flow_imp.id(805538978589340502.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2833898614491377.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2834398404491377.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2834884230491377.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2835379319491377.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2835811967491377.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2836324477491378.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Create2'
,p_placeholder=>'CREATE2'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2836811082491378.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2837355943491378.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2837870022491378.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Expand'
,p_placeholder=>'EXPAND'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2838347514491378.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2838829965491378.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2839360800491378.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2839812709491379.4753)
,p_plug_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1164683681838385745.4753)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(61244261409733472.4753)
,p_plug_template_id=>wwv_flow_imp.id(1164683681838385745.4753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(61244762612733472.4753)
,p_plug_template_id=>wwv_flow_imp.id(1164683681838385745.4753)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(404660636766798903.4753)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(404660915136798904.4753)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(750892319717997379.4753)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(755602131069880061.4753)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(798348984564602568.4753)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(805146703039709510.4753)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(741378333819007312.4753)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(741383139242007378.4753)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(741383847997007380.4753)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(741385154282007399.4753)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(805120647160580956.4753)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(805120945120580960.4753)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(805706496589034856.4753)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(932270054883616955.4753)
...
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(741012333966774170.4753)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(741376158824001765.4753)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(741376298358001771.4753)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(741376307162001773.4753)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(741376417814001773.4753)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(750871254241940005.4753)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(1212080564184792020.4753)
...
wwv_flow_imp_shared.create_menu_template(
 p_id=>wwv_flow_imp.id(404662212565801043.4753)
...
wwv_flow_imp_shared.create_popup_lov_template(
 p_id=>wwv_flow_imp.id(539940326974132424.4753)
,p_page_name=>'winlov'
...
wwv_flow_imp_shared.create_calendar_template(
 p_id=>wwv_flow_imp.id(539940232021132423.4753)
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(72333757135541211.4753)
,p_theme_id=>3
,p_name=>'DARK'
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(556402834682122674.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(556403147888123468.4753)
,p_theme_id=>3
,p_name=>'DARK_AUTO'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#IMAGE_PREFIX#apex_ui/css/Core#MIN#.css',
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(607578911660270943.4753)
,p_theme_id=>3
,p_name=>'STANDARD'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#IMAGE_PREFIX#apex_ui/css/Core#MIN#.css',
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2349310377056027.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(697253623117708869.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(698708764949187835.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(698709451036187835.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(698710164448187835.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(698711710498187841.4753)
,p_theme_id=>3
,p_name=>'REPORT_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(740735413933086306.4753)
,p_theme_id=>3
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(740735719132086313.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(740736131546086315.4753)
,p_theme_id=>3
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(741378782415007354.4753)
,p_theme_id=>3
,p_name=>'BADGE_LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(741379667978007374.4753)
,p_theme_id=>3
,p_name=>'BADGE_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746441836569425940.4753)
,p_theme_id=>3
,p_name=>'HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746443190371425941.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746443452881425941.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746443757575425941.4753)
,p_theme_id=>3
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746444836374425941.4753)
,p_theme_id=>3
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746445145634425941.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746445421077425942.4753)
,p_theme_id=>3
,p_name=>'BUTTON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746445725296425945.4753)
,p_theme_id=>3
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746446077015425945.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746446530805425946.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746446884162425946.4753)
,p_theme_id=>3
,p_name=>'BUTTON_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746535083802889112.4753)
,p_theme_id=>3
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(746535358980889115.4753)
,p_theme_id=>3
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(750899131263089224.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(750899683273089226.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(798349340561602593.4753)
,p_theme_id=>3
,p_name=>'LAYOUT'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1523503933426795.4753)
,p_theme_id=>3
,p_name=>'HIDDEN'
,p_display_name=>'Hidden to Assistive Tech'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(805538978589340502.4753)
,p_css_classes=>'a-Region--hideHeader'
,p_group_id=>wwv_flow_imp.id(740735413933086306.4753)
,p_template_types=>'REGION'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2349650561067810.4753)
,p_theme_id=>3
,p_name=>'HEADING_LEVEL_H1'
,p_display_name=>'H1'
,p_display_sequence=>10
,p_css_classes=>'js-headingLevel-1'
,p_group_id=>wwv_flow_imp.id(2349310377056027.4753)
,p_template_types=>'REGION'
,p_help_text=>'H1'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2349964112067810.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2350357144067810.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2350726291067810.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2351150114067810.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(2351586092067810.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747463006528132175.4753)
,p_theme_id=>3
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
,p_css_classes=>'a-Button--gapLeft'
,p_group_id=>wwv_flow_imp.id(746445725296425945.4753)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747463277324132175.4753)
,p_theme_id=>3
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
,p_css_classes=>'a-Button--gapRight'
,p_group_id=>wwv_flow_imp.id(746446077015425945.4753)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747463446233132175.4753)
,p_theme_id=>3
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_imp.id(746446530805425946.4753)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747463631373132175.4753)
,p_theme_id=>3
,p_name=>'LARGE'
,p_display_name=>'Large'
,p_display_sequence=>3
,p_css_classes=>'a-Button--large'
,p_group_id=>wwv_flow_imp.id(746445421077425942.4753)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747463892204132175.4753)
,p_theme_id=>3
,p_name=>'SMALLLEFT'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747464099568132175.4753)
,p_theme_id=>3
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747464257097132175.4753)
,p_theme_id=>3
,p_name=>'INNERBUTTON'
,p_display_name=>'Inner Button'
,p_display_sequence=>2
,p_css_classes=>'a-Button--pill'
,p_group_id=>wwv_flow_imp.id(746443757575425941.4753)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747464408083132175.4753)
,p_theme_id=>3
,p_name=>'LASTBUTTON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747464690649132175.4753)
,p_theme_id=>3
,p_name=>'FIRSTBUTTON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747464847493132175.4753)
,p_theme_id=>3
,p_name=>'PRIMARY'
,p_display_name=>'Primary'
,p_display_sequence=>1
,p_css_classes=>'a-Button--primary'
,p_group_id=>wwv_flow_imp.id(746446884162425946.4753)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747464983019132175.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747465129834132176.4753)
,p_theme_id=>3
,p_name=>'SMALL'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747465242839132176.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747465484278132176.4753)
,p_theme_id=>3
,p_name=>'AUTOWIDTH'
,p_display_name=>'Auto Width'
,p_display_sequence=>1
,p_css_classes=>'a-Form--autoWidthLabels'
,p_group_id=>wwv_flow_imp.id(746443452881425941.4753)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747465645644132176.4753)
,p_theme_id=>3
,p_name=>'FIXEDWIDTH'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747465815587132176.4753)
,p_theme_id=>3
,p_name=>'LABELSABOVE'
,p_display_name=>'Labels Above'
,p_display_sequence=>1
,p_css_classes=>'a-Form--labelsAbove'
,p_group_id=>wwv_flow_imp.id(746445145634425941.4753)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747466092646132176.4753)
,p_theme_id=>3
,p_name=>'ALIGNLABELSLEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_css_classes=>'a-Form--leftLabels'
,p_group_id=>wwv_flow_imp.id(746443190371425941.4753)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747466208356132176.4753)
,p_theme_id=>3
,p_name=>'LABELAUTOWIDTH'
,p_display_name=>'Auto Width'
,p_display_sequence=>1
,p_css_classes=>'a-Form-fieldContainer--autoLabelWidth'
,p_group_id=>wwv_flow_imp.id(746444836374425941.4753)
,p_template_types=>'FIELD'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747466360014132176.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747466555388132176.4753)
,p_theme_id=>3
,p_name=>'FIXEDLARGE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747466798216132176.4753)
,p_theme_id=>3
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747466963230132176.4753)
,p_theme_id=>3
,p_name=>'180PX'
,p_display_name=>'180px'
,p_display_sequence=>10
,p_css_classes=>'h180'
,p_group_id=>wwv_flow_imp.id(746441836569425940.4753)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747467175674132176.4753)
,p_theme_id=>3
,p_name=>'240PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747467399810132176.4753)
,p_theme_id=>3
,p_name=>'320PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747467514327132177.4753)
,p_theme_id=>3
,p_name=>'480PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747467776225132177.4753)
,p_theme_id=>3
,p_name=>'540PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747467997690132177.4753)
,p_theme_id=>3
,p_name=>'640PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747473828460136685.4753)
,p_theme_id=>3
,p_name=>'USE_COLORED_BACKGROUND'
,p_display_name=>'Use Colored Background'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(746534672114889110.4753)
,p_css_classes=>'a-Alert--colorBG'
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747473950983136685.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747474127360136685.4753)
,p_theme_id=>3
,p_name=>'WARNING'
...
,p_group_id=>wwv_flow_imp.id(746535083802889112.4753)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747474348131136685.4753)
,p_theme_id=>3
,p_name=>'ERROR'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747474514470136685.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747474707581136685.4753)
,p_theme_id=>3
,p_name=>'HORIZONTAL'
...
,p_group_id=>wwv_flow_imp.id(746535358980889115.4753)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747474944578136686.4753)
,p_theme_id=>3
,p_name=>'WIZARD'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747475015417136686.4753)
,p_theme_id=>3
,p_name=>'REMOVE_ICON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747475237721136686.4753)
,p_theme_id=>3
,p_name=>'SUCCESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747475664720136688.4753)
,p_theme_id=>3
,p_name=>'REGIONCONTAINSITEMSTEXT'
,p_display_name=>'Region Contains Items / Text'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(740735067061086300.4753)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747475812078136688.4753)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(740736131546086315.4753)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747476008148136688.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747476278021136688.4753)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
...
,p_group_id=>wwv_flow_imp.id(740735719132086313.4753)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747476495301136688.4753)
,p_theme_id=>3
,p_name=>'NOPADDING'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747476598371136688.4753)
,p_theme_id=>3
,p_name=>'WIZARDDIALOG'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747476784777136688.4753)
,p_theme_id=>3
,p_name=>'VISIBLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747476963807136688.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747478061061136695.4753)
,p_theme_id=>3
,p_name=>'FLOATITEMS'
,p_display_name=>'Float Items'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(741378333819007312.4753)
,p_css_classes=>'a-BadgeList--float'
,p_group_id=>wwv_flow_imp.id(741378782415007354.4753)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747478236458136695.4753)
,p_theme_id=>3
,p_name=>'FIXED'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747478465916136695.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747478620563136695.4753)
,p_theme_id=>3
,p_name=>'SMALL'
,p_display_name=>'32px'
,p_display_sequence=>1
...
,p_group_id=>wwv_flow_imp.id(741379667978007374.4753)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747478816770136695.4753)
,p_theme_id=>3
,p_name=>'MEDIUM'
,p_display_name=>'48px'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747479061860136695.4753)
,p_theme_id=>3
,p_name=>'LARGE'
,p_display_name=>'64px'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747479231007136697.4753)
,p_theme_id=>3
,p_name=>'XLARGE'
,p_display_name=>'96px'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747479414686136697.4753)
,p_theme_id=>3
,p_name=>'XXLARGE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747479631087136697.4753)
,p_theme_id=>3
,p_name=>'2COLUMNNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747479882130136697.4753)
,p_theme_id=>3
,p_name=>'3COLUMNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747480030416136697.4753)
,p_theme_id=>3
,p_name=>'4COLUMNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747480265456136697.4753)
,p_theme_id=>3
,p_name=>'5COLUMNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(747480483547136697.4753)
,p_theme_id=>3
,p_name=>'FLEXIBLEBOX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(787127352847949731.4753)
,p_theme_id=>3
,p_name=>'DISABLE'
,p_display_name=>'Disable'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(741385154282007399.4753)
,p_css_classes=>'a-Report--staticRowColors'
,p_group_id=>wwv_flow_imp.id(698708764949187835.4753)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(787127585732949731.4753)
,p_theme_id=>3
,p_name=>'ENABLE'
...
,p_group_id=>wwv_flow_imp.id(698709451036187835.4753)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(787127711546949731.4753)
,p_theme_id=>3
,p_name=>'NOBORDERS'
...
,p_group_id=>wwv_flow_imp.id(698710164448187835.4753)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(787127972338949731.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(787128199893949731.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(787128259567949731.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(787128429850949731.4753)
,p_theme_id=>3
,p_name=>'STRETCH'
...
,p_group_id=>wwv_flow_imp.id(698711710498187841.4753)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798350813694602633.4753)
,p_theme_id=>3
,p_name=>'2COLUMNGRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(798348984564602568.4753)
,p_css_classes=>'a-MediaList--cols a-MediaList--2cols'
,p_group_id=>wwv_flow_imp.id(798349340561602593.4753)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798351014569602633.4753)
,p_theme_id=>3
,p_name=>'3COLUMNGRID'
,p_display_name=>'3 Column Grid'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798351220332602633.4753)
,p_theme_id=>3
,p_name=>'4COLUMNGRID'
,p_display_name=>'4 Column Grid'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798351489652602634.4753)
,p_theme_id=>3
,p_name=>'5COLUMNGRID'
,p_display_name=>'5 Column Grid'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798351687944602634.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798351753474602634.4753)
,p_theme_id=>3
,p_name=>'HIDEBADGE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798351813649602634.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798351937390602634.4753)
,p_theme_id=>3
,p_name=>'HIDETITLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798352054616602634.4753)
,p_theme_id=>3
,p_name=>'HIDEICONS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(798352116411602634.4753)
,p_theme_id=>3
,p_name=>'SLIMLIST'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(805706717271034862.4753)
,p_theme_id=>3
,p_name=>'DISABLE'
,p_display_name=>'Disable'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(805706496589034856.4753)
,p_css_classes=>'a-Report--staticRowColors'
,p_group_id=>wwv_flow_imp.id(698708764949187835.4753)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(805706847390034864.4753)
,p_theme_id=>3
,p_name=>'ENABLE'
,p_display_name=>'Enable'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(805706992942034864.4753)
,p_theme_id=>3
,p_name=>'HORIZONTALBORDERS'
,p_display_name=>'Horizontal Borders'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(805707090166034864.4753)
,p_theme_id=>3
,p_name=>'INLINEBORDERS'
,p_display_name=>'Inline Borders'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(805707148450034864.4753)
,p_theme_id=>3
,p_name=>'NOBORDERS'
,p_display_name=>'No Borders'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(805707237455034864.4753)
,p_theme_id=>3
,p_name=>'STRETCH'
,p_display_name=>'Stretch'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(805707357730034864.4753)
,p_theme_id=>3
,p_name=>'VERTICALBORDERS'
,p_display_name=>'Vertical Borders'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(926400418677707541.4753)
,p_theme_id=>3
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(404660915136798904.4753)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(926400594637707541.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(940695744751341570.4753)
,p_theme_id=>3
,p_name=>'SLIMPROGRESSLIST'
,p_display_name=>'Slim Progress List'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(755602131069880061.4753)
,p_css_classes=>'a-WizardSteps--slim'
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1199562503035032434.4753)
,p_theme_id=>3
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_imp.id(758581488338548971.4753)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_imp.id(746446530805425946.4753)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1241666929781396960.4753)
,p_theme_id=>3
,p_name=>'USED_IN_DIALOG'
,p_display_name=>'Used in Dialog'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(1164683681838385745.4753)
,p_css_classes=>'a-ProcessingRegion--dialog'
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1525662345070182113.4753)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(805146703039709510.4753)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1525662481640182113.4753)
,p_theme_id=>3
,p_name=>'SHOWBADGES'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1525662510081182113.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1525662661993182113.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1525662869499182113.4753)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(697253623117708869.4753)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1525663077488182113.4753)
,p_theme_id=>3
,p_name=>'FORALLITEMS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1544819964749478035.4753)
,p_theme_id=>3
,p_name=>'SHOWRIGHTARROW'
,p_display_name=>'Show Right Arrow'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(741383847997007380.4753)
,p_css_classes=>'a-LinksList--showArrow'
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1544820012780478035.4753)
,p_theme_id=>3
,p_name=>'USEBRIGHTHOVERS'
,p_display_name=>'Use Bright Hovers'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1544820102363478035.4753)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554817344758408390.4753)
,p_theme_id=>3
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(404667570222803088.4753)
,p_css_classes=>'a-Region--hideHeader'
,p_group_id=>wwv_flow_imp.id(740735413933086306.4753)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554817556033408390.4753)
,p_theme_id=>3
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554817788346408390.4753)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554817927221408390.4753)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554818142196408390.4753)
,p_theme_id=>3
,p_name=>'SIDEBAR'
...
,p_group_id=>wwv_flow_imp.id(750899131263089224.4753)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554818375607408390.4753)
,p_theme_id=>3
,p_name=>'BORDERLESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554818564149408390.4753)
,p_theme_id=>3
...
,p_group_id=>wwv_flow_imp.id(750899683273089226.4753)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554818775823408390.4753)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554818958443408390.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554819000019408390.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554819282202408390.4753)
,p_theme_id=>3
,p_name=>'SIMPLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554830602794526786.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554830783243526786.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554830803540526786.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554836989856542249.4753)
,p_theme_id=>3
,p_name=>'FLUSHREGION'
,p_display_name=>'Flush Region'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(805699740467941340.4753)
,p_css_classes=>'a-Region--flush'
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554837048702542249.4753)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554837210657542249.4753)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554837432873542249.4753)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554837628193542249.4753)
,p_theme_id=>3
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554837892538542249.4753)
,p_theme_id=>3
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554838070925542250.4753)
,p_theme_id=>3
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554838282191542250.4753)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554838444739542251.4753)
,p_theme_id=>3
,p_name=>'EXPANDED'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(1554838651314542251.4753)
,p_theme_id=>3
,p_name=>'COLLAPSED'
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(693462664348655994.4753)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(539943211297143567.4753)
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_plugin_type=>'REGION TYPE'
...
,p_version_scn=>2599874
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23825926227826455.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23826362374826455.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(23825926227826455.4753)
,p_display_sequence=>10
,p_display_value=>'Server Side'
,p_return_value=>'SERVER'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23826846848826456.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(23825926227826455.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23827328026826456.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23825926227826455.4753)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23827763162826457.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23828120599826457.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(23827763162826457.4753)
,p_display_sequence=>10
,p_display_value=>'GET'
,p_return_value=>'GET'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23828646814826457.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(23827763162826457.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23829129391826458.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23827763162826457.4753)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23829534096826458.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23829926143826459.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23830302402826459.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23830743954826459.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23831128575826460.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23831519766826460.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23831904230826460.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(23831519766826460.4753)
,p_display_sequence=>10
,p_display_value=>'Scroll'
,p_return_value=>'SCROLL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23832480394826460.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(23831519766826460.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23832999228826461.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
,p_default_value=>'20'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23831519766826460.4753)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23833372954826461.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23833738649826461.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(23837482273826472.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(23837826055826472.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
...
wwv_flow_imp_shared.create_plugin_event(
 p_id=>wwv_flow_imp.id(23838239876826473.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
,p_name=>'apexclientsidetemplatorajaxerror'
,p_display_name=>'AJAX Error'
);
wwv_flow_imp_shared.create_plugin_event(
 p_id=>wwv_flow_imp.id(23838641338826473.4753)
,p_plugin_id=>wwv_flow_imp.id(1705025475548402.4753)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(44507041528251871.4753)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416859260950942524.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416859601641942524.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(416859260950942524.4753)
,p_display_sequence=>10
,p_display_value=>'OpenID Connect Provider'
,p_return_value=>'OPENID_CONNECT'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416860154481942524.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(416859260950942524.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416860627353942525.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(416859260950942524.4753)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416861178437942525.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(416859260950942524.4753)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416861641814942525.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(416859260950942524.4753)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416862030154942526.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416862413144942526.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416862816831942526.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416863298400942526.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416863622492942527.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416864065163942527.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416864422508942527.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416864875781942528.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416865210287942528.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416865660594942528.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(416865210287942528.4753)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416866153514942528.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(416865210287942528.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416866607567942529.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(416865210287942528.4753)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(416867126725942529.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(416865210287942528.4753)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(416867661745942529.4753)
,p_plugin_id=>wwv_flow_imp.id(118599641342932798.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(404682856933862574.4753)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_plugin_id=>wwv_flow_imp.id(404682856933862574.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1706307718757974.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>10
,p_display_value=>'ADMIN: Ability to manage flow developer privileges'
,p_return_value=>'ADMIN'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1706898839757974.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1707342230757975.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1707803171757975.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708310066757975.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1708878977757975.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1709391229757976.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1709837210757977.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1710382283757977.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1710815803757977.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1711387184757977.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1711856452757978.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>130
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1705899786757974.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(1705450667757973.4753)
,p_display_sequence=>140
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(499279834326550209.4753)
,p_plugin_type=>'ITEM TYPE'
,p_name=>'COM.ORACLE.APEX.PLUGIN_DYNAMIC_ATTRIBUTE'
,p_display_name=>'Dynamisches Plug-in-Attribut'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(760226818503948428.4753)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(760229135394948431.4753)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(760232319702948435.4753)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(760287411454948485.4753)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308196144432529867.4753)
,p_plugin_id=>wwv_flow_imp.id(760287411454948485.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308196541202529867.4753)
,p_plugin_id=>wwv_flow_imp.id(760287411454948485.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308196922742529867.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(308196541202529867.4753)
,p_display_sequence=>10
,p_display_value=>'Redirect to Built-In URL'
,p_return_value=>'BUILTIN_URL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308197442329529868.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(308196541202529867.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308197927617529868.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(308196541202529867.4753)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308198454439529868.4753)
,p_plugin_id=>wwv_flow_imp.id(760287411454948485.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
,p_display_length=>60
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(308196541202529867.4753)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308198812754529869.4753)
,p_plugin_id=>wwv_flow_imp.id(760287411454948485.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308199267680529869.4753)
,p_plugin_id=>wwv_flow_imp.id(760287411454948485.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308199647132529869.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(308199267680529869.4753)
,p_display_sequence=>10
,p_display_value=>'Each Request'
,p_return_value=>'ALWAYS'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(308200170394529870.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(308199267680529869.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308200620053529870.4753)
,p_plugin_id=>wwv_flow_imp.id(760287411454948485.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(760360526050948543.4753)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(760360721990948543.4753)
,p_plugin_id=>wwv_flow_imp.id(760360526050948543.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(760361111417948543.4753)
,p_plugin_id=>wwv_flow_imp.id(760360526050948543.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(760361533802948544.4753)
,p_plugin_id=>wwv_flow_imp.id(760360526050948543.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(760361938927948544.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(760361533802948544.4753)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(760362419420948544.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(760361533802948544.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(760362933267948544.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(760361533802948544.4753)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(760363417836948545.4753)
,p_plugin_id=>wwv_flow_imp.id(760360526050948543.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(760363827848948545.4753)
,p_plugin_id=>wwv_flow_imp.id(760360526050948543.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(760364216062948545.4753)
,p_plugin_id=>wwv_flow_imp.id(760360526050948543.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(760363827848948545.4753)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(760364637771948545.4753)
,p_plugin_id=>wwv_flow_imp.id(760360526050948543.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(760365024887948545.4753)
,p_plugin_id=>wwv_flow_imp.id(760360526050948543.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(760365437846948545.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(760365024887948545.4753)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(760365918613948546.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(760365024887948545.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(760366434328948546.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(760365024887948545.4753)
,p_display_sequence=>30
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(760375920088948554.4753)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(931633487189212464.4753)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(931633787892213491.4753)
,p_plugin_id=>wwv_flow_imp.id(931633487189212464.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(931634195040213494.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(931633787892213491.4753)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'S'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(931634625437213498.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(931633787892213491.4753)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(931635198372213498.4753)
,p_plugin_attribute_id=>wwv_flow_imp.id(931633787892213491.4753)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(931635685556213498.4753)
,p_plugin_id=>wwv_flow_imp.id(931633487189212464.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(845155986163834531.4753)
,p_plugin_id=>wwv_flow_imp.id(931633487189212464.4753)
,p_name=>'LOV'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(2448359566117403168.4753)
,p_plugin_type=>'DYNAMIC ACTION'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404677206185829568.4753)
,p_plug_name=>'APEX 5 - Header'
,p_region_css_classes=>'a-Header apex-pkg-apps'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(404672496027804677.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404677418056829569.4753)
,p_plug_name=>'APEX 5 - Header Left'
,p_parent_plug_id=>wwv_flow_imp.id(404677206185829568.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79231277016259802.4753)
,p_plug_name=>'Navigation Tabs Landmark'
,p_parent_plug_id=>wwv_flow_imp.id(404677418056829569.4753)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(404672496027804677.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(384690703142932822.4753)
,p_plug_name=>'APEX 5 - Tabs'
,p_region_name=>'a_Header_menu'
,p_parent_plug_id=>wwv_flow_imp.id(79231277016259802.4753)
,p_region_css_classes=>'a-Header-tabsContainer'
,p_region_attributes=>'style="display: none;"'
,p_plug_template=>wwv_flow_imp.id(404672496027804677.4753)
,p_plug_display_sequence=>30
,p_list_id=>wwv_flow_imp.id(719097510387175373.4753)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(404660636766798903.4753)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404677698967829569.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404677861324829570.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404678078196829570.4753)
,p_plug_name=>'APEX 5 - Search'
,p_parent_plug_id=>wwv_flow_imp.id(404677861324829570.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404678295558829570.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2401819682991815.4753)
,p_plug_name=>'APEX 5 - Extensions Menu'
,p_region_name=>'extensionsMenu'
,p_parent_plug_id=>wwv_flow_imp.id(404678295558829570.4753)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(404672496027804677.4753)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(4800278867383473.4753)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(404660915136798904.4753)
,p_translate_title=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404724225488161526.4753)
...
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(697584654501422607.4753)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(404660915136798904.4753)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(486772230808301732.4753)
...
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(697615600061428203.4753)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(404660915136798904.4753)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404678402039829570.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404678655419829570.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404678877158829570.4753)
,p_plug_name=>'APEX 5 - Control Bar Left'
,p_parent_plug_id=>wwv_flow_imp.id(404678655419829570.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(384690882838932823.4753)
,p_plug_name=>'APEX 5- Breadcrumb'
,p_parent_plug_id=>wwv_flow_imp.id(404678877158829570.4753)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(404672496027804677.4753)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
,p_menu_id=>wwv_flow_imp.id(539941826945132432.4753)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_imp.id(404662212565801043.4753)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(404679005997829570.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(735033847544168733.4753)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(404678295558829570.4753)
,p_button_name=>'UPGRADE_AVAILABLE'
,p_button_static_id=>'header-upgradeAvailable'
,p_button_action=>'REDIRECT_APP'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(404711161197908978.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(735033724002168732.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3773582323250301546.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2401975531991816.4753)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(404678295558829570.4753)
,p_button_name=>'EXTENSIONS'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(404710812892908978.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(384690975801932824.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(384691038290932825.4753)
...
,p_required_patch=>wwv_flow_imp.id(693462664348655994.4753)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(384691145501932826.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(385808567373243610.4753)
,p_name=>'P0_WINDOW_MGMT_MODE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(404677206185829568.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(385808664685243611.4753)
...
wwv_flow_imp_page.create_page(
 p_id=>40.4753
,p_name=>'Anwendungsdetails'
,p_alias=>'APPLICATION-DETAILS'
,p_page_mode=>'MODAL'
,p_step_title=>'Anwendungsdetails'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_imp.id(741365982136994250.4753)
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6860274872588023.4753)
,p_plug_name=>unistr('Container f\00FCr Schaltfl\00E4chen')
,p_region_css_classes=>'margin-top-none'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(740735067061086300.4753)
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6860712723588028.4753)
...
,p_plug_template=>wwv_flow_imp.id(746534672114889110.4753)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6861275020588033.4753)
,p_plug_name=>'Erweiterte Einstellungen'
,p_region_css_classes=>'margin-none'
,p_region_template_options=>'#DEFAULT#:is-collapsed'
,p_region_attributes=>'style="display:none"'
,p_plug_template=>wwv_flow_imp.id(805699740467941340.4753)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'REGION_POSITION_03'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(5058770130014456.4753)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(6860274872588023.4753)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(404710483554908976.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2279235270493824.4753)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(6860274872588023.4753)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(404710483554908976.4753)
,p_button_image_alt=>'Anwendung entfernen'
,p_button_position=>'NEXT'
,p_button_execute_validations=>'N'
,p_confirm_message=>unistr('<p>M\00F6chten Sie <strong>&P40_APP_NAME. (&P40_APP_ID.)</strong> wirklich entfernen?</p> <p>Hierdurch wird die Anwendung deinstalliert, und die zugeh\00F6rigen Datenbankobjekte werden entfernt.</p>')
,p_confirm_style=>'danger'
,p_button_condition=>'P40_APP_ID'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(5058372125014451.4753)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(6860274872588023.4753)
...
,p_button_template_id=>wwv_flow_imp.id(404710483554908976.4753)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Anwendung installieren'
,p_button_position=>'NEXT'
,p_warn_on_unsaved_changes=>null
,p_button_condition=>'P40_APP_ID'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2279134048493823.4753)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(6860274872588023.4753)
...
,p_button_template_id=>wwv_flow_imp.id(404710483554908976.4753)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Anwendung aktualisieren'
,p_button_position=>'NEXT'
,p_button_execute_validations=>'N'
,p_confirm_message=>unistr('<p>M\00F6chten Sie <strong>&P40_APP_NAME. (&P40_APP_ID.)</strong> wirklich aktualisieren?</p> <p>Hierdurch wird die Anwendung deinstalliert, und die unterst\00FCtzenden Datenbankobjekte werden entfernt, bevor sie wieder installiert wird.</p>')
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(5065847186014493.4753)
...
,p_branch_when_button_id=>wwv_flow_imp.id(5058372125014451.4753)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(7087430126289005.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5023117348816202.4753)
,p_name=>'P40_APP_AUTHOR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(6860712723588028.4753)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5023204808816203.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5053931809014409.4753)
,p_name=>'P40_APP_NAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(6860712723588028.4753)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5054397556014412.4753)
,p_name=>'P40_APP_DESC'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(6860712723588028.4753)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5054762313014413.4753)
,p_name=>'P40_APP_ICON'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(6860712723588028.4753)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5055432767014418.4753)
,p_name=>'P40_NEW_FLOW_OPTIONS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(6861275020588033.4753)
,p_item_default=>'AUTO'
,p_prompt=>'Als Anwendung installieren'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'NEW_FLOW_OPTIONS'
,p_lov=>'.'||wwv_flow_imp.id(4007216121720968)||'.'
,p_field_template=>wwv_flow_imp.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>',
unistr('W\00E4hlen Sie aus, wie diese Anwendung installiert werden soll. Verf\00FCgbare Optionen:'),
'</p>',
'',
'<p><ul>',
'<li>Neue Anwendungs-ID automatisch zuweisen: Es wird eine neue Anwendungs-ID erstellt.</li>',
unistr('<li>Anwendungs-ID \00E4ndern: Geben Sie eine neue Anwendungs-ID an.</li>'),
'</ul>',
'</p>',
'',
'<p>',
unistr('Beachten Sie, dass Sie eine Anwendungs-ID angeben m\00FCssen, die innerhalb aller &PRODUCT_NAME.-Workspaces eindeutig ist.'),
'</p>'))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'number_of_columns', '1',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5056290767014435.4753)
,p_name=>'P40_FLOW_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(6861275020588033.4753)
,p_prompt=>'Neue Anwendungs-ID'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>8
,p_field_template=>wwv_flow_imp.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('Geben Sie eine neue Anwendungs-ID ein. Hierbei handelt es sich um einen ganzzahligen Wert, der f\00FCr die Anwendung steht. Die Anwendungs-ID muss innerhalb Ihrer Instanz von &PRODUCT_NAME. eindeutig sein. <br /><br />'),
'',
unistr('Anwendungs-IDs im Bereich zwischen 3000 und 9000 sind f\00FCr den internen Gebrauch von &PRODUCT_NAME. reserviert.')))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'number_alignment', 'right',
  'virtual_keyboard', 'text')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5057175098014439.4753)
,p_name=>'P40_SCHEMA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(6861275020588033.4753)
...
,p_help_text=>unistr('Die Installation der Anwendung wird mit dieser Auswahl abgeschlossen. Nach der erfolgreichen Installation wird diese Auswahl verwendet, um den Eigent\00FCmer der installierten Anwendung auf diesen Wert zu setzen. ')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7087056832289001.4753)
,p_name=>'P40_APP_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(6860712723588028.4753)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7087570536289006.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7087623518289007.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7088428730289015.4753)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(7087132025289002.4753)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(7087741355289008.4753)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(5060064021014464.4753)
...
,p_when_button_pressed=>wwv_flow_imp.id(5058372125014451.4753)
,p_associated_item=>wwv_flow_imp.id(5056290767014435.4753)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(5059245585014460.4753)
,p_validation_name=>'Flow ID Numeric'
,p_validation_sequence=>30
,p_validation=>'P40_FLOW_ID'
,p_validation_type=>'ITEM_IS_NUMERIC'
,p_error_message=>'#LABEL# muss numerisch sein.'
,p_always_execute=>'Y'
,p_validation_condition=>':P40_NEW_FLOW_OPTIONS = ''SPECIFY'''
,p_validation_condition2=>'PLSQL'
,p_validation_condition_type=>'EXPRESSION'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(5059665804014463.4753)
...
,p_error_message=>unistr('Anwendungs-IDs zwischen 3000 und 9000 sind f\00FCr den internen Gebrauch durch &PRODUCT_NAME. reserviert.')
,p_always_execute=>'Y'
,p_validation_condition=>':P40_NEW_FLOW_OPTIONS = ''SPECIFY'''
,p_validation_condition2=>'PLSQL'
,p_validation_condition_type=>'EXPRESSION'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5063991991014484.4753)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(5058770130014456.4753)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5064442259014487.4753)
,p_event_id=>wwv_flow_imp.id(5063991991014484.4753)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5061136668014470.4753)
,p_name=>'Set App Icon'
,p_event_sequence=>20
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5061680504014474.4753)
,p_event_id=>wwv_flow_imp.id(5061136668014470.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5064871446014488.4753)
,p_name=>'Submit Page'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(5058372125014451.4753)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5065380055014490.4753)
,p_event_id=>wwv_flow_imp.id(5064871446014488.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5062017793014475.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5063026143014479.4753)
,p_event_id=>wwv_flow_imp.id(5062017793014475.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5063516983014483.4753)
,p_event_id=>wwv_flow_imp.id(5062017793014475.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5062583162014478.4753)
,p_event_id=>wwv_flow_imp.id(5062017793014475.4753)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(229281816338449001.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(229281966869449002.4753)
,p_event_id=>wwv_flow_imp.id(229281816338449001.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(7087835348289009.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(7087906514289010.4753)
,p_event_id=>wwv_flow_imp.id(7087835348289009.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6861275020588033.4753)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7095367014319588.4753)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(2279235270493824.4753)
,p_process_when=>'P40_APP_ID'
,p_process_when_type=>'ITEM_IS_NOT_NULL'
,p_internal_uid=>7095367014319588.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7089599908289026.4753)
...
,p_internal_uid=>7089599908289026.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7088529306289016.4753)
...
,p_attribute_09=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(5058372125014451.4753)
,p_process_when=>':P40_GALLERY_BACKGROUND_INSTALL = ''Y'' and :P40_APP_ID is null'
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>7088529306289016.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7088734046289018.4753)
...
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>7088734046289018.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7095610481323594.4753)
...
,p_attribute_09=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(2279134048493823.4753)
,p_process_when=>':P40_GALLERY_BACKGROUND_INSTALL = ''Y'' and :P40_APP_UPDATE_AVAILABLE = ''Y'''
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>7095610481323594.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7089075659289021.4753)
...
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>7089075659289021.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(5060331561014465.4753)
,p_process_sequence=>10
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>5060331561014465.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7087216913289003.4753)
,p_process_sequence=>10
,p_parent_process_id=>wwv_flow_imp.id(7095610481323594.4753)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Remove App for Update BG'
,p_process_sql_clob=>'wwv_flow_f4000_util.remove_app( p_flow_id => :P40_APP_ID );'
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>7087216913289003.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7088661442289017.4753)
,p_process_sequence=>10
,p_parent_process_id=>wwv_flow_imp.id(7088529306289016.4753)
,p_process_type=>'NATIVE_PLSQL'
...
');'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>7088661442289017.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7088882167289019.4753)
,p_process_sequence=>10
,p_parent_process_id=>wwv_flow_imp.id(7088734046289018.4753)
,p_process_type=>'NATIVE_PLSQL'
...
');'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>7088882167289019.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7089181372289022.4753)
,p_process_sequence=>10
,p_parent_process_id=>wwv_flow_imp.id(7089075659289021.4753)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Remove App for Update FG'
,p_process_sql_clob=>'wwv_flow_f4000_util.remove_app( p_flow_id => :P40_APP_ID );'
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>7089181372289022.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7087324783289004.4753)
,p_process_sequence=>20
,p_parent_process_id=>wwv_flow_imp.id(7095610481323594.4753)
,p_process_type=>'NATIVE_PLSQL'
...
');'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>7087324783289004.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7089240699289023.4753)
,p_process_sequence=>20
,p_parent_process_id=>wwv_flow_imp.id(7089075659289021.4753)
,p_process_type=>'NATIVE_PLSQL'
...
');'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>7089240699289023.4753
);
end;
/
...
'}',
''))
,p_step_template=>wwv_flow_imp.id(741368521013994306.4753)
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_imp.id(750863634498892275)
,p_deep_linking=>'Y'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9052805313207693.4753)
,p_plug_name=>unistr('Container f\00FCr App-Inhalt')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6843439835550493.4753)
,p_plug_name=>'Beispiel-Apps'
,p_region_name=>'SAMPLE_APPS'
,p_parent_plug_id=>wwv_flow_imp.id(9052805313207693.4753)
...
,p_plug_template=>wwv_flow_imp.id(404667570222803088.4753)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
,p_plug_source_type=>'PLUGIN_COM.ORACLE.APEX.CLIENT_SIDE_TEMPLATOR'
,p_plug_query_no_data_found=>'Keine Anwendung gefunden'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6843974991550498.4753)
,p_plug_name=>'Start-Apps'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6847262198550631.4753)
,p_plug_name=>unistr('Container f\00FCr benutzerdefinierte Apps')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6844097892550500.4753)
,p_plug_name=>'Benutzerdefinierte Apps'
,p_region_name=>'CUSTOM_APPS_CONTENT'
,p_parent_plug_id=>wwv_flow_imp.id(6847262198550631.4753)
,p_region_css_classes=>'apps_region a-Gallery-cards'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--slimPadding:a-Region--accessibleHeader'
,p_plug_template=>wwv_flow_imp.id(404667570222803088.4753)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6847362034550632.4753)
,p_plug_name=>'Benutzerdefinierte Apps einrichten'
,p_parent_plug_id=>wwv_flow_imp.id(6847262198550631.4753)
,p_region_css_classes=>'w800 a-Alert--inlineDialog'
...
,p_plug_display_point=>'SUB_REGIONS'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>M\00F6chten Sie hier Ihre eigenen Apps sehen?</p>'),
unistr('<p>In &PRODUCT_NAME. Administration Services k\00F6nnen Sie \00FCber die Seite mit den Einstellungen auf Instanzebene weitere Installationsquellen konfigurieren.</p>'),
unistr('<p>Ausf\00FChrliche Anweisungen finden Sie unter <a target="_blank" href="&SYSTEM_HELP_URL.">Galerie konfigurieren</a>.</p>')))
,p_plug_display_condition_type=>'EXPRESSION'
,p_plug_display_when_condition=>'regexp_count( wwv_flow_platform.get_preference(''GALLERY_FILE_URLS''), ''http'' ) = 1'
,p_plug_display_when_cond2=>'PLSQL'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(278122437415115701.4753)
,p_plug_name=>'Utilitys'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(572326527332275167.4753)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10061558747793193.4753)
,p_plug_name=>'Verbindungsfehler'
,p_parent_plug_id=>wwv_flow_imp.id(572326527332275167.4753)
,p_region_template_options=>'#DEFAULT#:a-Alert--colorBG:a-Alert--warning:a-Alert--wizard'
,p_plug_template=>wwv_flow_imp.id(746534672114889110.4753)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Es kann keine Verbindung mit dem Anwendungsgalerieanbieter hergestellt werden.</p>',
unistr('<p>Dies k\00F6nnte an Netzwerkeinschr\00E4nkungen oder an einem vor\00FCbergehenden Ausfall des angeforderten Service liegen.</p>')))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(641262218785692204.4753)
,p_plug_name=>'Galerieinformationen'
...
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
,p_plug_source=>unistr('Schauen Sie sich Beispiele an, die neue Features und Designmuster demonstrieren, f\00FCgen Sie mit Plug-ins neue Funktionen hinzu, und erhalten Sie vordefinierte Apps, die Sie unver\00E4ndert verwenden oder anpassen k\00F6nnen. ')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(641262065358692203.4753)
,p_plug_name=>'Links List'
,p_parent_plug_id=>wwv_flow_imp.id(641262218785692204.4753)
...
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(563238341577468350.4753)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(798348984564602568.4753)
,p_translate_title=>'N'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1782130101798719965.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1401862180865701.4753)
,p_name=>'P50_APP_INSTALL_EXEC_ID'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(1782130101798719965.4753)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2277622871493808.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2277761479493809.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2278554709493817.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5039038958977005.4753)
,p_name=>'P50_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1782130101798719965.4753)
,p_prompt=>'Suchen'
,p_placeholder=>'Such-Apps'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_tag_css_classes=>'a-Form-field--searchField'
,p_field_template=>wwv_flow_imp.id(1212080564184792020.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5039356862977024.4753)
,p_name=>'P50_APP_GROUP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(1782130101798719965.4753)
,p_use_cache_before_default=>'NO'
,p_item_default=>'SAMPLE_APPS'
,p_prompt=>'App-Typ filtern'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5039784724977026.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5040516614977030.4753)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(5044063457977092.4753)
,p_validation_name=>'Remove Flow ID Required'
,p_validation_sequence=>10
,p_validation=>'P50_REMOVE_FLOW_ID'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Fehler beim Entfernen der Anwendung.'
,p_always_execute=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5045539430977106.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5046093713977109.4753)
,p_event_id=>wwv_flow_imp.id(5045539430977106.4753)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5046493164977111.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5046974958977116.4753)
,p_event_id=>wwv_flow_imp.id(5046493164977111.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5047310905977119.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5047880792977124.4753)
,p_event_id=>wwv_flow_imp.id(5047310905977119.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2280335063493835.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2280445608493836.4753)
,p_event_id=>wwv_flow_imp.id(2280335063493835.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5049106741977131.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5049626978977138.4753)
,p_event_id=>wwv_flow_imp.id(5049106741977131.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(572326527332275167.4753)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5050607909977144.4753)
,p_event_id=>wwv_flow_imp.id(5049106741977131.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1782130101798719965.4753)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5050144037977140.4753)
,p_event_id=>wwv_flow_imp.id(5049106741977131.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(9052805313207693.4753)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(278122626461115703.4753)
,p_name=>'Show Utility Apps Tab'
,p_event_sequence=>90
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(278122437415115701.4753)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'PLUGIN_COM.ORACLE.APEX.CLIENT_SIDE_TEMPLATOR|REGION TYPE|apexclientsidetemplatorresponse'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(278123008786115707.4753)
,p_event_id=>wwv_flow_imp.id(278122626461115703.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(93204886026686901.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(93204965545686902.4753)
,p_event_id=>wwv_flow_imp.id(93204886026686901.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2276949321493801.4753)
,p_name=>'Init Sample Apps Action Menu'
,p_event_sequence=>110
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(6843439835550493.4753)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2277023267493802.4753)
,p_event_id=>wwv_flow_imp.id(2276949321493801.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2279465704493826.4753)
,p_name=>'Init Starter Apps Action Menu'
,p_event_sequence=>120
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(6843974991550498.4753)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'custom'
,p_bind_event_type_custom=>'tablemodelviewpagechange'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2279580288493827.4753)
,p_event_id=>wwv_flow_imp.id(2279465704493826.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2279619271493828.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2279744392493829.4753)
,p_event_id=>wwv_flow_imp.id(2279619271493828.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2279836858493830.4753)
,p_name=>'Init Custom Apps Action Menu'
,p_event_sequence=>140
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(6844097892550500.4753)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'custom'
,p_bind_event_type_custom=>'tablemodelviewpagechange'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2279958174493831.4753)
,p_event_id=>wwv_flow_imp.id(2279836858493830.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1482913960514903.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1483077570514904.4753)
,p_event_id=>wwv_flow_imp.id(1482913960514903.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2113815960014501.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2113939709014502.4753)
,p_event_id=>wwv_flow_imp.id(2113815960014501.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(5023721132816208.4753)
,p_process_sequence=>10
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>5023721132816208.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2279385668493825.4753)
,p_process_sequence=>20
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2279385668493825.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(5045107468977104.4753)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Remove App'
...
,p_internal_uid=>5045107468977104.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2277316269493805.4753)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_EXECUTION_CHAIN'
,p_process_name=>'Install App Background'
...
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>2277316269493805.4753
,p_process_comment=>'This process is used by an AJAX callback'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2278784325493819.4753)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_EXECUTION_CHAIN'
,p_process_name=>'Install App Foreground'
...
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>2278784325493819.4753
,p_process_comment=>'This process is used by an AJAX callback'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2278089943493812.4753)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_EXECUTION_CHAIN'
,p_process_name=>'Update App Background'
...
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>2278089943493812.4753
,p_process_comment=>'This process is used by an AJAX callback'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2278830627493820.4753)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_EXECUTION_CHAIN'
,p_process_name=>'Update App Foreground'
...
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>2278830627493820.4753
,p_process_comment=>'This process is used by an AJAX callback'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(5044303039977094.4753)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Init Page Items'
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>5044303039977094.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(5044798306977101.4753)
,p_process_sequence=>10
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>5044798306977101.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2280528281493837.4753)
,p_process_sequence=>20
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
...
');'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2280528281493837.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7088269013289013.4753)
,p_process_sequence=>30
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
...
');'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>7088269013289013.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2280171005493833.4753)
,p_process_sequence=>40
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2280171005493833.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2280279089493834.4753)
,p_process_sequence=>50
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2280279089493834.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2278167974493813.4753)
,p_process_sequence=>10
,p_parent_process_id=>wwv_flow_imp.id(2278089943493812.4753)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Remove App for Update BG'
,p_process_sql_clob=>'wwv_flow_f4000_util.remove_app( p_flow_id => :P50_REMOVE_FLOW_ID );'
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2278167974493813.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2278927025493821.4753)
,p_process_sequence=>10
,p_parent_process_id=>wwv_flow_imp.id(2278830627493820.4753)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Remove App for Update FG'
,p_process_sql_clob=>'wwv_flow_f4000_util.remove_app( p_flow_id => :P50_REMOVE_FLOW_ID );'
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2278927025493821.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7088382910289014.4753)
,p_process_sequence=>10
,p_parent_process_id=>wwv_flow_imp.id(2278784325493819.4753)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Install App FG'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>7088382910289014.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2277554211493807.4753)
,p_process_sequence=>20
,p_parent_process_id=>wwv_flow_imp.id(2277316269493805.4753)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Install App BG'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2277554211493807.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2278275009493814.4753)
,p_process_sequence=>20
,p_parent_process_id=>wwv_flow_imp.id(2278089943493812.4753)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Install App for Update BG'
...
');'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2278275009493814.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2279034768493822.4753)
,p_process_sequence=>20
,p_parent_process_id=>wwv_flow_imp.id(2278830627493820.4753)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Install App for Update FG'
...
');'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2279034768493822.4753
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>60.4753
,p_name=>'Benutzerdefinierte App-Galerie'
,p_alias=>'CUSTOM-APP-GALLERY'
,p_step_title=>'Benutzerdefinierte App-Galerie'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(635423667041974798.4753)
,p_plug_name=>'Region "Weitere Informationen"'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1775290936659177198.4753)
,p_plug_name=>'App Filters'
,p_region_name=>'pkgapp_filters'
,p_region_css_classes=>'a-ButtonRegion--pkgApps'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--withItems:a-ButtonRegion--noBorder:a-ButtonRegion--accessibleTitle:a-Form--autoWidthLabels'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2079300425802352969.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(563217833616405307.4753)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(635423667041974798.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(563224672166405332.4753)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1775290936659177198.4753)
,p_button_name=>'ADMIN'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:a-Button--iconLeft'
,p_button_template_id=>wwv_flow_imp.id(758581488338548971.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(563225022447405333.4753)
,p_name=>'P60_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1775290936659177198.4753)
,p_prompt=>'Suchen'
,p_placeholder=>'Such-Apps'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(563226185126405344.4753)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(563227002928405348.4753)
,p_name=>'Search on Enter'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(563228073830405349.4753)
,p_event_id=>wwv_flow_imp.id(563227002928405348.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CANCEL_EVENT'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(563228471251405349.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(563228959500405349.4753)
,p_event_id=>wwv_flow_imp.id(563228471251405349.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(829721255038941612.4753)
,p_plug_name=>'Feedback'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(740771588500180474.4753)
,p_plug_display_sequence=>100
,p_plug_header=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p><strong>Vielen Dank, dass Sie &PRODUCT_NAME. verbessern, indem Sie uns Ihr Feedback zukommen lassen.</strong></p>',
unistr('<p>Erfahren Sie mehr \00FCber die <a target="_blank" href="https://apex.oracle.com/pls/apex/f?p=520052:FEATURES:::NO:::">Features</a> in APEX 19.2.</p>'),
unistr('<p>Lesen Sie <a rel="noopener noreferrer" target="_blank" href="https://apex.oracle.com/pls/apex/f?p=192192:KNOWN-ISSUES:::NO:::">Bekannte Probleme</a>, bevor Sie Feedback eingeben, da diese regelm\00E4\00DFig mit den h\00E4ufigsten Problemen und Einschr\00E4nkungen')
||unistr(' f\00FCr dieses Early-Adopter-Release aktualisiert werden.<br>'),
unistr('Navigieren Sie zu <a rel="noopener noreferrer" target="_blank" href="&P11001_FEEDBACK_URL.">Early Adopter Public Feedback</a>, um Antworten und Informationen zu Folgema\00DFnahmen zu erhalten.</p>'),
''))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1831121893546426040.4753)
,p_plug_name=>'Vorhandenes Feedback auf dieser Seite'
,p_parent_plug_id=>wwv_flow_imp.id(829721255038941612.4753)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1831121926658426041.4753)
,p_name=>'Vorhandenes Feedback'
,p_parent_plug_id=>wwv_flow_imp.id(1831121893546426040.4753)
,p_template=>wwv_flow_imp.id(404667570222803088.4753)
,p_display_sequence=>30
...
,p_query_row_template=>wwv_flow_imp.id(741385154282007399.4753)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>unistr('F\00FCr diese Seite wurde kein Feedback eingegeben.')
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1831122013825426042.4753)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(784426461887840006.4753)
,p_query_column_id=>2
,p_column_alias=>'FEEDBACK_ID'
,p_column_display_sequence=>2
,p_column_heading=>'Feedback-Nummer'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1831122187593426043.4753)
,p_query_column_id=>3
,p_column_alias=>'FEEDBACK_TYPE'
,p_column_display_sequence=>3
,p_column_heading=>'Feedbacktyp'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1831122292218426044.4753)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1831122323939426045.4753)
,p_query_column_id=>5
,p_column_alias=>'FEEDBACK_STATUS'
,p_column_display_sequence=>5
,p_column_heading=>'Feedbackstatus'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1831122493214426046.4753)
,p_query_column_id=>6
,p_column_alias=>'PUBLIC_RESPONSE'
,p_column_display_sequence=>6
,p_column_heading=>unistr('\00D6ffentliche Antwort')
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1831122584819426047.4753)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(829723948212941618.4753)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(740735067061086300.4753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(829724329405941619.4753)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(829723948212941618.4753)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(404710483554908976.4753)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Feedback weiterleiten'
,p_button_position=>'CREATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(829724171601941619.4753)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(829723948212941618.4753)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(784376114194752225.4753)
,p_name=>'P11001_ENHANCEMENTS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(829721255038941612.4753)
,p_prompt=>'Verbesserungsanweisungen'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(784426013151840002.4753)
,p_name=>'P11001_BUG_INSTRUCTIONS'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(829721255038941612.4753)
,p_prompt=>'Buganweisungen'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(784426501672840007.4753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(829721485791941614.4753)
...
,p_field_template=>wwv_flow_imp.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Die Anwendung, zu der Sie Feedback liefern.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(829721931618941617.4753)
...
,p_field_template=>wwv_flow_imp.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Die Seite, zu der Sie Feedback liefern.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'based_on', 'VALUE',
  'format', 'PLAIN',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(829722489187941618.4753)
,p_name=>'P11001_FEEDBACK'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(829721255038941612.4753)
,p_prompt=>unistr('Feedback f\00FCr App Builder und<br>APEX Application Development')
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>70
,p_cMaxlength=>4000
,p_cHeight=>4
,p_field_template=>wwv_flow_imp.id(741376307162001773.4753)
,p_item_template_options=>'#DEFAULT#'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'auto_height', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(829722929232941618.4753)
,p_name=>'P11001_FEEDBACK_TYPE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(829721255038941612.4753)
,p_prompt=>'Feedbacktyp'
,p_source=>'1'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_SELECT_LIST'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Geben Sie die Art von Feedback an.'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(829723440981941618.4753)
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>unistr('Geben Sie an, zu welcher Komponente oder Funktion Sie einen Kommentar abgeben m\00F6chten.')
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'number_of_columns', '3',
  'page_action_on_selection', 'NONE')).to_clob
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(829724676691941620.4753)
,p_validation_name=>'P11001_COMPONENT Not Null'
,p_validation_sequence=>10
,p_validation=>'P11001_COMPONENT'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# muss einen Wert haben.'
,p_associated_item=>wwv_flow_imp.id(829723440981941618.4753)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(784426180894840003.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(784426293836840004.4753)
,p_event_id=>wwv_flow_imp.id(784426180894840003.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(784426312937840005.4753)
,p_event_id=>wwv_flow_imp.id(784426180894840003.4753)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(784376274049752226.4753)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(784376345892752227.4753)
,p_event_id=>wwv_flow_imp.id(784376274049752226.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(784376447650752228.4753)
,p_event_id=>wwv_flow_imp.id(784376274049752226.4753)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(641954835025558602.4753)
,p_name=>'Cancel Dialog'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(829724171601941619.4753)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(641954956270558603.4753)
,p_event_id=>wwv_flow_imp.id(641954835025558602.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(784426606272840008.4753)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>784426606272840008.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(829724961027941621.4753)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(829724329405941619.4753)
,p_internal_uid=>829724961027941621.4753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(829725190931941621.4753)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>829725190931941621.4753
);
end;
/
